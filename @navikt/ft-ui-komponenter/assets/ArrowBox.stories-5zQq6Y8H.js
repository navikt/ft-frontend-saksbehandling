import{j as t}from"./jsx-runtime-CLpGMVip.js";const d="#B7B1A9",m=4,u=(e,o,r)=>`
  .arrowBoxTop${e} {
    background: #ffffff;
    border: 1px solid ${d};
    border-radius: ${m}px;
