import{a as Q}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{J as N,K as W,q as J,Q as X}from"./index.es-cVzKZrru.js";import{a as Z}from"./alleKodeverk-LoqTPBoT.js";import{a as ee}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as _,I as q,a as ne,o as re,N as te,z as $,u as ae,$ as U,W as ie,X as se}from"./style-DvXKkWZ-.js";import{Q as E,u as le,i as oe,P as de,f as ue}from"./index.es-BQ0OpxNI.js";import{u as ge,c as pe,b as me}from"./index.esm-BH4c-sZP.js";import{h as P}from"./moment-C5S46NFB.js";import{M as g,b as ke,A as ye}from"./index.es-CrE2Ek67.js";import{T as b}from"./Table-hgvlVDkU.js";import{V as k,H as B}from"./VStack-5o7uu9_z.js";import"./index-DASCADcX.js";import"./Theme-CaMvzsUv.js";import{L as D,D as F,a as j}from"./Label-ymrTdXLG.js";import{B as be}from"./Button-Dgzkd3lk.js";/* empty css              */import"./v4-CtRu48qb.js";import"./dayjs.min-Cke173X9.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Checkbox-tuo5WLqa.js";import"./omit-B7stZg_p.js";import"./useId-BiFzyKmP.js";import"./ReadOnlyIcon-DdHBAqwe.js";import"./Loader--92hiQI0.js";import"./Provider-ChnEfPss.js";import"./useId-sDoo_C8F.js";import"./useFormField-C_Behg-2.js";import"./Fieldset-DHF1hOrP.js";import"./Tag-CHNx7fef.js";import"./Textarea-BcuV6kw_.js";import"./index-CRSK7kgn.js";import"./index-BxWMR1Ay.js";import"./useClientLayoutEffect-Dt_TuINI.js";import"./Select-BwsnmEV0.js";import"./ChevronDown-DKSW_DmS.js";import"./Radio-BXDa3uop.js";import"./useDatepicker-C2gv930k.js";import"./Date.Input-_pUoiyW-.js";import"./DatePicker-a7Z44c2g.js";import"./Checkmark-abnGd_Ay.js";import"./Modal-CYTt9kvk.js";import"./floating-ui.react-9TVABcNX.js";import"./XMark-KAXZPgUH.js";import"./Popover-IFfnr5z7.js";import"./TextField-CqY3sxwQ.js";import"./Alert-ByhgfYs4.js";import"./ExclamationmarkTriangleFill-BFbmXhrr.js";import"./XMarkOctagonFill-Cj0h8cZo.js";import"./PersonPencilFill-CoF6qBVB.js";import"./Box-BDgFgj_x.js";import"./BasePrimitive-BG5YNwzo.js";import"./KeyVerticalFill-m_CavoP-.js";var K=(t=>(t.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",t))(K||{});const ve="_feilutbetalingTable_1bepb_1",ce="_redText_1bepb_8",V={feilutbetalingTable:ve,redText:ce},A="perioder",he=(t,o)=>{const r=t.find(a=>a.hendelseType===o);return r!=null&&r.hendelseUndertyper&&r.hendelseUndertyper.length>0?r.hendelseUndertyper:void 0},H=({perioder:t,årsaker:o,readOnly:r,behandlePerioderSamlet:a,kodeverkSamlingFpTilbake:s})=>{const{control:u,watch:l,setValue:p,getValues:v}=ge(),{fields:h}=pe({control:u,name:A}),c=(n,m,d)=>{a&&h.forEach((w,i)=>{m!==i&&(d?v(`${A}.${i}.årsak`)===d&&p(`${A}.${i}.${d}.underÅrsak`,n):p(`${A}.${i}.årsak`,n))})};return e.jsx("div",{className:V.feilutbetalingTable,children:e.jsxs(b,{children:[e.jsx(b.Header,{children:e.jsxs(b.Row,{children:[e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Period"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Hendelse"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Beløp"})})]})}),e.jsx(b.Body,{children:h.map((n,m)=>{const d=l(`${A}.${m}.årsak`),w=he(o,d);return e.jsxs(b.Row,{children:[e.jsx(b.DataCell,{children:`${P(n.fom).format(E)} - ${P(n.tom).format(E)}`}),e.jsxs(b.DataCell,{children:[e.jsx(N,{name:`${A}.${m}.årsak`,selectValues:o.map(i=>{var f;return e.jsx("option",{value:i.hendelseType,children:(f=s[q.HENDELSE_TYPE].find(x=>x.kode===i.hendelseType))==null?void 0:f.navn},i.hendelseType)}),validate:[_],disabled:r,onChange:i=>c(i.target.value,m),label:""}),w&&e.jsx(N,{name:`${A}.${m}.${d}.underÅrsak`,selectValues:w.map(i=>{var f;return e.jsx("option",{value:i,children:(f=s[q.HENDELSE_UNDERTYPE].find(x=>x.kode===i))==null?void 0:f.navn},i)}),validate:[_],disabled:r,onChange:i=>c(i.target.value,m,d),label:""})]}),e.jsxs(b.DataCell,{className:V.redText,children:[t?t[m].belop:null," "]})]},n.id)})})]})})};H.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingPerioderFieldArray",props:{perioder:{required:!0,tsType:{name:"signature['perioder']",raw:"FeilutbetalingFakta['behandlingFakta']['perioder']"},description:""},årsaker:{required:!0,tsType:{name:"Array",raw:"FeilutbetalingÅrsak['hendelseTyper']"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},behandlePerioderSamlet:{required:!0,tsType:{name:"boolean"},description:""},kodeverkSamlingFpTilbake:{required:!0,tsType:{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
