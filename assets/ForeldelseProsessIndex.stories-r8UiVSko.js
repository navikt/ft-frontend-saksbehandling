import{$ as b,e as I,r as Ee,a as Me,y as Oe,p as Q,S as Ve,H as Be,D as Ie,o as N,V as pe,Z as Ne}from"./style-dtFfnrpF.js";import{g as Z,a7 as ke,j as e,ar as ye,V as S,av as _e,H as M,aM as Ue,aN as ee,p as k,A as D,M as K,N as be,L as te,B as _,t as U,F as Le,q as Ce,r as c,aO as fe,aP as ve,aj as Ke,aQ as Ge,a9 as ze,at as He,aq as $e,I as Ze,aR as Ye,aw as We,aS as Xe,P as Je,k as Qe}from"./iframe-D0Hh2isZ.js";import{M as m}from"./message-3R1e5Iiw.js";import{S as re,T as X,a as er,b as rr,c as nr,d as tr,e as ar,f as sr}from"./Timeline-DlGWiHsc.js";import{S as ir}from"./Scissors-BQy5vb5F.js";import{a as or,S as lr}from"./SilhouetteFill-BRQMCCPP.js";var Y=(r=>(r.VURDER_FORELDELSE="5003",r))(Y||{});const ur=Ee(3),dr=Me(1500),mr=r=>r!==b.UDEFINERT?r:void 0,gr=r=>r.foreldet?r.foreldet:mr(r.foreldelseVurderingType),pr=r=>({...r,foreldet:gr(r)}),ce=({skjulPeriode:r,readOnly:n,periode:a,oppdaterPeriode:l,kodeverkSamlingFpTilbake:T})=>{const g=Z(),o=ke({defaultValues:pr(a)}),f=o.watch("foreldet"),v=f&&f===b.FORELDET,q=f&&f===b.TILLEGGSFRIST,s=T.ForeldelseVurderingType.filter(d=>d.kode!==b.IKKE_VURDERT);return e.jsx(ye,{formMethods:o,onSubmit:d=>l(d),children:e.jsxs(S,{gap:"4",children:[e.jsx(_e,{name:"begrunnelse",label:g.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[I,ur,dr,Oe],maxLength:1500,readOnly:n}),e.jsxs(M,{gap:"10",children:[e.jsx(Ue,{name:"foreldet",label:e.jsx(m,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[I],radios:s.map(d=>({label:d.navn,value:d.kode})),isReadOnly:n}),e.jsxs(S,{gap:"5",children:[(v||q)&&e.jsx(ee,{name:"foreldelsesfrist",label:g.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[I,Q],isReadOnly:n}),q&&e.jsx(ee,{name:"oppdagelsesDato",label:g.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[I,Q,Ve],isReadOnly:n,fromDate:k("1970-01-01").toDate(),toDate:k().toDate()})]})]}),e.jsxs(M,{gap:"4",children:[e.jsx(D,{size:"small",variant:"primary",disabled:!o.formState.isDirty||o.formState.isSubmitting||n,loading:o.formState.isSubmitting,children:e.jsx(m,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(D,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(m,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ce.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  foreldelsesfrist?: Date;
  oppdagelsesDato?: Date;
}>`}]},name:"values"}],return:{name:"void"}}},description:""},skjulPeriode:{required:!0,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent"},name:"event"}],return:{name:"void"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const kr="_button_8q57x_1",yr="_cancelButton_8q57x_5",se={button:kr,cancelButton:yr},br=(r,n)=>a=>a&&(Be(a)(k(r.tom.toString()).subtract(1,"day"))||Ie(a)(r.fom))?n.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,fr=(r,n)=>{const a=k(r.forstePeriodeTomDato).add(1,"days"),l={fom:n.fom,tom:r.forstePeriodeTomDato},T={fom:a.format(Ce),tom:n.tom};return{forstePeriode:l,andrePeriode:T}},Te=({periodeData:r,showModal:n,cancelEvent:a,finnesBelopMed0Verdi:l,splitPeriod:T})=>{const g=Z(),o=ke();return e.jsx(ye,{formMethods:o,onSubmit:f=>T(fr(f,r)),children:e.jsxs(K,{width:"medium",open:n,"aria-label":g.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:a,children:[e.jsx(K.Header,{children:e.jsx(be,{size:"small",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(K.Body,{children:e.jsxs(S,{gap:"4",children:[e.jsxs("div",{children:[e.jsx(te,{size:"small",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(_,{size:"small",children:`${k(r.fom.toString()).format(U)} - ${k(r.tom.toString()).format(U)}`})]}),e.jsx(ee,{name:"forstePeriodeTomDato",label:e.jsx(m,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[I,Q,br(r,g)],fromDate:k(r.fom).toDate(),toDate:k(r.tom).toDate()}),l&&e.jsx(Le,{variant:"error",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(K.Footer,{children:[e.jsx(D,{size:"small",variant:"primary",className:se.button,disabled:!o.formState.isDirty,children:e.jsx(m,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(D,{size:"small",variant:"secondary",onClick:a,className:se.cancelButton,type:"button",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};Te.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}}]}},name:"perioder"}],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const vr="_margin_wnej3_37",J={margin:vr},cr=!1,qe=({valgtPeriode:r,beregnBelop:n,behandlingUuid:a,oppdaterSplittedePerioder:l,setNestePeriode:T,setForrigePeriode:g,readOnly:o,lukkPeriode:f})=>{const v=Z(),[q,s]=c.useState(!1),[d,p]=c.useState(!1),i=w=>{s(!0),w.preventDefault()},x=()=>{s(!1)},t=w=>{p(!1);const A={belop:r.feilutbetaling,fom:w.forstePeriode.fom,tom:w.forstePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "},F={belop:r.feilutbetaling,fom:w.andrePeriode.fom,tom:w.andrePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "};n({behandlingUuid:a,perioder:[A,F]}).then(E=>{const{perioder:j}=E;if(j.some(V=>V.belop===0))p(!0);else{const V={fom:A.fom,tom:A.tom,feilutbetaling:j[0].belop},O={fom:F.fom,tom:F.tom,feilutbetaling:j[1].belop};x(),l([V,O])}})};return e.jsxs(M,{children:[e.jsxs(te,{size:"small",children:[e.jsx(m,{id:"PeriodeController.Detaljer"}),cr]}),!o&&e.jsxs(e.Fragment,{children:[e.jsx(re,{}),e.jsx(D,{className:J.margin,size:"xsmall",icon:e.jsx(ir,{"aria-hidden":!0}),onClick:i,variant:"tertiary-neutral",type:"button",title:v.formatMessage({id:"PeriodeController.DelOppPerioden"}),children:e.jsx(m,{id:"PeriodeController.DelOppPerioden"})})]}),q&&e.jsx(Te,{cancelEvent:x,showModal:q,periodeData:r,splitPeriod:t,finnesBelopMed0Verdi:d}),e.jsx(re,{}),e.jsx(D,{className:J.margin,size:"xsmall",icon:e.jsx(fe,{"aria-hidden":!0}),onClick:g,variant:"secondary-neutral",type:"button",title:v.formatMessage({id:"PeriodeController.prevPeriod"}),children:e.jsx(m,{id:"PeriodeController.prevPeriodShort"})}),e.jsx(D,{className:J.margin,size:"xsmall",icon:e.jsx(ve,{"aria-hidden":!0}),onClick:T,variant:"secondary-neutral",type:"button",title:v.formatMessage({id:"PeriodeController.nextPeriod"}),iconPosition:"right",children:e.jsx(m,{id:"PeriodeController.nextPeriodShort"})}),e.jsx(D,{size:"xsmall",icon:e.jsx(Ke,{"aria-hidden":!0}),onClick:f,variant:"tertiary-neutral",type:"button",title:v.formatMessage({id:"PeriodeController.LukkPeriode"})})]})};qe.__docgenInfo={description:"",methods:[],displayName:"PeriodeController",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},beregnBelop:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BeregnBeløpParams) => Promise<BeregnBeløpResultat>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  foreldelsesfrist?: Date;
  oppdagelsesDato?: Date;
}>`}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},lukkPeriode:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Tr="_infoSummary_ythle_1",qr="_positivNumber_ythle_7",jr="_redNumber_ythle_11",hr="_resultName_ythle_16",G={infoSummary:Tr,positivNumber:qr,redNumber:jr,resultName:hr},je=({fom:r,tom:n,feilutbetaling:a})=>{const l=Ge(r,n);return e.jsxs(S,{gap:"2",className:G.infoSummary,children:[e.jsxs(M,{children:[e.jsx(te,{size:"small",children:`${k(r).format(U)} - ${k(n).format(U)}`}),e.jsx(re,{}),e.jsx(_,{size:"small",children:l.formattedString})]}),e.jsx(M,{gap:"4",children:e.jsxs(_,{size:"small",className:G.resultName,children:[e.jsx(m,{id:"PeriodeInformasjon.Feilutbetaling"}),":",e.jsx("span",{className:a?G.redNumber:G.positivNumber,children:ze(a)})]})})]})};je.__docgenInfo={description:`PeriodeInformasjon

Tilbakekreving periode oppsummering`,methods:[],displayName:"PeriodeInformasjon",props:{fom:{required:!0,tsType:{name:"string"},description:""},tom:{required:!0,tsType:{name:"string"},description:""},feilutbetaling:{required:!0,tsType:{name:"number"},description:""}}};const Pr="_margin_1wl4t_1",z={margin:Pr},Dr=r=>{const n=r.isGodkjent?"success":"danger";return r.isAksjonspunktOpen?"warning":n},wr=(r=[])=>r.map(n=>({id:n.id,fom:n.fom,tom:n.tom,status:Dr(n)})),Rr=r=>r===N.MOR||r===N.MEDMOR?e.jsx(or,{width:20,height:20,color:"var(--a-red-200)"}):r===N.FAR?e.jsx(lr,{width:20,height:20,color:"var(--a-blue-600)"}):e.jsx(nr,{width:20,height:20}),Fr={danger:e.jsx(sr,{}),success:e.jsx(ar,{}),warning:e.jsx(tr,{})},he=({perioder:r,setPeriode:n,valgtPeriode:a,relasjonsRolleType:l,relasjonsRolleTypeKodeverk:T})=>{var F;const g=Z(),o=c.useMemo(()=>wr(r),[r]),f=c.useCallback(y=>{const E=r.find(j=>j.id===y);E&&n(E)},[r,n]),v=k(o[0].fom),q=k(o[o.length-1].tom),[s,d]=c.useState(v),[p,i]=c.useState(q),x=c.useCallback(()=>{s.subtract(1,"month").isBefore(v)||(d(s.subtract(1,"month")),i(p.subtract(1,"month")))},[s,p,v]),t=c.useCallback(()=>{p.add(1,"month").isAfter(q)||(d(s.add(1,"month")),i(p.add(1,"month")))},[s,p,q]),w=c.useCallback(()=>{s.add(3,"month").isAfter(p)||(d(s.add(1,"month")),i(p.subtract(1,"month")))},[s,p]),A=c.useCallback(()=>{p.add(1,"month").diff(s.subtract(1,"month"),"months")<36&&(d(s.subtract(1,"month")),i(p.add(1,"month")))},[s,p]);return e.jsxs(S,{gap:"4",children:[e.jsx(X,{startDate:s.toDate(),endDate:p.add(1,"days").toDate(),children:e.jsx(X.Row,{label:((F=T.find(y=>y.kode===l))==null?void 0:F.navn)||"-",icon:Rr(l),children:o.map(y=>e.jsx(X.Period,{start:k(y.fom).toDate(),end:k(y.tom).toDate(),status:y.status,onSelectPeriod:()=>f(y.id),isActive:(a==null?void 0:a.id)===y.id,icon:Fr[y.status],"aria-controls":"panel-tilbakekreving-foreldelse",id:y.id.toString()},y.id))})}),e.jsxs(M,{justify:"end",children:[e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(er,{"aria-hidden":!0}),onClick:w,variant:"primary-neutral",type:"button",title:g.formatMessage({id:"TilbakekrevingTimeline.ZoomInn"})}),e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(rr,{"aria-hidden":!0}),onClick:A,variant:"primary-neutral",type:"button",title:g.formatMessage({id:"TilbakekrevingTimeline.ZoomUt"})}),e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(fe,{"aria-hidden":!0}),onClick:x,variant:"primary-neutral",type:"button",title:g.formatMessage({id:"TilbakekrevingTimeline.ScrollTilVenstre"})}),e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(ve,{"aria-hidden":!0}),onClick:t,variant:"primary-neutral",type:"button",title:g.formatMessage({id:"TilbakekrevingTimeline.ScrollTilHogre"})})]})]})};he.__docgenInfo={description:`TilbakekrevingTimeLine
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const ie=(r,n)=>k(r.fom).diff(k(n.fom)),Sr=()=>k().subtract(30,"months").format(U),xr=r=>r?[e.jsx(m,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Sr()}},"vurderForeldelse")]:[],ne=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===b.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Ar=(r=[])=>r.map((n,a)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:ne(n),isGodkjent:b.FORELDET!==n.foreldet&&b.UDEFINERT!==n.foreldet,id:a})),Er=r=>({foreldelsePerioder:r.map(a=>({fraDato:a.fom,tilDato:a.tom,begrunnelse:a.begrunnelse,foreldelseVurderingType:a.foreldet,foreldelsesfrist:a.foreldelsesfrist,oppdagelsesDato:a.oppdagelsesDato})),kode:Y.VURDER_FORELDELSE}),Mr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Or=r=>[...r].sort(Mr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===b.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:We(n.begrunnelse)})),Pe=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a,aksjonspunkt:l,alleMerknaderFraBeslutter:T,perioderForeldelse:g,readOnly:o,kodeverkSamlingFpTilbake:f,beregnBelop:v,behandlingUuid:q,formData:s,setFormData:d})=>{const p=Or(g.perioder),[i,x]=c.useState(s||p),[t,w]=c.useState(i==null?void 0:i.find(ne)),[A,F]=c.useState(!1),[y,E]=c.useState(!!s),j=u=>{const h=u?i.find(P=>P.fom===u.fom&&P.tom===u.tom):void 0;w(h)},ae=()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===i.length-1?u:u+1;j(i[h])},V=()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===0?u:u-1;j(i[h])},O=()=>{j(void 0)},we=u=>{const h=Xe(u,"erSplittet"),C=i.filter(R=>R.fom!==h.fom&&R.tom!==h.tom).concat(h).sort(ie);x(C),d(C),E(!0),O();const B=C.find(ne);B&&j(B)},Re=u=>{const h=i.find(R=>R.fom===(t==null?void 0:t.fom)&&R.tom===(t==null?void 0:t.tom));if(h===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${t==null?void 0:t.fom} Tom: ${t==null?void 0:t.tom}`);const P=u.map(R=>({...h,...R,erSplittet:!0})),B=i.filter(R=>R.fom!==(t==null?void 0:t.fom)&&R.tom!==(t==null?void 0:t.tom)).concat(P).sort(ie);x(B),d(B),E(!0),O(),j(P[0])},Fe=()=>{F(!0),r(Er(i))},Se=T[Y.VURDER_FORELDELSE],W=Ar(i),xe=l&&l.status===pe.OPPRETTET,Ae=W.every(u=>!u.isAksjonspunktOpen),L=t?W.find(u=>u.fom===t.fom&&u.tom===t.tom):void 0;return e.jsx(He,{merknaderFraBeslutter:Se,withoutBorder:!0,children:e.jsxs(S,{gap:"4",children:[e.jsx(be,{size:"small",children:e.jsx(m,{id:"ForeldelseForm.Foreldelse"})}),!l&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(m,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(m,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),i&&l&&e.jsxs(S,{gap:"4",children:[xe&&e.jsx($e,{children:xr(l)}),e.jsx(he,{perioder:W,valgtPeriode:L,setPeriode:j,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a}),t&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":L==null?void 0:L.id.toString(),children:e.jsx(Ze,{borderWidth:"1",padding:"4",children:e.jsxs(S,{gap:"4",children:[e.jsx(qe,{setNestePeriode:ae,setForrigePeriode:V,valgtPeriode:t,readOnly:o,oppdaterSplittedePerioder:Re,behandlingUuid:q,beregnBelop:v,lukkPeriode:O}),e.jsx(je,{feilutbetaling:t.feilutbetaling,fom:t.fom,tom:t.tom}),e.jsx(ce,{periode:t,oppdaterPeriode:we,skjulPeriode:O,readOnly:o,kodeverkSamlingFpTilbake:f},t.fom)]})})}),e.jsx(M,{children:e.jsx(Ye,{isReadOnly:o,isDirty:y,isSubmittable:!t&&Ae,onClick:Fe,isSubmitting:A})})]})]})})};Pe.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const{action:Ir}=__STORYBOOK_MODULE_ACTIONS__,Nr={perioder:[{fom:"2019-01-01",tom:"2019-01-31",belop:1e3,begrunnelse:"Foreldet",foreldelseVurderingType:b.FORELDET,foreldelsesfrist:"2020-04-01"},{fom:"2019-03-01",tom:"2019-03-31",belop:3e3,foreldelseVurderingType:b.UDEFINERT},{fom:"2019-02-01",tom:"2019-02-28",belop:3e3,begrunnelse:"Over foreldelsesfrist, med tillegsfrist brukes",foreldelseVurderingType:b.TILLEGGSFRIST,foreldelsesfrist:"2020-04-01",oppdagelsesDato:"2019-11-01"},{fom:"2019-04-01",tom:"2019-04-30",belop:4e3,foreldelseVurderingType:b.UDEFINERT}]},_r={ForeldelseVurderingType:[{kode:b.FORELDET,navn:"Foreldet",kodeverk:"FORELDELSE_VURDERING"},{kode:b.TILLEGGSFRIST,navn:"Ikke foreldet, med tilleggsfrist",kodeverk:"FORELDELSE_VURDERING"},{kode:b.IKKE_FORELDET,navn:"Ikke foreldet",kodeverk:"FORELDELSE_VURDERING"}]},Hr={component:De,args:{submitCallback:Ir("button-click"),behandling:{uuid:"1",versjon:1,status:Ne.BEHANDLING_UTREDES},kodeverkSamlingFpTilbake:_r,isReadOnly:!1,setFormData:()=>{},perioderForeldelse:Nr,relasjonsRolleType:N.MOR,beregnBelop:()=>Promise.resolve({perioder:[{belop:1e4},{belop:12e3}]}),alleMerknaderFraBeslutter:{},relasjonsRolleTypeKodeverk:[{kode:N.MOR,kodeverk:"RELASJONSROLLE_TYPE",navn:"Mor"}]}},H={args:{aksjonspunkter:[{definisjon:Y.VURDER_FORELDELSE,status:pe.OPPRETTET,begrunnelse:void 0,kanLoses:!0}]}},$={args:{aksjonspunkter:[]}};var oe,le,ue;H.parameters={...H.parameters,docs:{...(oe=H.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: [{
