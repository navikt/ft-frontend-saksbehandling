import{j as e,F as R,A as f,G as j,I as N,u as A,J as v,H as x}from"./iframe-DH7Rhn68.js";import{r as b}from"./formUtils-scCUyMbE.js";import{R as T}from"./RhfDatepicker-Cv8UDdUl.js";import{R as y}from"./RhfTextField-DYQiB2tu.js";import"./preload-helper-PPVm8Dsz.js";import"./customParseFormat-DfXo6wJw.js";import"./ReadOnlyField-sou-u3hS.js";const c=({fields:r,readOnly:n=!0,titleText:l,addButtonText:a,emptyTemplate:d,children:i,remove:s,append:o,size:t="small"})=>e.jsxs(R,{legend:l,size:t,children:[r.map((m,F)=>i(m,F,e.jsx(h,{index:F,remove:s,size:t,skjul:n}))),e.jsx(g,{append:o,emptyTemplate:d,size:t,skjul:n,children:a})]}),h=({index:r,remove:n,size:l,skjul:a})=>r>0&&!a?e.jsx(f,{icon:e.jsx(j,{"aria-hidden":!0}),title:"Fjern element",type:"button",variant:"tertiary-neutral",size:l,onClick:()=>{n(r)}}):null,g=({append:r,size:n,skjul:l,emptyTemplate:a,children:d})=>l?null:e.jsx(f,{onClick:()=>r(a),type:"button",tabIndex:0,variant:"tertiary",icon:e.jsx(N,{"aria-hidden":!0}),size:n,children:d});c.__docgenInfo={description:"",methods:[],displayName:"RhfFieldArray",props:{children:{required:!0,tsType:{name:"signature",type:"function",raw:`(
