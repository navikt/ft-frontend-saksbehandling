import{g as _,l as Z,r as x,j as e,D as O,av as ee,V as T,N as U,e as re,L as B,B as b,aw as te,a7 as ne,ar as ie,H as S,aR as ae,z as se,aT as le,an as ue,a9 as c,P as de,k as ke}from"./iframe-BXXXxsZ-.js";import{a as oe}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as ge,r as me,y as M,a as L,I as K,j as ve,d as pe}from"./style-DwqxuKU5.js";import{c as be}from"./index-M-SzZVFL.js";import{S as fe}from"./PlusCircle-BrxO4FpS.js";import{M as m}from"./message-l41z7YxF.js";import{E as h}from"./ExpansionCard-ZMm-Egb0.js";import{T as s}from"./Table-DHlKca55.js";var E=(n=>(n.FORSETT="FORSETT",n.GROVT_UAKTSOM="GROVT_UAKTSOM",n.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",n))(E||{});const v={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"};var C=(n=>(n.FORESLA_VEDTAK="5004",n))(C||{});const ye="_addCircleIcon_84ecs_1",ce="_imageText_84ecs_7",Te="_addPeriode_84ecs_12",w={addCircleIcon:ye,imageText:ce,addPeriode:Te},H=me(3),qe=L(4e3),Ae=[H,M],he=[ge,H,M],z=({type:n,readOnly:i,fritekstPakrevet:t,maximumLength:r})=>{const a=_(),{watch:u}=Z(),l=u(n)===void 0,[o,k]=x.useState(l&&!t),g=t?he:Ae;return g.push(r?L(r):qe),e.jsxs(e.Fragment,{children:[o&&!i&&e.jsx(e.Fragment,{children:e.jsxs("div",{onClick:p=>{p.preventDefault(),k(!1)},onKeyDown:p=>{p.preventDefault(),k(!1)},className:w.addPeriode,role:"button",tabIndex:0,children:[e.jsx(fe,{className:w.addCircleIcon,title:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),e.jsx(O,{size:"small",className:w.imageText,children:e.jsx(m,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})}),!o&&e.jsx(ee,{name:n,label:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:g,maxLength:r||4e3,readOnly:i})]})};z.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{type:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},fritekstPakrevet:{required:!1,tsType:{name:"boolean"},description:""},maximumLength:{required:!1,tsType:{name:"number"},description:""}}};const je="_container_aetpe_1",Pe="_gulmarkering_aetpe_4",G={container:je,gulmarkering:Pe},P=({intl:n,vedtaksbrevAvsnitt:i,readOnly:t,perioderSomIkkeHarUtfyltObligatoriskVerdi:r,fritekstOppsummeringPakrevdMenIkkeUtfylt:a=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:u})=>e.jsxs(T,{gap:"2",className:G.container,children:[e.jsx(U,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),i.map(l=>{const o=l.underavsnittsliste,k=`${l.fom}_${l.tom}`,g=r.some(d=>d===k),p=l.avsnittstype===v.OPPSUMMERING&&a;return e.jsx(re.Fragment,{children:e.jsxs(h,{"aria-label":"periode",defaultOpen:g||p,className:g||p?G.gulmarkering:"",children:[e.jsx(h.Header,{children:e.jsx(h.Title,{size:"small",children:l.overskrift?l.overskrift:n.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),e.jsx(h.Content,{children:e.jsx(T,{gap:"2",children:o.map(d=>e.jsxs(T,{gap:"2",children:[d.overskrift&&e.jsx(B,{size:"small",children:d.overskrift}),d.brødtekst&&e.jsx(b,{size:"small",children:d.brødtekst}),d.fritekstTillatt&&e.jsx(e.Fragment,{children:e.jsx(z,{type:d.underavsnittstype?`${k}.${d.underavsnittstype}`:l.avsnittstype,readOnly:t,fritekstPakrevet:d.fritekstPåkrevet,maximumLength:u?1e4:void 0})})]},(d.underavsnittstype||"")+d.overskrift+d.brødtekst))})})]})},l.avsnittstype+l.fom)})]});P.buildInitialValues=n=>n.filter(i=>i.underavsnittsliste.some(t=>t.fritekst)).reduce((i,t)=>{const a=t.underavsnittsliste.filter(l=>l.fritekst).reduce((l,o)=>({...l,[o.underavsnittstype?o.underavsnittstype:t.avsnittstype]:te(o.fritekst)}),{}),u=t.fom?{[`${t.fom}_${t.tom}`]:a}:a;return{...i,...u}},{});P.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"vedtaksbrevAvsnitt",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avsnittstype: string;
  fom?: string;
  tom?: string;
  overskrift?: string;
  ...
  underavsnittstype?: string;
  fritekstPåkrevet?: boolean;
}[]`,required:!0}}]}}],raw:"VedtaksbrevAvsnitt[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},perioderSomIkkeHarUtfyltObligatoriskVerdi:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},fritekstOppsummeringPakrevdMenIkkeUtfylt:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""}}};const Re="_buttonLink_sudxz_1",we="_padding_sudxz_8",Ve="_infoTextIcon_sudxz_14",V={buttonLink:Re,padding:we,infoTextIcon:Ve},Y=n=>{const i=le(n,v.OPPSUMMERING);return{oppsummeringstekst:n[v.OPPSUMMERING],perioderMedTekst:Object.keys(i).map(t=>({fom:t.split("_")[0],tom:t.split("_")[1],faktaAvsnitt:i[t][v.FAKTA],foreldelseAvsnitt:i[t][v.FORELDELSE],vilkaarAvsnitt:i[t][v.VILKAR],saerligeGrunnerAvsnitt:i[t][v.SARLIGEGRUNNER],saerligeGrunnerAnnetAvsnitt:i[t][v.SARLIGEGRUNNER_ANNET]}))}},xe=(n,i)=>n.some(t=>t.avsnittstype===v.OPPSUMMERING&&t.underavsnittsliste.some(r=>r.fritekstPåkrevet)&&!i[v.OPPSUMMERING]),Be=n=>({kode:C.FORESLA_VEDTAK,...Y(n)}),Ee=(n,i)=>n.reduce((t,r)=>{const a=`${r.fom}_${r.tom}`,u=i[a];return r.underavsnittsliste.some(k=>k.fritekstPåkrevet&&k.underavsnittstype===v.FAKTA)&&(!u||!u[v.FAKTA])||r.underavsnittsliste.some(k=>k.fritekstPåkrevet&&k.underavsnittstype===v.SARLIGEGRUNNER_ANNET)&&(!u||!u[v.SARLIGEGRUNNER_ANNET])?t.concat(a):t},[]),N=(n,i,t)=>r=>{n({uuid:i,...Y(t)}),r.preventDefault()},$=({submitCallback:n,readOnly:i,fetchPreviewVedtaksbrev:t,avsnittsliste:r,behandlingUuid:a,erRevurderingTilbakekrevingKlage:u,erRevurderingTilbakekrevingFeilBeløpBortfalt:l,formData:o,setFormData:k})=>{const g=r,p=x.useMemo(()=>o||P.buildInitialValues(g),[o,g]),d=_(),f=ne({defaultValues:p}),y=f.watch(),R=xe(g,y),q=Ee(g,y),X=R||q.length>0;return e.jsx(ie,{formMethods:f,onSubmit:A=>n(Be(A)),setDataOnUnmount:k,children:e.jsxs(T,{gap:"4",children:[e.jsx(P,{intl:d,vedtaksbrevAvsnitt:g,readOnly:i,perioderSomIkkeHarUtfyltObligatoriskVerdi:x.useMemo(()=>q,[]),fritekstOppsummeringPakrevdMenIkkeUtfylt:R,erRevurderingTilbakekrevingFeilBeløpBortfalt:l}),e.jsxs(S,{gap:"10",children:[e.jsx(ae,{text:d.formatMessage({id:"TilbakekrevingVedtakForm.TilGodkjenning"}),isReadOnly:i,isSubmittable:q.length===0&&!R,isSubmitting:f.formState.isSubmitting,isDirty:f.formState.isDirty,hasErrors:X}),q.length===0&&e.jsx("div",{className:V.padding,children:e.jsx("a",{href:"",onClick:N(t,a,y),onKeyDown:A=>A.key==="Enter"?N(t,a,y)(A):null,className:be(V.buttonLink,"lenke lenke--frittstaende"),children:e.jsx(m,{id:"TilbakekrevingVedtakForm.ForhandvisBrev"})})})]}),u&&e.jsxs(S,{children:[e.jsx(se,{className:V.infoTextIcon}),e.jsx(m,{id:"TilbakekrevingVedtakForm.Infotekst.Klage"})]})]})})};$.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakForm",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
  ...
  saerligeGrunnerAvsnitt: string;
  saerligeGrunnerAnnetAvsnitt: string;
}[]`,required:!0}}]}}]},name:"data"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},behandlingUuid:{required:!0,tsType:{name:"string"},description:""},erRevurderingTilbakekrevingKlage:{required:!1,tsType:{name:"boolean"},description:""},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"union",raw:"Record<string, string> | string",elements:[{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},{name:"string"}]}],raw:"Record<string, Record<string, string> | string>"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FormValues) => void",signature:{arguments:[{type:{name:"Record",elements:[{name:"string"},{name:"union",raw:"Record<string, string> | string",elements:[{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},{name:"string"}]}],raw:"Record<string, Record<string, string> | string>"},name:"data"}],return:{name:"void"}}},description:""}}};const Se="_table_gko8z_1",Ge={table:Se},J=({perioder:n,kodeverkSamlingFpTilbake:i})=>{const t=n.map(r=>{var a;return e.jsxs(s.Row,{children:[e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:e.jsx(ue,{dateStringFom:r.periode.fom,dateStringTom:r.periode.tom})})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(r.feilutbetaltBeløp)})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:(a=i[K.AKTSOMHET].find(u=>u.kode===r.vurdering))==null?void 0:a.navn})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:r.andelAvBeløp!==void 0&&r.andelAvBeløp!==null?`${r.andelAvBeløp}%`:""})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:r.renterProsent?`${r.renterProsent}%`:""})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(r.tilbakekrevingBeløp)})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(r.tilbakekrevingBeløpEtterSkatt)})})]},r.periode.fom)}).concat(e.jsxs(s.Row,{children:[e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Sum"})})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(n.reduce((r,a)=>r+a.feilutbetaltBeløp,0))})}),e.jsx(s.DataCell,{}),e.jsx(s.DataCell,{}),e.jsx(s.DataCell,{}),e.jsx(s.DataCell,{children:e.jsx(B,{size:"small",children:c(n.reduce((r,a)=>r+a.tilbakekrevingBeløp,0))})}),e.jsx(s.DataCell,{children:e.jsx(B,{size:"small",children:c(n.reduce((r,a)=>r+a.tilbakekrevingBeløpEtterSkatt,0))})})]},"sum"));return e.jsx("div",{className:Ge.table,children:e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Periode"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.FeilutbetaltBelop"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Vurdering"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.AndelAvBelop"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Renter"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.ForSkatt"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.BelopSomTilbakekreves"})})]})}),e.jsx(s.Body,{children:t})]})})};J.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakPeriodeTabell",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  periode: {
    fom: string;
    tom: string;
  };
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<KodeverkType, KodeverkMedNavn[]>"},description:""}}};const Q=({submitCallback:n,readOnly:i,resultat:t,perioder:r,kodeverkSamlingFpTilbake:a,behandlingUuid:u,avsnittsliste:l,fetchPreviewVedtaksbrev:o,erRevurderingTilbakekrevingKlage:k,erRevurderingTilbakekrevingFeilBeløpBortfalt:g,formData:p,setFormData:d})=>{var f;return e.jsxs(T,{gap:"4",children:[e.jsx(U,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtak"})}),e.jsxs("div",{children:[e.jsx(O,{children:e.jsx(m,{id:"TilbakekrevingVedtak.Resultat"})}),e.jsx(b,{size:"small",children:(f=a[K.VEDTAK_RESULTAT_TYPE].find(y=>y.kode===t))==null?void 0:f.navn})]}),e.jsx(J,{perioder:r,kodeverkSamlingFpTilbake:a}),e.jsx($,{submitCallback:n,readOnly:i,behandlingUuid:u,avsnittsliste:l,fetchPreviewVedtaksbrev:o,erRevurderingTilbakekrevingKlage:k,erRevurderingTilbakekrevingFeilBeløpBortfalt:g,formData:p,setFormData:d})]})};Q.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtak",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
  ...
  saerligeGrunnerAvsnitt: string;
  saerligeGrunnerAnnetAvsnitt: string;
}[]`,required:!0}}]}}]},name:"data"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},erRevurderingTilbakekrevingKlage:{required:!1,tsType:{name:"boolean"},description:""},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"union",raw:"Record<string, string> | string",elements:[{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},{name:"string"}]}],raw:"Record<string, Record<string, string> | string>"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FormValues) => void",signature:{arguments:[{type:{name:"Record",elements:[{name:"string"},{name:"union",raw:"Record<string, string> | string",elements:[{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},{name:"string"}]}],raw:"Record<string, Record<string, string> | string>"},name:"data"}],return:{name:"void"}}},description:""}}};const Ne={"TilbakekrevingVedtak.Resultat":"Resultat","TilbakekrevingVedtak.Vedtaksbrev":"Vedtaksbrev","TilbakekrevingVedtak.Vedtak":"Vedtak","TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst":"Legg til utdypende tekst","TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst":"Utdypende tekst","TilbakekrevingVedtakPeriodeTabell.Periode":"Periode","TilbakekrevingVedtakPeriodeTabell.FeilutbetaltBelop":"Feilutbetalt beløp","TilbakekrevingVedtakPeriodeTabell.Vurdering":"Vurdering","TilbakekrevingVedtakPeriodeTabell.AndelAvBelop":"Andel av beløp","TilbakekrevingVedtakPeriodeTabell.Renter":"Renter","TilbakekrevingVedtakPeriodeTabell.ForSkatt":"Beløp før skatt","TilbakekrevingVedtakPeriodeTabell.BelopSomTilbakekreves":"Beløp etter skatt","TilbakekrevingVedtakPeriodeTabell.Sum":"Sum","TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift":"Lovhjemler og klagerett","TilbakekrevingVedtakForm.TilGodkjenning":"Til godkjenning","TilbakekrevingVedtakForm.ForhandvisBrev":"Forhåndsvis brev","TilbakekrevingVedtakForm.Infotekst.Klage":"Vedtaksbrev sendes ikke ut fra denne behandlingen, men må sendes av saksbehandler fra klagebehandlingen"},Fe=ke(Ne),W=({behandling:n,beregningsresultat:i,isReadOnly:t,submitCallback:r,kodeverkSamlingFpTilbake:a,formData:u,setFormData:l,vedtaksbrev:o,fetchPreviewVedtaksbrev:k,erRevurderingTilbakekrevingKlage:g,erRevurderingTilbakekrevingFeilBeløpBortfalt:p})=>e.jsx(de,{value:Fe,children:e.jsx(Q,{behandlingUuid:n.uuid,perioder:i.beregningResultatPerioder,resultat:i.vedtakResultatType,avsnittsliste:o.avsnittsliste,submitCallback:r,readOnly:t,kodeverkSamlingFpTilbake:a,fetchPreviewVedtaksbrev:k,erRevurderingTilbakekrevingKlage:g,erRevurderingTilbakekrevingFeilBeløpBortfalt:p,formData:u,setFormData:l})});W.__docgenInfo={description:"",methods:[],displayName:"VedtakTilbakekrevingProsessIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  versjon: number;
  uuid: string;
  status: string;
  type: string;
