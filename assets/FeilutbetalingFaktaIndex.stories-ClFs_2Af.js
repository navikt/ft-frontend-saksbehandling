import{i as L,ar as M,j as e,as as E,at as R,au as P,c as Y,aa as C,V as m,av as G,aw as $,H as A,L as I,D as c,B as f,ax as z,ay as W,az as X,aA as J,y as Q,aB as Z,aC as ee,P as ne,h as re}from"./iframe-Ij6u3qkZ.js";import{a as ae}from"./alleKodeverk-DFOs3jtJ.js";import{a as te}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as x,a as se,o as ie,N as le,x as H,y as w,g as K,X as de,W as V,z as oe,C as ue}from"./style-idQLgP5J.js";import{T as b}from"./Table-24vFMoGj.js";import{M as d}from"./message-BGJyuEPI.js";import"./preload-helper-D9Z9MdNV.js";var U=(r=>(r.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",r))(U||{});const F="perioder",ge=(r,o)=>{const t=r.find(a=>a.hendelseType===o);return t?.hendelseUndertyper&&t.hendelseUndertyper.length>0?t.hendelseUndertyper:void 0},_=({perioder:r,årsaker:o,readOnly:t,behandlePerioderSamlet:a,kodeverkSamlingFpTilbake:g})=>{const{control:i,watch:l,setValue:k,getValues:v}=L(),{fields:T}=M({control:i,name:F}),h=(n,y,u)=>{a&&T.forEach((j,s)=>{y!==s&&(u?v(`${F}.${s}.årsak`)===u&&k(`${F}.${s}.${u}.underÅrsak`,n):k(`${F}.${s}.årsak`,n))})};return e.jsxs(b,{children:[e.jsx(b.Header,{children:e.jsxs(b.Row,{children:[e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Period"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Hendelse"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Beløp"})})]})}),e.jsx(b.Body,{children:T.map((n,y)=>{const u=l(`${F}.${y}.årsak`),j=ge(o,u);return e.jsxs(b.Row,{children:[e.jsx(b.DataCell,{children:e.jsx(E,{dateStringFom:n.fom,dateStringTom:n.tom})}),e.jsxs(b.DataCell,{children:[e.jsx(R,{name:`${F}.${y}.årsak`,control:i,selectValues:o.map(s=>e.jsx("option",{value:s.hendelseType,children:g.HendelseType.find(p=>p.kode===s.hendelseType)?.navn},s.hendelseType)),validate:[x],disabled:t,onChange:s=>h(s.target.value,y),label:""}),j&&e.jsx(R,{name:`${F}.${y}.${u}.underÅrsak`,control:i,selectValues:j.map(s=>e.jsx("option",{value:s,children:g.HendelseUnderType.find(p=>p.kode===s)?.navn},s)),validate:[x],disabled:t,onChange:s=>h(s.target.value,y,u),label:""})]}),e.jsx(b.DataCell,{align:"right",children:r?e.jsx(P,{rød:!0,beløp:r[y].belop}):null})]},n.id)})})]})};_.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingPerioderFieldArray",props:{perioder:{required:!0,tsType:{name:"signature['perioder']",raw:"FeilutbetalingFakta['behandlingFakta']['perioder']"},description:""},årsaker:{required:!0,tsType:{name:"Array",raw:"FeilutbetalingÅrsak['hendelseTyper']"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},behandlePerioderSamlet:{required:!0,tsType:{name:"boolean"},description:""},kodeverkSamlingFpTilbake:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavnTilbakekreving<K>[]"}}]}},description:""}}};const pe="_textarea_1pt2d_1",ke={textarea:pe},ye=se(3),N=4e3,me=ie(N),D=r=>r.behandlingFakta.perioder?[...r.behandlingFakta.perioder].sort(ee):[],be=r=>{const{behandlingFakta:{begrunnelse:o}}=r;return{begrunnelse:Z(o),perioder:D(r).map(t=>{const{fom:a,tom:g,feilutbetalingÅrsakDto:i}=t,l={fom:a,tom:g};if(!i)return l;const{hendelseType:k,hendelseUndertype:v}=i;return{...l,årsak:k,[k]:{underÅrsak:v||null}}})}},ve=(r,o)=>{const t=r.perioder.map(a=>{const g=o.find(l=>l.hendelseType===a.årsak),i=g?.hendelseUndertyper?g.hendelseUndertyper.find(l=>l===a[a.årsak]?.underÅrsak):void 0;return{fom:a.fom,tom:a.tom,årsak:{hendelseType:g?.hendelseType,hendelseUndertype:i}}});return{kode:U.AVKLAR_FAKTA_FOR_FEILUTBETALING,begrunnelse:r.begrunnelse,feilutbetalingFakta:t}},he=(r,o)=>{const{hendelseTyper:t}=r;return t.sort((a,g)=>{const i=o.HendelseType.find(n=>n.kode===a.hendelseType)?.navn||"",l=o.HendelseType.find(n=>n.kode===g.hendelseType)?.navn||"",k=i.startsWith("§"),v=l.startsWith("§"),T=k?i.replace(/\D/g,""):i,h=v?l.replace(/\D/g,""):l;return k&&v?T-h:T.localeCompare(h)})},O=({hasOpenAksjonspunkter:r,feilutbetalingAarsak:o,feilutbetalingFakta:t,readOnly:a,alleMerknaderFraBeslutter:g,kodeverkSamlingFpTilbake:i,kodeverkSamlingFpsak:l,formData:k,setFormData:v,submitCallback:T})=>{const h=Y(),n=t.behandlingFakta,y=be(t),u=C({defaultValues:k||y}),j=u.watch("behandlePerioderSamlet")||!1,s=he(o,i);return e.jsxs(m,{gap:"space-16",children:[r&&e.jsx(G,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Aksjonspunkt"})}),e.jsx($,{formMethods:u,onSubmit:p=>T(ve(p,s)),setDataOnUnmount:v,children:e.jsxs(m,{gap:"space-16",children:[e.jsxs(A,{gap:"space-40",wrap:!0,children:[e.jsxs(m,{gap:"space-16",children:[e.jsx(I,{size:"small",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Feilutbetaling"})}),e.jsxs(A,{justify:"space-between",children:[e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.PeriodeMedFeilutbetaling"})}),e.jsx(f,{size:"small",children:e.jsx(E,{dateStringFom:n.totalPeriodeFom,dateStringTom:n.totalPeriodeTom})})]}),e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.FeilutbetaltBeløp"})}),e.jsx(f,{size:"small",children:e.jsx(P,{rød:!0,beløp:n.aktuellFeilUtbetaltBeløp})})]}),e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.TidligereVarseltBeløp"})}),e.jsx(f,{size:"small",children:n.tidligereVarseltBeløp?e.jsx(P,{beløp:n.tidligereVarseltBeløp}):e.jsx(d,{id:"FeilutbetalingInfoPanel.IkkeVarslet"})})]})]}),e.jsx(z,{name:"behandlePerioderSamlet",control:u.control,label:h.formatMessage({id:"FeilutbetalingInfoPanel.BehandlePerioderSamlet"}),readOnly:a}),e.jsx(W,{merknaderFraBeslutter:g[U.AVKLAR_FAKTA_FOR_FEILUTBETALING],withoutBorder:!0,children:e.jsx(_,{perioder:D(t),behandlePerioderSamlet:j,årsaker:s,readOnly:a,kodeverkSamlingFpTilbake:i})})]}),e.jsxs(m,{gap:"space-16",children:[e.jsx(I,{size:"small",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Revurdering"})}),e.jsxs(A,{gap:"space-16",children:[e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Årsaker"})}),n.behandlingÅrsaker&&e.jsx(f,{size:"small",children:n.behandlingÅrsaker.map(p=>l.BehandlingÅrsakType.find(B=>B.kode===p.behandlingArsakType)?.navn).join(", ")})]}),n.datoForRevurderingsvedtak&&e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.DatoForRevurdering"})}),e.jsx(f,{size:"small",children:e.jsx(X,{dateString:n.datoForRevurderingsvedtak})})]})]}),e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Resultat"})}),n.behandlingsresultat&&e.jsx(f,{size:"small",children:l.BehandlingResultatType.find(p=>p.kode===n.behandlingsresultat?.type)?.navn})]}),e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Konsekvens"})}),n.behandlingsresultat&&e.jsx(f,{size:"small",children:n.behandlingsresultat.konsekvenserForYtelsen.map(p=>l.KonsekvensForYtelsen.find(B=>B.kode===p)?.navn).join(", ")})]}),e.jsxs(m,{gap:"space-4",children:[e.jsx(c,{children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Tilbakekrevingsvalg"})}),n.tilbakekrevingValg&&e.jsx(f,{size:"small",children:i.VidereBehandling.find(p=>p.kode===n.tilbakekrevingValg?.videreBehandling)?.navn})]})]})]}),e.jsx("div",{className:ke.textarea,children:e.jsx(J,{name:"begrunnelse",control:u.control,label:h.formatMessage({id:"FeilutbetalingInfoPanel.Begrunnelse"}),validate:[x,ye,me,le],maxLength:N,readOnly:a})}),e.jsx("div",{children:e.jsx(Q,{variant:"primary",size:"small",disabled:a||!u.formState.isDirty||u.formState.isSubmitting,loading:u.formState.isSubmitting,children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Confirm"})})})]})})]})};O.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingInfoPanel",props:{feilutbetalingFakta:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  behandlingFakta: {
    perioder?: {
      fom: string;
      tom: string;
