import{k as Y,al as He,j as e,aG as Ce,Z as ke,a1 as ye,W as R,X as x,B as P,d as c,b as re,a$ as yr,a2 as Je,I as F,x as Or,r as _,H as f,b0 as We,b1 as Ze,J as Ar,am as Sr,b2 as Rr,ao as ne,u as $,b4 as X,a_ as D,N as M,f as Oe,aD as Xe,b5 as Pe,b6 as Er,aH as hr,aK as oe,E as fr,aL as ce,v as Qe,b7 as Ke,aN as _r,K as Mr,aI as Pr,aF as Fr,a0 as qr,aY as Gr,aZ as Ae,P as Ir,i as jr}from"./iframe-AHoChqZU.js";import{g as Ur}from"./withIntl-CN8CrMcr.js";import{a as Lr}from"./alleTilbakekrevingKodeverk-BIIVe2EV.js";import{A as Fe}from"./index.es-BDctT3QU.js";import{t as h,O as Kr,J as wr,R as Nr,i as er,l as Vr,a as je,o as Ue,N as Se}from"./index.es-B0gbTLxo.js";import{M as i}from"./message-B-_zgcp-.js";import{S as we,T as _e,a as Br,b as xr,c as Dr,d as Yr,e as $r}from"./Timeline-BMygv-oZ.js";import{S as zr}from"./Scissors-B7WOATkt.js";import{T as K}from"./Table-BbJnK7LK.js";import{T as Hr,m as rr}from"./nb_NO-CmdOv02F.js";import{a as Cr,S as Jr}from"./SilhouetteFill-AHFA8N-i.js";/* empty css              */import"./preload-helper-PPVm8Dsz.js";const Wr="_button_8q57x_1",Zr="_cancelButton_8q57x_5",Ne={button:Wr,cancelButton:Zr},Xr=(r,t)=>n=>n&&(wr(n)(c(r.tom.toString()).subtract(1,"day"))||Nr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,Qr=(r,t)=>{const n=c(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},l={fom:n.format(Or),tom:t.tom};return{forstePeriode:a,andrePeriode:l}},nr=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:l})=>{const s=Y(),u=He();return e.jsx(Ce,{formMethods:u,onSubmit:p=>l(Qr(p,r)),children:e.jsxs(ke,{open:t,"aria-label":s.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(ke.Header,{children:e.jsx(ye,{size:"small",level:"2",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(ke.Body,{children:e.jsxs(R,{gap:"space-16",children:[e.jsxs("div",{children:[e.jsx(x,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(P,{size:"small",children:`${c(r.fom.toString()).format(re)} - ${c(r.tom.toString()).format(re)}`})]}),e.jsx(yr,{name:"forstePeriodeTomDato",control:u.control,label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[h,Kr,Xr(r,s)],fromDate:c(r.fom).toDate(),toDate:c(r.tom).toDate()}),a&&e.jsx(Je,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(ke.Footer,{children:[e.jsx(F,{size:"small",variant:"primary",className:Ne.button,disabled:!u.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(F,{size:"small",variant:"secondary",onClick:n,className:Ne.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};nr.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
