import{F as y,_ as Fe}from"./index.es-y3XBOrzW.js";import{c as Z,aa as oe,j as e,aw as le,V as h,aA as we,H as E,aS as Re,U as he,aT as Y,d as k,y as P,M as K,I as de,L as ne,B as _,n as L,A as xe,m as Se,r as R,aU as ue,aV as me,an as Ee,aW as Ae,ae as Me,aX as Oe,ay as Ve,av as Ie,z as Be,aL as Ne,aB as _e,aY as Le,P as Ue,h as Ke}from"./iframe-Blg1GlFL.js";import{t as N,a as Ce,o as Ge,N as ze,O as Q,F as $e,J as Ze,R as He}from"./style-SMN6Wg51.js";import{M as g}from"./message-HjqXgkwr.js";import{S as ee,T as J,a as We,b as Je,c as Xe,d as Ye,e as Qe,f as er}from"./Timeline-DwAC4AU9.js";import{S as rr}from"./Scissors-CE9nv4A5.js";import{a as nr,S as tr}from"./SilhouetteFill-DsrWU4cP.js";import"./preload-helper-D9Z9MdNV.js";var H=(r=>(r.VURDER_FORELDELSE="5003",r))(H||{});const ir=Ce(3),ar=Ge(1500),sr=r=>r!==y.UDEFINERT?r:void 0,or=r=>r.foreldet?r.foreldet:sr(r.foreldelseVurderingType),lr=r=>({...r,foreldet:or(r)}),ge=({skjulPeriode:r,readOnly:n,periode:t,oppdaterPeriode:d,kodeverkSamlingFpTilbake:b})=>{const p=Z(),i=oe({defaultValues:lr(t)}),f=i.watch("foreldet"),c=f&&f===y.FORELDET,T=f&&f===y.TILLEGGSFRIST,u=b.ForeldelseVurderingType.filter(s=>s.kode!==y.IKKE_VURDERT&&s.kode!==y.UDEFINERT);return e.jsx(le,{formMethods:i,onSubmit:s=>d(s),children:e.jsxs(h,{gap:"space-16",children:[e.jsx(we,{name:"begrunnelse",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[N,ir,ar,ze],maxLength:1500,readOnly:n}),e.jsxs(E,{gap:"space-40",children:[e.jsx(Re,{name:"foreldet",control:i.control,label:e.jsx(g,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[N],isReadOnly:n,children:u.map(s=>e.jsx(he,{value:s.kode,size:"small",children:s.navn},s.kode))}),e.jsxs(h,{gap:"space-20",children:[(c||T)&&e.jsx(Y,{name:"foreldelsesfrist",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[N,Q],isReadOnly:n}),T&&e.jsx(Y,{name:"oppdagelsesDato",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[N,Q,$e],isReadOnly:n,fromDate:k("1970-01-01").toDate(),toDate:k().toDate()})]})]}),e.jsxs(E,{gap:"space-16",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!i.formState.isDirty||i.formState.isSubmitting||n,loading:i.formState.isSubmitting,children:e.jsx(g,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(g,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ge.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const se=(r,n)=>k(r.fom).diff(k(n.fom)),Dr=()=>k().subtract(30,"months").format(L),Fr=r=>r?[e.jsx(g,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Dr()}},"vurderForeldelse")]:[],re=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===y.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),wr=(r=[])=>r.map((n,t)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:re(n),isGodkjent:y.FORELDET!==n.foreldet&&y.UDEFINERT!==n.foreldet,id:t})),Rr=r=>({foreldelsePerioder:r.map(t=>({fraDato:t.fom,tilDato:t.tom,begrunnelse:t.begrunnelse,foreldelseVurderingType:t.foreldet,foreldelsesfrist:t.foreldelsesfrist,oppdagelsesDato:t.oppdagelsesDato})),kode:H.VURDER_FORELDELSE}),hr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,xr=r=>[...r].sort(hr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===y.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:_e(n.begrunnelse)})),be=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t,aksjonspunkt:d,alleMerknaderFraBeslutter:b,perioderForeldelse:p,readOnly:i,kodeverkSamlingFpTilbake:f,beregnBelop:c,behandlingUuid:T,formData:u,setFormData:s})=>{const v=xr(p.perioder),[o,x]=R.useState(u||v),[a,D]=R.useState(o?.find(re)),[S,m]=R.useState(!1),[V,A]=R.useState(!!u),F=l=>{const j=l?o.find(q=>q.fom===l.fom&&q.tom===l.tom):void 0;D(j)},te=()=>{const l=o.findIndex(q=>q.fom===a?.fom&&q.tom===a?.tom),j=l===o.length-1?l:l+1;F(o[j])},I=()=>{const l=o.findIndex(q=>q.fom===a?.fom&&q.tom===a?.tom),j=l===0?l:l-1;F(o[j])},M=()=>{F(void 0)},ve=l=>{const j=Le(l,"erSplittet"),U=o.filter(w=>w.fom!==j.fom&&w.tom!==j.tom).concat(j).sort(se);x(U),s(U),A(!0),M();const B=U.find(re);B&&F(B)},Te=l=>{const j=o.find(w=>w.fom===a?.fom&&w.tom===a?.tom);if(j===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${a?.fom} Tom: ${a?.tom}`);const q=l.map(w=>({...j,...w,erSplittet:!0})),B=o.filter(w=>w.fom!==a?.fom&&w.tom!==a?.tom).concat(q).sort(se);x(B),s(B),A(!0),M(),F(q[0])},je=()=>{m(!0),r(Rr(o))},qe=b[H.VURDER_FORELDELSE],W=wr(o),Pe=Oe(d),De=W.every(l=>!l.isAksjonspunktOpen),ie=a?W.find(l=>l.fom===a.fom&&l.tom===a.tom):void 0;return e.jsx(Ve,{merknaderFraBeslutter:qe,withoutBorder:!0,children:e.jsxs(h,{gap:"space-16",children:[e.jsx(de,{size:"small",level:"2",children:e.jsx(g,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),o&&d&&e.jsxs(h,{gap:"space-16",children:[Pe&&e.jsx(Ie,{children:Fr(d)}),e.jsx(fe,{perioder:W,valgtPeriode:ie,setPeriode:F,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t}),a&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":ie?.id.toString(),children:e.jsx(Be.New,{borderWidth:"1",padding:"4",children:e.jsxs(h,{gap:"space-16",children:[e.jsx(ke,{setNestePeriode:te,setForrigePeriode:I,valgtPeriode:a,readOnly:i,oppdaterSplittedePerioder:Te,behandlingUuid:T,beregnBelop:c,lukkPeriode:M}),e.jsx(ye,{feilutbetaling:a.feilutbetaling,fom:a.fom,tom:a.tom}),e.jsx(ge,{periode:a,oppdaterPeriode:ve,skjulPeriode:M,readOnly:i,kodeverkSamlingFpTilbake:f},a.fom)]})})}),e.jsx(E,{children:e.jsx(Ne,{isReadOnly:i,isDirty:V,isSubmittable:!a&&De,onClick:je,isSubmitting:S})})]})]})})};be.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
