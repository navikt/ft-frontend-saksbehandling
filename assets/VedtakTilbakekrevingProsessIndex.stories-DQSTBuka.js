import{h as D,m as Z,r as W,j as e,D as I,aw as X,V as T,O as U,e as ee,L as B,B as b,ax as te,aa as re,as as ne,H as E,aS as ie,A as ae,aU as se,ao as le,ad as c,P as ue,l as de}from"./iframe-DQj-1hI0.js";import{a as ke}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as oe,a as ge,N as _,o as M,m as me,Z as ve}from"./style-BbH34Im7.js";import{c as pe}from"./index-BT4Wiva4.js";import{S as be}from"./PlusCircle-DtQU-KUN.js";import{M as m}from"./message-Y2g9lHpZ.js";import{E as h}from"./ExpansionCard-COfAFQo3.js";import{T as s}from"./Table-Ceuot7E6.js";var x=(n=>(n.FORSETT="FORSETT",n.GROVT_UAKTSOM="GROVT_UAKTSOM",n.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",n))(x||{});const v={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"};var K=(n=>(n.FORESLA_VEDTAK="5004",n))(K||{});const ye="_addCircleIcon_84ecs_1",fe="_imageText_84ecs_7",ce="_addPeriode_84ecs_12",w={addCircleIcon:ye,imageText:fe,addPeriode:ce},L=ge(3),Te=M(4e3),qe=[L,_],Ae=[oe,L,_],C=({type:n,readOnly:i,fritekstPakrevet:r,maximumLength:t})=>{const a=D(),{watch:d,control:l}=Z(),o=d(n)===void 0,[k,g]=W.useState(o&&!r),p=r?Ae:qe;return p.push(t?M(t):Te),e.jsxs(e.Fragment,{children:[k&&!i&&e.jsx(e.Fragment,{children:e.jsxs("div",{onClick:u=>{u.preventDefault(),g(!1)},onKeyDown:u=>{u.preventDefault(),g(!1)},className:w.addPeriode,role:"button",tabIndex:0,children:[e.jsx(be,{className:w.addCircleIcon,title:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),e.jsx(I,{size:"small",className:w.imageText,children:e.jsx(m,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})}),!k&&e.jsx(X,{name:n,control:l,label:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:p,maxLength:t||4e3,readOnly:i})]})};C.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{type:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},fritekstPakrevet:{required:!1,tsType:{name:"boolean"},description:""},maximumLength:{required:!1,tsType:{name:"number"},description:""}}};const he="_container_aetpe_1",je="_gulmarkering_aetpe_4",S={container:he,gulmarkering:je},R=({intl:n,vedtaksbrevAvsnitt:i,readOnly:r,perioderSomIkkeHarUtfyltObligatoriskVerdi:t,fritekstOppsummeringPakrevdMenIkkeUtfylt:a=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:d})=>e.jsxs(T,{gap:"2",className:S.container,children:[e.jsx(U,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),i.map(l=>{const o=l.underavsnittsliste,k=`${l.fom}_${l.tom}`,g=t.some(u=>u===k),p=l.avsnittstype===v.OPPSUMMERING&&a;return e.jsx(ee.Fragment,{children:e.jsxs(h,{"aria-label":"periode",defaultOpen:g||p,className:g||p?S.gulmarkering:"",children:[e.jsx(h.Header,{children:e.jsx(h.Title,{size:"small",children:l.overskrift?l.overskrift:n.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),e.jsx(h.Content,{children:e.jsx(T,{gap:"2",children:o.map(u=>e.jsxs(T,{gap:"2",children:[u.overskrift&&e.jsx(B,{size:"small",children:u.overskrift}),u.brødtekst&&e.jsx(b,{size:"small",children:u.brødtekst}),u.fritekstTillatt&&e.jsx(e.Fragment,{children:e.jsx(C,{type:u.underavsnittstype?`${k}.${u.underavsnittstype}`:l.avsnittstype,readOnly:r,fritekstPakrevet:u.fritekstPåkrevet,maximumLength:d?1e4:void 0})})]},(u.underavsnittstype||"")+u.overskrift+u.brødtekst))})})]})},l.avsnittstype+l.fom)})]});R.buildInitialValues=n=>n.filter(i=>i.underavsnittsliste.some(r=>r.fritekst)).reduce((i,r)=>{const a=r.underavsnittsliste.filter(l=>l.fritekst).reduce((l,o)=>({...l,[o.underavsnittstype?o.underavsnittstype:r.avsnittstype]:te(o.fritekst)}),{}),d=r.fom?{[`${r.fom}_${r.tom}`]:a}:a;return{...i,...d}},{});R.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"vedtaksbrevAvsnitt",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avsnittstype: string;
  fom?: string;
  tom?: string;
  overskrift?: string;
  ...
  underavsnittstype?: string;
  fritekstPåkrevet?: boolean;
}[]`,required:!0}}]}}],raw:"VedtaksbrevAvsnitt[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},perioderSomIkkeHarUtfyltObligatoriskVerdi:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},fritekstOppsummeringPakrevdMenIkkeUtfylt:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""}}};const Re="_buttonLink_sudxz_1",Pe="_padding_sudxz_8",we="_infoTextIcon_sudxz_14",V={buttonLink:Re,padding:Pe,infoTextIcon:we},H=n=>{const i=se(n,v.OPPSUMMERING);return{oppsummeringstekst:n[v.OPPSUMMERING],perioderMedTekst:Object.keys(i).map(r=>({fom:r.split("_")[0],tom:r.split("_")[1],faktaAvsnitt:i[r][v.FAKTA],foreldelseAvsnitt:i[r][v.FORELDELSE],vilkaarAvsnitt:i[r][v.VILKAR],saerligeGrunnerAvsnitt:i[r][v.SARLIGEGRUNNER],saerligeGrunnerAnnetAvsnitt:i[r][v.SARLIGEGRUNNER_ANNET]}))}},Ve=(n,i)=>n.some(r=>r.avsnittstype===v.OPPSUMMERING&&r.underavsnittsliste.some(t=>t.fritekstPåkrevet)&&!i[v.OPPSUMMERING]),Be=n=>({kode:K.FORESLA_VEDTAK,...H(n)}),xe=(n,i)=>n.reduce((r,t)=>{const a=`${t.fom}_${t.tom}`,d=i[a];return t.underavsnittsliste.some(k=>k.fritekstPåkrevet&&k.underavsnittstype===v.FAKTA)&&(!d||!d[v.FAKTA])||t.underavsnittsliste.some(k=>k.fritekstPåkrevet&&k.underavsnittstype===v.SARLIGEGRUNNER_ANNET)&&(!d||!d[v.SARLIGEGRUNNER_ANNET])?r.concat(a):r},[]),G=(n,i,r)=>t=>{n({uuid:i,...H(r)}),t.preventDefault()},z=({submitCallback:n,readOnly:i,fetchPreviewVedtaksbrev:r,avsnittsliste:t,behandlingUuid:a,erRevurderingTilbakekrevingKlage:d,erRevurderingTilbakekrevingFeilBeløpBortfalt:l,formData:o,setFormData:k})=>{const g=t,p=o||R.buildInitialValues(g),u=D(),y=re({defaultValues:p}),f=y.watch(),P=Ve(g,f),q=xe(g,f),Q=P||q.length>0;return e.jsx(ne,{formMethods:y,onSubmit:A=>n(Be(A)),setDataOnUnmount:k,children:e.jsxs(T,{gap:"4",children:[e.jsx(R,{intl:u,vedtaksbrevAvsnitt:g,readOnly:i,perioderSomIkkeHarUtfyltObligatoriskVerdi:q,fritekstOppsummeringPakrevdMenIkkeUtfylt:P,erRevurderingTilbakekrevingFeilBeløpBortfalt:l}),e.jsxs(E,{gap:"10",children:[e.jsx(ie,{text:u.formatMessage({id:"TilbakekrevingVedtakForm.TilGodkjenning"}),isReadOnly:i,isSubmittable:q.length===0&&!P,isSubmitting:y.formState.isSubmitting,isDirty:y.formState.isDirty,hasErrors:Q}),q.length===0&&e.jsx("div",{className:V.padding,children:e.jsx("a",{href:"",onClick:G(r,a,f),onKeyDown:A=>A.key==="Enter"?G(r,a,f)(A):null,className:pe(V.buttonLink,"lenke lenke--frittstaende"),children:e.jsx(m,{id:"TilbakekrevingVedtakForm.ForhandvisBrev"})})})]}),d&&e.jsxs(E,{children:[e.jsx(ae,{className:V.infoTextIcon}),e.jsx(m,{id:"TilbakekrevingVedtakForm.Infotekst.Klage"})]})]})})};z.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakForm",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavnTilbakekreving<K>[]"}}]}},description:""}}};const $=({submitCallback:n,readOnly:i,resultat:r,perioder:t,kodeverkSamlingFpTilbake:a,behandlingUuid:d,avsnittsliste:l,fetchPreviewVedtaksbrev:o,erRevurderingTilbakekrevingKlage:k,erRevurderingTilbakekrevingFeilBeløpBortfalt:g,formData:p,setFormData:u})=>{var y;return e.jsxs(T,{gap:"4",children:[e.jsx(U,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtak"})}),e.jsxs("div",{children:[e.jsx(I,{children:e.jsx(m,{id:"TilbakekrevingVedtak.Resultat"})}),e.jsx(b,{size:"small",children:(y=a.VedtakResultatType.find(f=>f.kode===r))==null?void 0:y.navn})]}),e.jsx(Y,{perioder:t,kodeverkSamlingFpTilbake:a}),e.jsx(z,{submitCallback:n,readOnly:i,behandlingUuid:d,avsnittsliste:l,fetchPreviewVedtaksbrev:o,erRevurderingTilbakekrevingKlage:k,erRevurderingTilbakekrevingFeilBeløpBortfalt:g,formData:p,setFormData:u})]})};$.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtak",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
