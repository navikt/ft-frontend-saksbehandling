import{aM as _,aN as L,d as G,x as D,j as n,r as q,an as m,E as F,X as K,Y as T,a8 as V,H as B,B as M,aO as h,a3 as j,a1 as O,a2 as w}from"./iframe-DhpJkxJ1.js";import{I as c,T as y}from"./index.es-BDctT3QU.js";import{T as l}from"./Table-BVvNUCAC.js";import{M as o}from"./message-CkDnx30t.js";import{S as U}from"./Spacer-Cds6m8nG.js";var N=(e=>(e.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS="FASTSETT_BG_AT_FL",e.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE="VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN",e.VURDER_VARIG_ENDRET_ARBEIDSSITUASJON="VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV",e.FASTSETT_BRUTTO_BEREGNINGSGRUNNLAG_SELVSTENDIG_NAERINGSDRIVENDE="FASTSETT_BG_SN",e.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD="FASTSETT_BG_TB_ARB",e.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET="FASTSETT_BG_SN_NY_I_ARB_LIVT",e.VURDER_GRADERING_UTEN_BEREGNINGSGRUNNLAG="VURDER_GRADERING_UTEN_BG",e))(N||{});const Y=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),Re=new Set(["VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV","VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_SN_NY_I_ARB_LIVT"]),be=new Set(["FASTSETT_BG_AT_FL","FASTSETT_BG_TB_ARB"]),ye=e=>e.some(r=>J(r)&&r.kanLoses),J=e=>Y.has(e.definisjon),I=(...e)=>r=>e.includes(r.definisjon),Ie=(e,r)=>(r?.perioder?r.perioder.filter(t=>t.vurderesIBehandlingen&&!t.erForlengelse):[]).some(t=>t.periode.fom===e),Pe=e=>e.length>0?e[0].beregningsgrunnlagPrStatusOgAndel??[]:[],x=e=>e.overstyrtPrAar!==null&&e.overstyrtPrAar!==void 0?!0:e.erTilkommetAndel===!1&&e.lagtTilAvSaksbehandler===!1,H=(e,r)=>{const a=e.perioder.find(({periode:t})=>t.fom===r);if(!a)throw new Error(`Finner ikke vilkårsperiode med fom ${r}`);return a};var P=(e=>(e.OPPFYLT="OPPFYLT",e.IKKE_OPPFYLT="IKKE_OPPFYLT",e.IKKE_VURDERT="IKKE_VURDERT",e))(P||{});const z={AT:1,FL:2,DP:3,SP_AV_DP:4,PSB_AV_DP:5,AAP:6,KUN_YTELSE:7,MS:8,BA:9,SN:10},C=260,X=new Set([y.ARBEIDSFORHOLD_AVSLUTTET,y.NATURALYTELSE_TILKOMMER,y.NATURALYTELSE_BORTFALT]),$=e=>e.besteberegningPrAar||e.besteberegningPrAar===0?e.besteberegningPrAar:e.overstyrtPrAar||e.overstyrtPrAar===0?e.overstyrtPrAar:e.beregnetPrAar??0,Q=(e,r)=>{switch(e){case"AT":case"FL":return r.find(I(N.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS,N.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD));case"SN":return r.find(I(N.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET,N.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE));case"BA":return r.find(I(N.VURDER_VARIG_ENDRET_ARBEIDSSITUASJON));default:return}},W=({arbeidsforhold:e})=>{const r=e?.naturalytelseBortfaltPrÅr,a=e?.naturalytelseTilkommetPrÅr||0;return r?r-a:0},Z=({beregnetPrAar:e,pgiSnitt:r})=>{const a=e!=null,t=r!=null;return a||t},ee=(e,r)=>{const a=e.filter(x);return Map.groupBy(a,u=>u.aktivitetStatus).entries().map(([u,s])=>{const E=Q(u,r),v=s.every(Z),d=s.reduce((i,b)=>$(b)+i,0),A=s.reduce((i,b)=>W(b)+i,0),k=(d||0)+(A||0),g=v&&!L(E);return{inntekt:d,bortfaltNaturalytelse:A,inntektPlussNaturalytelse:k,erFerdigBeregnet:g,aktivitetStatus:u}}).toArray().sort(te)},ne=e=>e.some(r=>X.has(r)),re=e=>e?G(e.beregningsgrunnlagPeriodeFom).subtract(1,"day").format(D):void 0,ae=({avklaringsbehov:e,skjaeringstidspunktBeregning:r,beregningsgrunnlagPeriode:a})=>a.filter(t=>t.beregningsgrunnlagPeriodeFom===r||ne(t.periodeAarsaker??[])).sort(_("beregningsgrunnlagPeriodeFom")).map((t,u,s)=>{const{beregningsgrunnlagPeriodeFom:E,beregningsgrunnlagPrStatusOgAndel:v,periodeAarsaker:d,redusertPrAar:A,avkortetPrAar:k,dagsats:g}=t,i=ee(v||[],e);return{fom:E,tom:re(s[u+1]),årsak:d||[],andeler:i,redusertPrAar:A,avkortetPrAar:k,dagsats:g}}),S=e=>z[e.aktivitetStatus]||100,te=(e,r)=>S(e)-S(r),le=(e,r)=>R(e)>r*6,ie=({aktivitetStatus:e})=>!!e&&e.includes("MIDL_INAKTIV"),R=e=>e.reduce((r,a)=>(a.inntektPlussNaturalytelse||0)+r,0),se=(e,r,a)=>r&&e.avkortetPrAar?e.avkortetPrAar:a&&e.redusertPrAar?e.redusertPrAar:R(e.andeler),ue=(e,r)=>r?.ytelsetype!==c.FORELDREPENGER&&e.avkortetPrAar?Math.round(e.avkortetPrAar/C):e.dagsats||0,oe="_table_1nfdc_1",me="_periodeLabel_1nfdc_14",p={table:oe,periodeLabel:me},f=({beregningsgrunnlag:e,vilkårsperiode:r,tabellPeriode:a,skalVisePeriode:t,kodeverkSamling:u})=>{const s=a.andeler.every(i=>i.erFerdigBeregnet),E=le(a.andeler,e.grunnbeløp),v=e.dekningsgrad!==100,d=r.vilkarStatus===P.OPPFYLT,A=r.vilkarStatus===P.IKKE_OPPFYLT,k=se(a,E,v),g=a.andeler.map(i=>n.jsxs(q.Fragment,{children:[n.jsxs(l.Row,{children:[n.jsx(l.DataCell,{textSize:"small",children:de(i,u)}),n.jsx(l.DataCell,{textSize:"small",align:"right",children:i.erFerdigBeregnet?n.jsx(m,{beløp:i.inntekt,kr:!0}):n.jsx(F,{size:"small",children:n.jsx(o,{id:"Dagsats.IkkeBeregnet"})})})]}),!!i.bortfaltNaturalytelse&&n.jsxs(l.Row,{children:[n.jsx(l.DataCell,{textSize:"small",children:n.jsx(o,{id:"Dagsats.Naturalytelser"})}),n.jsx(l.DataCell,{textSize:"small",align:"right",children:n.jsx(m,{beløp:i.bortfaltNaturalytelse,kr:!0})})]})]},`andel_${i.aktivitetStatus}`));return d&&E&&g.push(n.jsxs(l.Row,{children:[n.jsx(l.DataCell,{textSize:"small",children:n.jsx(o,{id:"Dagsats.AvkortetOver6G",values:{grunnbeløp:n.jsx(m,{beløp:e.grunnbeløp*6,kr:!0})}})}),n.jsx(l.DataCell,{textSize:"small",align:"right",children:n.jsx(m,{beløp:-R(a.andeler)+e.grunnbeløp*6,kr:!0})})]})),d&&v&&g.push(n.jsxs(l.Row,{children:[n.jsx(l.DataCell,{textSize:"small",children:n.jsx(o,{id:"Dagsats.Redusert"})}),n.jsx(l.DataCell,{textSize:"small",align:"right",children:n.jsx(m,{beløp:-R(a.andeler)*.2,kr:!0})})]})),n.jsxs(K,{gap:"space-8",children:[t&&n.jsx(T,{size:"small",className:p.periodeLabel,children:n.jsx(o,{id:"Dagsats.Periode",values:{periode:V(a.fom,a.tom)}})}),n.jsxs(l,{size:"small",className:p.table,children:[n.jsx(l.Body,{children:g}),s&&g.length>1&&n.jsx("tfoot",{children:n.jsxs(l.Row,{children:[n.jsx(l.HeaderCell,{textSize:"small",children:n.jsx(o,{id:"Dagsats.TotalÅrsinntekt",values:{erRedusert:E||v}})}),n.jsx(l.HeaderCell,{textSize:"small",align:"right",children:n.jsx(m,{beløp:k,kr:!0})})]})})]}),d&&s&&n.jsxs(B,{"data-row-type":"summary",paddingInline:"space-8",children:[n.jsx(M,{size:"small",children:n.jsx(o,{id:"Dagsats.BeregnetDagsats",values:{b:h,inntekt:n.jsx(m,{beløp:k,kr:!0})}})}),n.jsx(U,{}),n.jsx(T,{size:"small",children:n.jsx(m,{beløp:ue(a,e.ytelsesspesifiktGrunnlag),kr:!0})})]}),A&&s&&n.jsx(j,{variant:"error",size:"small",inline:!0,children:n.jsx(o,{id:ie(e)?"Dagsats.VilkårIkkeOppfyltMidlertidigInaktiv":"Dagsats.VilkårIkkeOppfylt",values:{grunnbeløp:n.jsx(m,{beløp:e.grunnbeløp,kr:!0})}})})]})},de=(e,r)=>{const a=r.AktivitetStatus.find(t=>t.kode===e.aktivitetStatus)?.navn??e.aktivitetStatus;return n.jsx(o,{id:"Dagsats.FastsattÅrsinntekt",values:{aktivitetStatus:a}})};f.__docgenInfo={description:"",methods:[],displayName:"Dagsats",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const ge=({beregningsgrunnlag:e,beregningsgrunnlagsvilkår:r,kodeverkSamling:a})=>{const t=H(r,e.vilkårsperiodeFom),u=ae(e);return n.jsxs(O.New,{background:"neutral-soft",padding:"5",flexBasis:"0%",flexGrow:"1",children:[n.jsx(w,{size:"small",level:"4",children:n.jsx(o,{id:"Dagsats.Tittel"})}),u.map(s=>n.jsx(f,{beregningsgrunnlag:e,vilkårsperiode:t,tabellPeriode:s,skalVisePeriode:u.length>1,kodeverkSamling:a},s.fom))]})};ge.__docgenInfo={description:"",methods:[],displayName:"Dagsatser",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};export{N as A,ge as D,P as V,x as a,be as b,J as c,Ie as e,Pe as f,ye as h,I as m,Re as Å};
