import{a as Pr}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{O as nr,P as wr,F as $,M as tr,y as Se,$ as Fr,w as Sr,D as ue,Y as Vr}from"./index.es-bvI9ibP-.js";import{g as Or}from"./withIntl-dPd_V9-L.js";import{a as _r}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as x,O as Er,H as Mr,D as Ir,l as ar,i as Gr,a as Me,o as Ie,N as he,S as ce,h as fe,I as Nr,m as Ve,d as Dr}from"./style-j4lPI8dA.js";import{u as z,E as ne,L as Ur,e as Lr,C as te,d as Te,O as ir,t as Kr,n as qe,P as $r,r as Cr}from"./index.es-D-bTLu-p.js";import{r as P}from"./index-DNHX5htx.js";import{h as M}from"./moment-C5S46NFB.js";import{G as Q,c as Ue,s as zr,J as Hr}from"./index.es-G1pRqW5a.js";import{b as sr,u as Ge}from"./index.esm-FZjZzVNN.js";import{d as j}from"./dayjs.min-Cke173X9.js";import{M as pe}from"./Modal-OqvqWSjt.js";import{H as je,L as C,a as w,D as xe,E as Yr}from"./Label-CYbek38p.js";import{M as s}from"./message-DRmKFRPQ.js";import{V as R,H as I}from"./VStack-xkjQwvKn.js";import"./Theme-C_brBVJK.js";import{A as lr}from"./Alert-Ja4tf6sE.js";import{B as F}from"./Button-Cc809GDC.js";import{S as Le,T as we,a as Jr,b as Wr,c as Xr,d as Zr,e as Qr,f as en}from"./Timeline-gAqvekd3.js";import{S as rn}from"./Scissors-slXG3Pr9.js";import{S as or,e as ur}from"./DatePicker-BW3IWtn9.js";import{S as nn}from"./XMark-6H9iuGiv.js";import{T as D}from"./Table-CAbNZsjR.js";import{T as tn,m as dr}from"./nb_NO-NuCLhxIZ.js";import{a as an,S as sn}from"./SilhouetteFill-BavFPiUa.js";import{B as ln}from"./Box-C3b4VC_S.js";/* empty css              */import"./v4-CtRu48qb.js";import"./Checkbox-BaSR81FM.js";import"./omit-B7stZg_p.js";import"./useId-CsAOvYkp.js";import"./ReadOnlyIcon-BUzfiMc5.js";import"./Loader-42dkOmtz.js";import"./Provider-BZs7ODlm.js";import"./useId-SP_zdaIa.js";import"./useFormField-Bu2NUIkp.js";import"./Fieldset-B4jGbpi0.js";import"./Tag-ntoonGP8.js";import"./Textarea-BjE6whUD.js";import"./index-DU09BupE.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-7Fg4giie.js";import"./useClientLayoutEffect-pkze6c0k.js";import"./Select-CvyZY3UD.js";import"./ChevronDown-6T9JsqER.js";import"./Radio-Pmn7OwXu.js";import"./useDatepicker-Cb-Ak60T.js";import"./Date.Input-D651xWgA.js";import"./TextField-DY81zaLa.js";import"./PersonPencilFill-DqunLdn1.js";import"./KeyVerticalFill-DmgzHF4Z.js";import"./floating-ui.react-CQaPAoM5.js";import"./BasePrimitive-gBgyIEwX.js";import"./ExclamationmarkTriangleFill-DrBUO71d.js";import"./XMarkOctagonFill-Dr7RQDrl.js";import"./useControllableState-CEDyyUuG.js";import"./Popover-w-TwxTI4.js";var V=(r=>(r.FORSTO_BURDE_FORSTAATT="FORSTO_BURDE_FORSTAATT",r.FEIL_OPPLYSNINGER="FEIL_OPPLYSNINGER",r.MANGELFULL_OPPLYSNING="MANGELFULL_OPPLYSNING",r.GOD_TRO="GOD_TRO",r))(V||{}),Ne=(r=>(r.VURDER_TILBAKEKREVING="5002",r))(Ne||{});const on="_button_8q57x_1",un="_cancelButton_8q57x_5",Ke={button:on,cancelButton:un},dn=(r,t)=>n=>n&&(Mr(n)(j(r.tom.toString()).subtract(1,"day"))||Ir(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,mn=(r,t)=>{const n=j(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},i={fom:n.format(Ur),tom:t.tom};return{forstePeriode:a,andrePeriode:i}},mr=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:i})=>{const o=z(),u=sr();return e.jsx(nr,{formMethods:u,onSubmit:k=>i(mn(k,r)),children:e.jsxs(pe,{open:t,"aria-label":o.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(pe.Header,{children:e.jsx(je,{size:"small",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(pe.Body,{children:e.jsxs(R,{gap:"4",children:[e.jsxs("div",{children:[e.jsx(C,{size:"small",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(w,{size:"small",children:`${j(r.fom.toString()).format(ne)} - ${j(r.tom.toString()).format(ne)}`})]}),e.jsx(wr,{name:"forstePeriodeTomDato",label:e.jsx(s,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[x,Er,dn(r,o)],fromDate:j(r.fom).toDate(),toDate:j(r.tom).toDate()}),a&&e.jsx(lr,{variant:"error",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(pe.Footer,{children:[e.jsx(F,{size:"small",variant:"primary",className:Ke.button,disabled:!u.formState.isDirty,children:e.jsx(s,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(F,{size:"small",variant:"secondary",onClick:n,className:Ke.cancelButton,type:"button",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};mr.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
