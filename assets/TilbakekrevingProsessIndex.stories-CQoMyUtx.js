import{i as Pe,aa as mt,j as i,av as gt,M as qr,N as Yr,V as U,L as Oe,B as H,d as V,v as Xe,aT as Ra,G as ct,F as $,t as Oa,r as W,H as ie,aU as ft,aV as kt,an as Da,aW as Pa,ad as er,n as Ae,aY as Le,aS as De,D as Nr,as as pt,aZ as cn,a_ as Aa,aw as Fa,az as cr,E as Ba,aA as Pr,ao as ht,a$ as Zn,b0 as Ya,ax as Na,au as Va,I as Ia,aL as Ua,aX as Vr,P as Ea,m as Ga}from"./iframe-_4umShaB.js";import{g as La}from"./withIntl-BiSdOXXL.js";import{a as Wa}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as I,O as Ha,J as Ca,R as za,l as yt,i as $a,a as qn,o as jn,M as Ir,b as mr,$ as fn,Z as Ka,y as vt}from"./style-BhsXTo5S.js";import{M as k}from"./message-jyMKE1c-.js";import{S as Jn,T as ln,a as Za,b as Ja,c as Qa,d as Xa,e as es,f as rs}from"./Timeline-lRA1y2sG.js";import{S as ns}from"./Scissors-BmgrkeAM.js";import{T as ce}from"./Table-DKhllZ30.js";import{T as ts,m as bt}from"./nb_NO-DQsubQTz.js";import{a as as,S as ss}from"./SilhouetteFill-D50f5K9X.js";const is="_button_8q57x_1",ls="_cancelButton_8q57x_5",Qn={button:is,cancelButton:ls},os=(e,r)=>n=>n&&(Ca(n)(V(e.tom.toString()).subtract(1,"day"))||za(n)(e.fom))?r.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,us=(e,r)=>{const n=V(e.forstePeriodeTomDato).add(1,"days"),t={fom:r.fom,tom:e.forstePeriodeTomDato},a={fom:n.format(Oa),tom:r.tom};return{forstePeriode:t,andrePeriode:a}},Tt=({periodeData:e,showModal:r,cancelEvent:n,finnesBelopMed0Verdi:t,splitPeriod:a})=>{const s=Pe(),l=mt();return i.jsx(gt,{formMethods:l,onSubmit:o=>a(us(o,e)),children:i.jsxs(qr,{open:r,"aria-label":s.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[i.jsx(qr.Header,{children:i.jsx(Yr,{size:"small",level:"2",children:i.jsx(k,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),i.jsx(qr.Body,{children:i.jsxs(U,{gap:"space-16",children:[i.jsxs("div",{children:[i.jsx(Oe,{size:"small",children:i.jsx(k,{id:"DelOppPeriodeModalImpl.Periode"})}),i.jsx(H,{size:"small",children:`${V(e.fom.toString()).format(Xe)} - ${V(e.tom.toString()).format(Xe)}`})]}),i.jsx(Ra,{name:"forstePeriodeTomDato",control:l.control,label:i.jsx(k,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[I,Ha,os(e,s)],fromDate:V(e.fom).toDate(),toDate:V(e.tom).toDate()}),t&&i.jsx(ct,{variant:"error",children:i.jsx(k,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),i.jsxs(qr.Footer,{children:[i.jsx($,{size:"small",variant:"primary",className:Qn.button,disabled:!l.formState.isDirty,children:i.jsx(k,{id:"DelOppPeriodeModalImpl.Ok"})}),i.jsx($,{size:"small",variant:"secondary",onClick:n,className:Qn.cancelButton,type:"button",children:i.jsx(k,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};Tt.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}}]}},name:"perioder"}],return:{name:"void"}}},description:""}}};const ds="_margin_1dkor_37",on={margin:ds},ms=!1,_t=({setNestePeriode:e,setForrigePeriode:r,readOnly:n,lukkPeriode:t,periode:a,beregnBelop:s,behandlingUuid:l,oppdaterSplittedePerioder:o})=>{const u=Pe(),[g,f]=W.useState(!1),[y,h]=W.useState(!1),A=S=>{f(!0),S.preventDefault()},F=()=>{f(!1)},we=S=>{h(!1);const te={belop:a.feilutbetaling,fom:S.forstePeriode.fom,tom:S.forstePeriode.tom,begrunnelse:a.begrunnelse?a.begrunnelse:" "},B={belop:a.feilutbetaling,fom:S.andrePeriode.fom,tom:S.andrePeriode.tom,begrunnelse:a.begrunnelse?a.begrunnelse:" "};s({behandlingUuid:l,perioder:[te,B]}).then(M=>{const{perioder:Se}=M;if(Se.some(Fe=>Fe.belop===0))h(!0);else{const Fe={fom:te.fom,tom:te.tom,feilutbetaling:Se[0].belop},Be={fom:B.fom,tom:B.tom,feilutbetaling:Se[1].belop};F(),o([Fe,Be])}})};return i.jsxs(ie,{children:[i.jsxs(Oe,{size:"small",children:[i.jsx(k,{id:"PeriodeController.Detaljer"}),ms]}),!n&&i.jsxs(i.Fragment,{children:[i.jsx(Jn,{}),i.jsx($,{className:on.margin,size:"xsmall",icon:i.jsx(ns,{"aria-hidden":!0}),onClick:A,variant:"tertiary-neutral",type:"button",title:u.formatMessage({id:"PeriodeController.DelOppPerioden"}),children:i.jsx(k,{id:"PeriodeController.DelOppPerioden"})})]}),g&&i.jsx(Tt,{cancelEvent:F,showModal:g,periodeData:a,splitPeriod:we,finnesBelopMed0Verdi:y}),i.jsx(Jn,{}),i.jsx($,{className:on.margin,size:"xsmall",icon:i.jsx(ft,{"aria-hidden":!0}),onClick:r,variant:"secondary-neutral",type:"button",title:u.formatMessage({id:"PeriodeController.prevPeriod"}),children:i.jsx(k,{id:"PeriodeController.prevPeriodShort"})}),i.jsx($,{className:on.margin,size:"xsmall",icon:i.jsx(kt,{"aria-hidden":!0}),onClick:e,variant:"secondary-neutral",type:"button",title:u.formatMessage({id:"PeriodeController.nextPeriod"}),iconPosition:"right",children:i.jsx(k,{id:"PeriodeController.nextPeriodShort"})}),i.jsx($,{size:"xsmall",icon:i.jsx(Da,{"aria-hidden":!0}),onClick:t,variant:"tertiary-neutral",type:"button",title:u.formatMessage({id:"PeriodeController.LukkPeriode"})})]})};_t.__docgenInfo={description:"",methods:[],displayName:"PeriodeController",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},beregnBelop:{required:!0,tsType:{name:"signature",type:"function",raw:"(params: BeregnBeløpParams) => Promise<{ perioder: { belop: number }[] }>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
...
Presentationskomponent`,methods:[],displayName:"PeriodeInformasjon",props:{fom:{required:!0,tsType:{name:"string"},description:""},tom:{required:!0,tsType:{name:"string"},description:""},feilutbetaling:{required:!0,tsType:{name:"number"},description:""},arsakHendelseNavn:{required:!1,tsType:{name:"string"},description:""}}};var G=(e=>(e.FORSETT="FORSETT",e.GROVT_UAKTSOM="GROVT_UAKTSOM",e.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",e))(G||{});const hu=["SIMPEL_UAKTSOM","GROVT_UAKTSOM","FORSETT"];var ka=(e=>(e.GRAD_AV_UAKTSOMHET="GRAD_AV_UAKTSOMHET",e.HELT_ELLER_DELVIS_NAVS_FEIL="HELT_ELLER_DELVIS_NAVS_FEIL",e.STOERRELSE_BELOEP="STOERRELSE_BELOEP",e.TID_FRA_UTBETALING="TID_FRA_UTBETALING",e.ANNET="ANNET",e))(ka||{});const pa=({name:e,readOnly:r,erValgtResultatTypeForstoBurdeForstaatt:n})=>{const t=Ae(),a=`${e}.skalDetTilleggesRenter`;return W.useEffect(()=>{t.getValues(a)===void 0&&t.setValue(a,!1)},[]),i.jsx("div",{children:i.jsxs(Le,{alignOffset:n?320:360,children:[n&&i.jsxs(U,{gap:"space-16",children:[i.jsx(Oe,{size:"small",children:i.jsx(k,{id:"AktsomhetGradForsettFormPanel.Andel"})}),i.jsx(H,{size:"small",children:"100 %"}),i.jsx(De,{name:`${e}.skalDetTilleggesRenter`,control:t.control,label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.SkalTilleggesRenter"}),validate:[I],radios:[{label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Ja"}),value:"true"},{label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Nei"}),value:"false"}],isReadOnly:r,parse:s=>s==="true",isHorizontal:!0})]}),!n&&i.jsxs(U,{gap:"space-8",children:[i.jsxs("div",{children:[i.jsx(Nr,{children:i.jsx(k,{id:"AktsomhetGradForsettFormPanel.Andel"})}),i.jsx(H,{size:"small",children:"100 %"})]}),i.jsx(H,{size:"small",children:i.jsx(k,{id:"AktsomhetGradForsettFormPanel.Renter"})})]})]})})};pa.__docgenInfo={description:"",methods:[],displayName:"AktsomhetGradForsettFormPanel",props:{name:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},erValgtResultatTypeForstoBurdeForstaatt:{required:!1,tsType:{name:"boolean"},description:""}}};const yr="Egendefinert",_n=["30","50","70",yr],yu="_suffix_cawxu_1",vu="_suffixGrovText_cawxu_4",bu="_labelPadding_cawxu_8",Tu="_inputFelt_cawxu_12",ze={suffix:yu,suffixGrovText:vu,labelPadding:bu,inputFelt:Tu},st=yt(0),_u=$a(99.99),wu=e=>{const r=e.toString().replace(/\s/g,""),n=parseInt(r,10);return Number.isNaN(n)?"":n},Su=(e,r)=>n=>{if((typeof n=="string"?Number(n):n)>=r)return e.formatMessage({id:"TilbakekrevingPeriodeForm.BelopMaVereMindreEnnFeilutbetalingen"})},ha=({name:e,harGrunnerTilReduksjon:r,readOnly:n,handletUaktsomhetGrad:t,harMerEnnEnYtelse:a,feilutbetalingBelop:s,andelSomTilbakekreves:l})=>{const o=Pe(),u=Ae(),g=`${e}.skalDetTilleggesRenter`;return W.useEffect(()=>{u.getValues(g)===void 0&&u.setValue(g,!1)},[]),i.jsxs(U,{gap:"space-16",children:[i.jsx(De,{name:`${e}.harGrunnerTilReduksjon`,control:u.control,label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.SkalSarligeGrunnerGiReduksjon"}),validate:[I],radios:[{label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Ja"}),value:"true"},{label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Nei"}),value:"false"}],isReadOnly:n,isTrueOrFalseSelection:!0,isHorizontal:!0}),r&&i.jsx(Le,{alignOffset:24,children:i.jsxs(ie,{gap:"space-16",children:[!a&&l!==yr&&i.jsxs(i.Fragment,{children:[i.jsx(Oe,{size:"small",children:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.AngiAndelSomTilbakekreves"})}),i.jsxs(ie,{gap:"space-8",children:[i.jsx(pt,{name:`${e}.andelSomTilbakekreves`,control:u.control,label:"",validate:[I],selectValues:_n.map(f=>i.jsx("option",{value:f,children:f},f))}),i.jsx("div",{className:ze.suffix,children:"%"})]})]}),!a&&l===yr&&i.jsxs(i.Fragment,{children:[i.jsx(Oe,{size:"small",children:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.AngiAndelSomTilbakekreves"})}),i.jsxs(ie,{gap:"space-16",children:[i.jsx(cn,{name:`${e}.andelSomTilbakekrevesManuell`,control:u.control,className:ze.inputFelt,readOnly:n,validate:[I,st,_u],normalizeOnBlur:f=>Number.isNaN(f)?f:parseFloat(f.toString()).toFixed(2),format:f=>f.toString().replace(".",","),parse:f=>f.toString().replace(",",".")}),i.jsx("div",{className:t===G.GROVT_UAKTSOM?ze.suffixGrovText:ze.suffix,children:"%"})]})]}),a&&i.jsx(cn,{name:`${e}.belopSomSkalTilbakekreves`,control:u.control,label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.AngiBelopSomSkalTilbakekreves"}),validate:[I,st,Su(o,s)],readOnly:n,format:er,parse:wu}),t===G.GROVT_UAKTSOM&&i.jsxs("div",{children:[i.jsx(Nr,{children:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.SkalTilleggesRenter"})}),i.jsx(H,{size:"small",className:ze.labelPadding,children:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Nei"})})]})]})}),r===!1&&i.jsxs(Le,{alignOffset:90,children:[i.jsx(Nr,{children:i.jsx(k,{id:a?"AktsomhetReduksjonAvBelopFormPanel.BelopSomSkalTilbakekreves":"AktsomhetReduksjonAvBelopFormPanel.andelSomTilbakekreves"})}),i.jsxs(U,{gap:"space-16",children:[i.jsx(H,{size:"small",className:ze.labelPadding,children:a?er(s):"100%"}),t===G.GROVT_UAKTSOM&&i.jsx(De,{name:g,control:u.control,label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.SkalTilleggesRenter"}),validate:[I],radios:[{label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Ja"}),value:"true"},{label:i.jsx(k,{id:"AktsomhetReduksjonAvBelopFormPanel.Nei"}),value:"false"}],isReadOnly:n,isTrueOrFalseSelection:!0,isHorizontal:!0})]})]})]})};ha.__docgenInfo={description:"",methods:[],displayName:"AktsomhetReduksjonAvBelopFormPanel",props:{name:{required:!0,tsType:{name:"string"},description:""},harGrunnerTilReduksjon:{required:!1,tsType:{name:"boolean"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},handletUaktsomhetGrad:{required:!1,tsType:{name:"string"},description:""},harMerEnnEnYtelse:{required:!0,tsType:{name:"boolean"},description:""},feilutbetalingBelop:{required:!0,tsType:{name:"number"},description:""},andelSomTilbakekreves:{required:!1,tsType:{name:"string"},description:""}}};const qu=qn(3),ju=jn(1500),wn=({name:e,harGrunnerTilReduksjon:r,readOnly:n,handletUaktsomhetGrad:t,erSerligGrunnAnnetValgt:a,sarligGrunnTyper:s,harMerEnnEnYtelse:l,feilutbetalingBelop:o,andelSomTilbakekreves:u})=>{const g=Pe(),{watch:f,control:y}=Ae(),h=!s.some(F=>!!f(`${e}.${F.kode}`)),A=Aa(e,h?g.formatMessage({id:"TilbakekrevingPeriodeForm.MaVelgeSarligGrunn"}):void 0);return i.jsxs(U,{gap:"space-16",children:[i.jsx(Oe,{size:"small",children:i.jsx(k,{id:"AktsomhetSarligeGrunnerFormPanel.GrunnerTilReduksjon"})}),i.jsx("div",{children:s.map(F=>i.jsx(Fa,{name:`${e}.${F.kode}`,control:y,label:F.navn,readOnly:n},F.kode))}),a&&i.jsx(cr,{name:`${e}.annetBegrunnelse`,control:y,label:"",validate:[I,qu,ju,Ir],maxLength:1500,readOnly:n}),A&&i.jsx(Ba,{children:A}),i.jsx(ha,{name:e,harGrunnerTilReduksjon:r,readOnly:n,handletUaktsomhetGrad:t,harMerEnnEnYtelse:l,feilutbetalingBelop:o,andelSomTilbakekreves:u})]})};wn.__docgenInfo={description:"",methods:[],displayName:"AktsomhetSarligeGrunnerFormPanel",props:{harGrunnerTilReduksjon:{required:!1,tsType:{name:"boolean"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},handletUaktsomhetGrad:{required:!1,tsType:{name:"string"},description:""},erSerligGrunnAnnetValgt:{required:!1,tsType:{name:"boolean"},description:""},harMerEnnEnYtelse:{required:!0,tsType:{name:"boolean"},description:""},feilutbetalingBelop:{required:!0,tsType:{name:"number"},description:""},andelSomTilbakekreves:{required:!1,tsType:{name:"string"},description:""},sarligGrunnTyper:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavnTilbakekreving<K>[]"}}]}},description:""},antallPerioderMedAksjonspunkt:{required:!0,tsType:{name:"number"},description:""}}};const $u="_margin_1wl4t_1",Rr={margin:$u},Ku={danger:i.jsx(rs,{}),success:i.jsx(es,{}),warning:i.jsx(Xa,{})},Zu=(e,r)=>e.fom<r.fom?-1:e.fom>r.fom?1:0,Ju=e=>{const r=e.isGodkjent?"success":"danger";return e.isAksjonspunktOpen?"warning":r},Qu=(e=[])=>[...e].sort(Zu).map(r=>({...r,status:Ju(r)})),Xu=e=>e===mr.MOR||e===mr.MEDMOR?i.jsx(as,{width:20,height:20,color:"var(--ax-danger-300)"}):e===mr.FAR?i.jsx(ss,{width:20,height:20,color:"var(--ax-accent-700)"}):i.jsx(Qa,{width:20,height:20}),Sa=({perioder:e,valgtPeriode:r,setPeriode:n,relasjonsRolleType:t,relasjonsRolleTypeKodeverk:a})=>{const s=Pe(),l=Qu(e),o=B=>{const de=e.find(M=>M.id===B);de&&n(de)},u=V(l[0].fom),g=V(l[l.length-1].tom),[f,y]=W.useState(u),[h,A]=W.useState(g),F=()=>{f.subtract(1,"month").isBefore(u)||(y(f.subtract(1,"month")),A(h.subtract(1,"month")))},we=()=>{h.add(1,"month").isAfter(g)||(y(f.add(1,"month")),A(h.add(1,"month")))},S=()=>{f.add(3,"month").isAfter(h)||(y(f.add(1,"month")),A(h.subtract(1,"month")))},te=()=>{h.add(1,"month").diff(f.subtract(1,"month"),"months")<36&&(y(f.subtract(1,"month")),A(h.add(1,"month")))};return i.jsxs(U,{gap:"space-16",children:[i.jsx(ln,{startDate:V(f).toDate(),endDate:V(h).add(1,"days").toDate(),children:i.jsx(ln.Row,{label:a.find(B=>B.kode===t)?.navn||"-",icon:Xu(t),children:l.map(B=>i.jsx(ln.Period,{start:V(B.fom).toDate(),end:V(B.tom).toDate(),status:B.status,icon:Ku[B.status],onSelectPeriod:()=>o(B.id),isActive:r?.id===B.id,"aria-controls":"panel-tilbakekreving",id:B.id.toString()},B.id))})}),i.jsxs(ie,{justify:"end",children:[i.jsx($,{className:Rr.margin,size:"small",icon:i.jsx(Za,{"aria-hidden":!0}),onClick:S,variant:"primary-neutral",type:"button",title:s.formatMessage({id:"TilbakekrevingTimeline.ZoomInn"})}),i.jsx($,{className:Rr.margin,size:"small",icon:i.jsx(Ja,{"aria-hidden":!0}),onClick:te,variant:"primary-neutral",type:"button",title:s.formatMessage({id:"TilbakekrevingTimeline.ZoomUt"})}),i.jsx($,{className:Rr.margin,size:"small",icon:i.jsx(ft,{"aria-hidden":!0}),onClick:F,variant:"primary-neutral",type:"button",title:s.formatMessage({id:"TilbakekrevingTimeline.ScrollTilVenstre"})}),i.jsx($,{className:Rr.margin,size:"small",icon:i.jsx(kt,{"aria-hidden":!0}),onClick:we,variant:"primary-neutral",type:"button",title:s.formatMessage({id:"TilbakekrevingTimeline.ScrollTilHogre"})})]})]})};Sa.__docgenInfo={description:`TilbakekrevingTimeLine
