import{c as S,i as z,r as Y,j as e,H as B,D as J,az as W,V as h,J as G,e as V,L as F,B as N,aA as Z,a9 as Q,av as X,aK as ee,A as te,aL as re,ar as ne,at as f,P as ie,h as ae}from"./iframe-DY6AKeF1.js";import{a as se}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as le,a as ue,M as O,o as D,m as de,Z as ke}from"./style-Hz7eTGyt.js";import{S as oe}from"./PlusCircle-CwRxLdaD.js";import{M as o}from"./message-6eaHICY0.js";import{E as A}from"./ExpansionCard-BBZAPwb1.js";import{L as ge}from"./Link-B9y2zK2v.js";import{T as a}from"./Table-BHdhMbFM.js";import"./preload-helper-D9Z9MdNV.js";var w=(r=>(r.FORSETT="FORSETT",r.GROVT_UAKTSOM="GROVT_UAKTSOM",r.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",r))(w||{});const m={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"},ve="_addCircleIcon_1pxx3_1",me="_addPeriode_1pxx3_7",pe="_textfield_1pxx3_12",R={addCircleIcon:ve,addPeriode:me,textfield:pe},I=ue(3),fe=D(4e3),ye=[I,O],be=[le,I,O],U=({type:r,readOnly:n,fritekstPakrevet:t,maximumLength:i})=>{const u=S(),{watch:k,control:s}=z(),g=k(r)===void 0,[d,v]=Y.useState(g&&!t),p=t?be:ye;return p.push(i?D(i):fe),e.jsxs(e.Fragment,{children:[d&&!n&&e.jsx("div",{onClick:l=>{l.preventDefault(),v(!1)},onKeyDown:l=>{l.preventDefault(),v(!1)},className:R.addPeriode,role:"button",tabIndex:0,children:e.jsxs(B,{gap:"space-8",align:"center",children:[e.jsx(oe,{className:R.addCircleIcon,title:u.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),e.jsx(J,{as:"span",children:e.jsx(o,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})}),!d&&e.jsx(W,{className:R.textfield,name:r,control:s,label:e.jsx(o,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:p,maxLength:i||4e3,readOnly:n})]})};U.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{type:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},fritekstPakrevet:{required:!1,tsType:{name:"boolean"},description:""},maximumLength:{required:!1,tsType:{name:"number"},description:""}}};const ce="_gulmarkering_xswfh_1",Te="_paddingTop_xswfh_6",x={gulmarkering:ce,paddingTop:Te},j=({intl:r,vedtaksbrevAvsnitt:n,readOnly:t,perioderSomIkkeHarUtfyltObligatoriskVerdi:i,fritekstOppsummeringPakrevdMenIkkeUtfylt:u=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:k})=>e.jsxs(h,{gap:"space-16",children:[e.jsx(G,{size:"small",level:"2",children:e.jsx(o,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),n.map(s=>{const g=s.underavsnittsliste,d=`${s.fom}_${s.tom}`,v=i.some(l=>l===d),p=s.avsnittstype===m.OPPSUMMERING&&u;return e.jsx(V.Fragment,{children:e.jsxs(A,{size:"small","aria-label":d,defaultOpen:v||p,className:v||p?x.gulmarkering:"",children:[e.jsx(A.Header,{children:e.jsx(A.Title,{size:"small",children:s.overskrift?s.overskrift:r.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),e.jsx(A.Content,{children:e.jsx(h,{gap:"space-8",children:g.map(l=>e.jsxs(V.Fragment,{children:[l.overskrift&&e.jsx(F,{className:x.paddingTop,children:l.overskrift}),l.brødtekst&&e.jsx(N,{children:l.brødtekst}),l.fritekstTillatt&&e.jsx(U,{type:l.underavsnittstype?`${d}.${l.underavsnittstype}`:s.avsnittstype,readOnly:t,fritekstPakrevet:l.fritekstPåkrevet,maximumLength:k?1e4:void 0})]},(l.underavsnittstype??"")+l.overskrift+l.brødtekst))})})]})},s.avsnittstype+s.fom)})]});j.buildInitialValues=r=>r.filter(n=>n.underavsnittsliste.some(t=>t.fritekst)).reduce((n,t)=>{const u=t.underavsnittsliste.filter(s=>s.fritekst).reduce((s,g)=>({...s,[g.underavsnittstype?g.underavsnittstype:t.avsnittstype]:Z(g.fritekst)}),{}),k=t.fom?{[`${t.fom}_${t.tom}`]:u}:u;return{...n,...k}},{});j.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"vedtaksbrevAvsnitt",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avsnittstype: string;
  fom?: string;
  tom?: string;
  overskrift?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavnTilbakekreving<K>[]"}}]}},description:""}}};const C=({submitCallback:r,readOnly:n,resultat:t,perioder:i,kodeverkSamlingFpTilbake:u,behandlingUuid:k,avsnittsliste:s,fetchPreviewVedtaksbrev:g,erRevurderingTilbakekrevingKlage:d,erRevurderingTilbakekrevingFeilBeløpBortfalt:v,formData:p,setFormData:l})=>e.jsxs(h,{gap:"space-24",maxWidth:"1200px",children:[e.jsx(G,{size:"small",level:"2",children:e.jsx(o,{id:"TilbakekrevingVedtak.Vedtak"})}),e.jsxs("div",{children:[e.jsx(F,{children:e.jsx(o,{id:"TilbakekrevingVedtak.Resultat"})}),e.jsx(N,{children:u.VedtakResultatType.find(y=>y.kode===t)?.navn})]}),e.jsx(L,{perioder:i,kodeverkSamlingFpTilbake:u}),e.jsx(K,{submitCallback:r,readOnly:n,behandlingUuid:k,avsnittsliste:s,fetchPreviewVedtaksbrev:g,erRevurderingTilbakekrevingKlage:d,erRevurderingTilbakekrevingFeilBeløpBortfalt:v,formData:p,setFormData:l})]});C.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtak",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
