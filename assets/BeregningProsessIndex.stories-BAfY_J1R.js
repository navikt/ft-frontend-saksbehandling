...
>`}],raw:"Record<string, ArbeidsgiverOpplysninger>"},description:""}}};const F=({beregningsgrunnlag:r,arbeidsgiverOpplysningerPerId:a,kodeverkSamling:t})=>e.jsx(c.New,{background:"neutral-soft",padding:"5",children:e.jsxs(q,{gap:"space-12",children:[e.jsx(_,{size:"medium",level:"2",children:e.jsx(o,{id:"GrunnlagForBeregning.Tittel"})}),e.jsxs(G,{align:"center",children:[e.jsx(C,{kodeverkSamling:t,beregningsgrunnlagPeriode:r.beregningsgrunnlagPeriode}),e.jsx(X,{}),e.jsx(b,{size:"small",children:e.jsx(o,{id:"GrunnlagForBeregning.Skjæringstidspunkt",values:{dato:p(r.skjaeringstidspunktBeregning),b:I}})})]}),e.jsx(D,{beregningsgrunnlag:r,arbeidsgiverOpplysningerPerId:a})]})});F.__docgenInfo={description:"",methods:[],displayName:"GrunnlagForBeregning",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const K=({beregningsgrunnlag:r,beregningsgrunnlagsvilkår:a,kodeverkSamling:t,arbeidsgiverOpplysningerPerId:l})=>{const{sammenligningsgrunnlagPrStatus:n=[],inntektsgrunnlag:s}=r;return e.jsxs(q,{gap:"space-8",paddingBlock:"space-16",children:[e.jsx(F,{beregningsgrunnlag:r,beregningsgrunnlagsvilkår:a,kodeverkSamling:t,arbeidsgiverOpplysningerPerId:l}),n.length>0&&e.jsx(H,{sammenligningsgrunnlagPrStatus:n}),s&&n.length>0&&e.jsx($,{sammenligningsgrunnlagFom:n[0].sammenligningsgrunnlagFom,sammenligningsgrunnlagInntekter:s.sammenligningsgrunnlagInntekter,arbeidsgiverOpplysningerPerId:l})]})};K.__docgenInfo={description:"",methods:[],displayName:"TabInnhold",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const ge=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),de=r=>r.some(a=>ge.has(a.definisjon)&&a.kanLoses),me=(r,a)=>{const t=r.vilkårsperiodeFom;return(a?.perioder??[]).filter(n=>n.vurderesIBehandlingen&&!n.erForlengelse).some(n=>n.periode.fom===t)},ve=(r,a)=>{const t=Ee(r,a),l=t.find(g=>g.skalVurderes&&g.harAvklaringsbehov)?.bgIndex??0,[n,s]=L.useState(l);return{tabOptions:t,currentTabValue:n.toString(),onTabChange:g=>s(Number(g))}},Ee=(r,a)=>r.map((t,l)=>({bgIndex:l,skalVurderes:me(t,a),harAvklaringsbehov:de(t.avklaringsbehov),skjæringstidspunkt:t.skjaeringstidspunktBeregning,optionLabel:p(t.skjaeringstidspunktBeregning)})).sort((t,l)=>f(t.skjæringstidspunkt).diff(f(l.skjæringstidspunkt))),ke=U(Q),V=({beregningsgrunnlagListe:r,beregningsgrunnlagsvilkår:a,kodeverkSamling:t,arbeidsgiverOpplysningerPerId:l})=>{const{tabOptions:n,currentTabValue:s,onTabChange:g}=ve(r,a);return e.jsx(Y,{value:ke,children:e.jsxs(v,{value:s,onChange:g,children:[n.length>1&&e.jsx(v.List,{children:n.map(u=>e.jsx(v.Tab,{value:u.bgIndex.toString(),label:u.optionLabel,icon:u.harAvklaringsbehov?e.jsx(J,{"aria-hidden":!0,color:"var(--ax-bg-warning-strong)"}):void 0},u.bgIndex))}),n.map(u=>e.jsx(v.Panel,{value:u.bgIndex.toString(),"aria-label":u.optionLabel,children:e.jsx(K,{beregningsgrunnlag:r[u.bgIndex],beregningsgrunnlagsvilkår:a,kodeverkSamling:t,arbeidsgiverOpplysningerPerId:l})},u.bgIndex))]})})};V.__docgenInfo={description:"",methods:[],displayName:"BeregningProsessIndex",props:{beregningsgrunnlagListe:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
}`,...A.parameters?.docs?.source}}};const he=["CaseArbeidstakerMedEttArbeidsforholdFP","ToGrunnlagHvorEnHarÅpentAP","ArbeidstakerMedFlereArbeidsforhold"];export{A as ArbeidstakerMedFlereArbeidsforhold,E as CaseArbeidstakerMedEttArbeidsforholdFP,k as ToGrunnlagHvorEnHarÅpentAP,he as __namedExportsOrder,Ve as default};
