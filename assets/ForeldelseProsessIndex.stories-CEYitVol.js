import{F as y,_ as Fe}from"./index.es-DELgJj0W.js";import{k as Z,ae as oe,j as e,ay as le,V as R,aC as we,H as E,aU as he,A as Re,aV as J,d as k,v as P,N as K,Y as de,L as ne,B as _,b as L,Q as xe,x as Se,r as h,aW as ue,aX as me,w as Ee,aY as Ae,ai as Me,y as Oe,aZ as Ve,aA as Be,ax as Ie,U as Ne,aN as _e,aD as Le,aO as Ue,P as Ke,o as Ce}from"./iframe-BTh7qCSp.js";import{t as N,a as Ge,o as ze,N as $e,O as Q,F as Ze,J as He,R as We}from"./style-Bvc7TQhq.js";import{M as g}from"./message-D46nJCSz.js";import{S as ee,T as X,a as Xe,b as Ye,c as Je,d as Qe,e as er}from"./Timeline-DvOI8e51.js";import{S as rr}from"./Scissors-CZowYPL1.js";import{a as nr,S as tr}from"./SilhouetteFill-Xc18tKwg.js";import"./preload-helper-PPVm8Dsz.js";var H=(r=>(r.VURDER_FORELDELSE="5003",r))(H||{});const ir=Ge(3),ar=ze(1500),sr=r=>r!==y.UDEFINERT?r:void 0,or=r=>r.foreldet?r.foreldet:sr(r.foreldelseVurderingType),lr=r=>({...r,foreldet:or(r)}),ge=({skjulPeriode:r,readOnly:n,periode:t,oppdaterPeriode:d,kodeverkSamlingFpTilbake:b})=>{const p=Z(),i=oe({defaultValues:lr(t)}),f=i.watch("foreldet"),c=f&&f===y.FORELDET,T=f&&f===y.TILLEGGSFRIST,u=b.ForeldelseVurderingType.filter(s=>s.kode!==y.IKKE_VURDERT&&s.kode!==y.UDEFINERT);return e.jsx(le,{formMethods:i,onSubmit:s=>d(s),children:e.jsxs(R,{gap:"space-16",children:[e.jsx(we,{name:"begrunnelse",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[N,ir,ar,$e],maxLength:1500,readOnly:n}),e.jsxs(E,{gap:"space-40",children:[e.jsx(he,{name:"foreldet",control:i.control,legend:e.jsx(g,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[N],readOnly:n,children:u.map(s=>e.jsx(Re,{value:s.kode,size:"small",children:s.navn},s.kode))}),e.jsxs(R,{gap:"space-20",children:[(c||T)&&e.jsx(J,{name:"foreldelsesfrist",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[N,Q],readOnly:n}),T&&e.jsx(J,{name:"oppdagelsesDato",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[N,Q,Ze],readOnly:n,fromDate:k("1970-01-01").toDate(),toDate:k().toDate()})]})]}),e.jsxs(E,{gap:"space-16",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!i.formState.isDirty||i.formState.isSubmitting||n,loading:i.formState.isSubmitting,children:e.jsx(g,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(g,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ge.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
