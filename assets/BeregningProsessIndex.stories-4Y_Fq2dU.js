...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}},{key:"sisteLønnsendringsdato",value:{name:"string",required:!1}},{key:"stillingsprosenter",value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  fomDato: string;
  tomDato: number;
}`,signature:{properties:[{key:"prosent",value:{name:"number",required:!0}},{key:"fomDato",value:{name:"string",required:!0}},{key:"tomDato",value:{name:"number",required:!0}}]}}],raw:`Readonly<{
  prosent: number;
  fomDato: string;
  tomDato: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const N=({beregningsgrunnlag:e,beregningsgrunnlagsvilkår:n,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t})=>r.jsxs(A,{gap:"space-8",paddingBlock:"space-16",children:[r.jsx(R,{beregningsgrunnlag:e,beregningsgrunnlagsvilkår:n,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t}),e.inntektsgrunnlag&&e.sammenligningsgrunnlagPrStatus?.[0]?.sammenligningsgrunnlagFom&&r.jsx(D,{sammenligningsgrunnlagFom:e.sammenligningsgrunnlagPrStatus[0].sammenligningsgrunnlagFom,sammenligningsgrunnlagInntekter:e.inntektsgrunnlag.sammenligningsgrunnlagInntekter,arbeidsgiverOpplysningerPerId:t})]});N.__docgenInfo={description:"",methods:[],displayName:"TabInnhold",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const V=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),B=e=>e.some(n=>V.has(n.definisjon)&&n.kanLoses),h=(e,n)=>{const a=e.vilkårsperiodeFom;return(n?.perioder??[]).filter(l=>l.vurderesIBehandlingen&&!l.erForlengelse).some(l=>l.periode.fom===a)},M=(e,n)=>{const a=j(e,n),t=a.find(s=>s.skalVurderes&&s.harAvklaringsbehov)?.bgIndex??0,[l,d]=f.useState(t);return{tabOptions:a,currentTabValue:l.toString(),onTabChange:s=>d(Number(s))}},j=(e,n)=>e.map((a,t)=>({bgIndex:t,skalVurderes:h(a,n),harAvklaringsbehov:B(a.avklaringsbehov),skjæringstidspunkt:a.skjaeringstidspunktBeregning,optionLabel:b(a.skjaeringstidspunktBeregning)})).sort((a,t)=>v(a.skjæringstidspunkt).diff(v(t.skjæringstidspunkt))),O=L(F),y=({beregningsgrunnlagListe:e,beregningsgrunnlagsvilkår:n,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t})=>{const{tabOptions:l,currentTabValue:d,onTabChange:s}=M(e,n);return r.jsx(S,{value:O,children:r.jsxs(u,{value:d,onChange:s,children:[l.length>1&&r.jsx(u.List,{children:l.map(i=>r.jsx(u.Tab,{value:i.bgIndex.toString(),label:i.optionLabel,icon:i.harAvklaringsbehov?r.jsx(G,{"aria-hidden":!0,color:"var(--ax-bg-warning-strong)"}):void 0},i.bgIndex))}),l.map(i=>r.jsx(u.Panel,{value:i.bgIndex.toString(),"aria-label":i.optionLabel,children:r.jsx(N,{beregningsgrunnlag:e[i.bgIndex],beregningsgrunnlagsvilkår:n,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t})},i.bgIndex))]})})};y.__docgenInfo={description:"",methods:[],displayName:"BeregningProsessIndex",props:{beregningsgrunnlagListe:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const ee={component:y,args:{kodeverkSamling:_,arbeidsgiverOpplysningerPerId:K,beregningsgrunnlagsvilkår:null}},o={name:"Case - Arbeidstaker med ett arbeidsforhold (FP)",args:{beregningsgrunnlagListe:[E]}},m={args:{beregningsgrunnlagListe:[{...E,skjaeringstidspunktBeregning:"2025-11-01"},{...E,avklaringsbehov:[]}]}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
}`,...m.parameters?.docs?.source}}};const ne=["CaseArbeidstakerMedEttArbeidsforholdFP","ToGrunnlagHvorEnHarÅpentAP"];export{o as CaseArbeidstakerMedEttArbeidsforholdFP,m as ToGrunnlagHvorEnHarÅpentAP,ne as __namedExportsOrder,ee as default};
