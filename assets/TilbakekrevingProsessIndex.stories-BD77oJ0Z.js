import{c as z,a9 as Je,j as e,av as Ze,M as be,J as qe,V as j,L as H,B as S,d as y,n as te,aS as jr,A as Xe,z as F,m as Rr,r as P,H as A,aT as Qe,aU as er,al as Br,aa as xr,aV as Ar,ac as ae,i as C,aX as ee,aR as $,v as w,D as je,as as rr,aY as Oe,aZ as Pr,aw as wr,az as me,E as Sr,aA as Te,am as nr,a_ as De,a$ as Fr,ax as Or,au as Vr,F as Er,aK as Gr,aW as Re,P as Ir,h as _r}from"./iframe-DY6AKeF1.js";import{g as Ur}from"./withIntl-DPxchLeU.js";import{a as Mr}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as B,O as Dr,J as Nr,R as Kr,l as tr,i as Lr,a as _e,o as Ue,M as Be,b as de,$ as Ve,Z as Hr,y as ar}from"./style-Hz7eTGyt.js";import{M as i}from"./message-6eaHICY0.js";import{S as Ne,T as Se,a as $r,b as zr,c as Cr,d as Yr,e as Wr,f as Jr}from"./Timeline-C2tu2oHm.js";import{S as Zr}from"./Scissors-D_rAKfZu.js";import{T as M}from"./Table-BHdhMbFM.js";import{T as Xr,m as sr}from"./nb_NO-DFyIBXAL.js";import{a as Qr,S as en}from"./SilhouetteFill-BThCYGFp.js";import"./preload-helper-D9Z9MdNV.js";const rn="_button_8q57x_1",nn="_cancelButton_8q57x_5",Ke={button:rn,cancelButton:nn},tn=(r,t)=>n=>n&&(Nr(n)(y(r.tom.toString()).subtract(1,"day"))||Kr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,an=(r,t)=>{const n=y(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},s={fom:n.format(Rr),tom:t.tom};return{forstePeriode:a,andrePeriode:s}},ir=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:s})=>{const l=z(),u=Je();return e.jsx(Ze,{formMethods:u,onSubmit:k=>s(an(k,r)),children:e.jsxs(be,{open:t,"aria-label":l.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(be.Header,{children:e.jsx(qe,{size:"small",level:"2",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(be.Body,{children:e.jsxs(j,{gap:"space-16",children:[e.jsxs("div",{children:[e.jsx(H,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(S,{size:"small",children:`${y(r.fom.toString()).format(te)} - ${y(r.tom.toString()).format(te)}`})]}),e.jsx(jr,{name:"forstePeriodeTomDato",control:u.control,label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[B,Dr,tn(r,l)],fromDate:y(r.fom).toDate(),toDate:y(r.tom).toDate()}),a&&e.jsx(Xe,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(be.Footer,{children:[e.jsx(F,{size:"small",variant:"primary",className:Ke.button,disabled:!u.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(F,{size:"small",variant:"secondary",onClick:n,className:Ke.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};ir.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
