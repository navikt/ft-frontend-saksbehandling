import{a as Me}from"./chunk-D5ZWXAHU-DlerbUHg.js";import{m as b,S as pe,e as B,N as Oe,O as ee,b as Ie,a as Ve,l as Be,H as Ne,D as _e,h as Z,c as ke,d as Le}from"./style-BR8WP_Fa.js";import{j as e}from"./jsx-runtime-CLpGMVip.js";import{u as W,P as Ue}from"./index-D9DDUrbY.js";import{d as y,P as _,A as Ce,e as Ke,g as Ge,j as ze,a as He,n as $e}from"./index.es-Dh3mAfPy.js";import{r as l}from"./index-B5OHeJSP.js";import{r as ye,e as Ze,Z as We,X as re,K as Xe}from"./index.es-kUJJLXnO.js";import{W as Ye,N as Je}from"./index.es-BdLW2Tvk.js";import{c as fe}from"./ReadOnlyIcon-3mCRcvzc.js";import{V as S,H as O}from"./VStack-DrfGxCua.js";import{M as p}from"./message-BcVJpMje.js";import{B as D}from"./Button-C4dKKha_.js";import{M as K}from"./Modal-C6iE4cX-.js";import{H as be,L as te,a as L}from"./Label-ZYbyet41.js";import{A as Qe}from"./Alert-Pz1mMbfe.js";import{S as ne,T as J,a as er,b as rr,c as nr,d as tr,e as ar,f as ir}from"./Timeline-Dqkdb2KD.js";import{S as sr}from"./Scissors-DZqh_mpJ.js";import{S as ve,a as ce}from"./DatePicker-DoJN_gWH.js";import{S as or}from"./XMark-BWJopseo.js";import{a as lr,S as dr}from"./SilhouetteFill-DMHyitGq.js";import{B as ur}from"./Box-B_1ucAEI.js";/* empty css              */import"./v4-CtRu48qb.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Checkbox-CHErwGPi.js";import"./clsx-B-dksMZM.js";import"./omit-B7stZg_p.js";import"./useId-e75EoDiw.js";import"./useFormField-BKpVC0Pg.js";import"./Fieldset-Cs108nF-.js";import"./Tag-DqR_3-Kz.js";import"./Textarea-DQ7w4yc6.js";import"./index-sT6466e8.js";import"./index-DYwZEShM.js";import"./useClientLayoutEffect-DnVV5Q77.js";import"./create-context-BlrHNsQj.js";import"./Loader-CoAqN6Lw.js";import"./Provider-B_QIWjIe.js";import"./useDatepicker-oJRfFMcH.js";import"./useDateTranslationContext-DuYWebvA.js";import"./Radio-BIYAymoT.js";import"./Select-wYL7g-5T.js";import"./ChevronDown-Bw2TG6jd.js";import"./useId-B9OmVTHV.js";import"./TextField-DEo8zdDE.js";import"./PersonPencilFill-DS1qmMzQ.js";import"./KeyVerticalFill-CH0oXMyL.js";import"./Checkmark-uHeVskEM.js";import"./Theme-6IdwQf2V.js";import"./BasePrimitive-B7qNT1W_.js";import"./floating-ui.react-FIE1On8Y.js";import"./XMarkOctagonFill-BUHxl6gj.js";import"./ExclamationmarkTriangleFill-Ck4a0gXp.js";import"./Popover-CgZ7HliT.js";var X=(r=>(r.VURDER_FORELDELSE="5003",r))(X||{});const mr=Ve(3),gr=Be(1500),pr=r=>r!==b.UDEFINERT?r:void 0,kr=r=>r.foreldet?r.foreldet:pr(r.foreldelseVurderingType),yr=r=>({...r,foreldet:kr(r)}),qe=({skjulPeriode:r,readOnly:n,periode:a,oppdaterPeriode:d,kodeverkSamlingFpTilbake:q})=>{const m=W(),o=fe({defaultValues:yr(a)}),v=o.watch("foreldet"),c=v&&v===b.FORELDET,T=v&&v===b.TILLEGGSFRIST,s=q[pe.FORELDELSE_VURDERING].filter(g=>g.kode!==b.IKKE_VURDERT);return e.jsx(ye,{formMethods:o,onSubmit:g=>d(g),children:e.jsxs(S,{gap:"4",children:[e.jsx(Ze,{name:"begrunnelse",label:m.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[B,mr,gr,Oe],maxLength:1500,readOnly:n}),e.jsxs(O,{gap:"10",children:[e.jsx(We,{name:"foreldet",label:e.jsx(p,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[B],radios:s.map(g=>({label:g.navn,value:g.kode})),isReadOnly:n}),e.jsxs(S,{gap:"5",children:[(c||T)&&e.jsx(re,{name:"foreldelsesfrist",label:m.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[B,ee],isReadOnly:n}),T&&e.jsx(re,{name:"oppdagelsesDato",label:m.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[B,ee,Ie],isReadOnly:n,fromDate:y("1970-01-01").toDate(),toDate:y().toDate()})]})]}),e.jsxs(O,{gap:"4",children:[e.jsx(D,{size:"small",variant:"primary",disabled:!o.formState.isDirty||o.formState.isSubmitting||n,loading:o.formState.isSubmitting,children:e.jsx(p,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(D,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(p,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};qe.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  foreldelsesfrist?: Date;
  oppdagelsesDato?: Date;
}>`}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},lukkPeriode:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const Fr="_infoSummary_ythle_1",wr="_positivNumber_ythle_7",xr="_redNumber_ythle_11",Sr="_resultName_ythle_16",G={infoSummary:Fr,positivNumber:wr,redNumber:xr,resultName:Sr},he=({fom:r,tom:n,feilutbetaling:a})=>{const d=Ke(r,n);return e.jsxs(S,{gap:"2",className:G.infoSummary,children:[e.jsxs(O,{children:[e.jsx(te,{size:"small",children:`${y(r).format(_)} - ${y(n).format(_)}`}),e.jsx(ne,{}),e.jsx(L,{size:"small",children:d.formattedString})]}),e.jsx(O,{gap:"4",children:e.jsxs(L,{size:"small",className:G.resultName,children:[e.jsx(p,{id:"PeriodeInformasjon.Feilutbetaling"}),":",e.jsx("span",{className:a?G.redNumber:G.positivNumber,children:Ge(a)})]})})]})};he.__docgenInfo={description:`PeriodeInformasjon

Tilbakekreving periode oppsummering`,methods:[],displayName:"PeriodeInformasjon",props:{fom:{required:!0,tsType:{name:"string"},description:""},tom:{required:!0,tsType:{name:"string"},description:""},feilutbetaling:{required:!0,tsType:{name:"number"},description:""}}};const Er="_margin_1wl4t_1",z={margin:Er},Ar=r=>{const n=r.isGodkjent?"success":"danger";return r.isAksjonspunktOpen?"warning":n},Mr=(r=[])=>r.map(n=>({id:n.id,fom:n.fom,tom:n.tom,status:Ar(n)})),Or=r=>r===Z.MOR||r===Z.MEDMOR?e.jsx(lr,{width:20,height:20,color:"var(--a-red-200)"}):r===Z.FAR?e.jsx(dr,{width:20,height:20,color:"var(--a-blue-600)"}):e.jsx(nr,{width:20,height:20}),Ir={danger:e.jsx(tr,{}),success:e.jsx(ar,{}),warning:e.jsx(ir,{})},Pe=({perioder:r,setPeriode:n,valgtPeriode:a,relasjonsRolleType:d,relasjonsRolleTypeKodeverk:q})=>{var w;const m=W(),o=l.useMemo(()=>Mr(r),[r]),v=l.useCallback(f=>{const M=r.find(j=>j.id===f);M&&n(M)},[r,n]),c=y(o[0].fom),T=y(o[o.length-1].tom),[s,g]=l.useState(c),[k,i]=l.useState(T),E=l.useCallback(()=>{s.subtract(1,"month").isBefore(c)||(g(s.subtract(1,"month")),i(k.subtract(1,"month")))},[s,k,c]),t=l.useCallback(()=>{k.add(1,"month").isAfter(T)||(g(s.add(1,"month")),i(k.add(1,"month")))},[s,k,T]),R=l.useCallback(()=>{s.add(3,"month").isAfter(k)||(g(s.add(1,"month")),i(k.subtract(1,"month")))},[s,k]),A=l.useCallback(()=>{k.add(1,"month").diff(s.subtract(1,"month"),"months")<36&&(g(s.subtract(1,"month")),i(k.add(1,"month")))},[s,k]);return e.jsxs(S,{gap:"4",children:[e.jsx(J,{startDate:s.toDate(),endDate:k.add(1,"days").toDate(),children:e.jsx(J.Row,{label:((w=q.find(f=>f.kode===d))==null?void 0:w.navn)||"-",icon:Or(d),children:o.map(f=>e.jsx(J.Period,{start:y(f.fom).toDate(),end:y(f.tom).toDate(),status:f.status,onSelectPeriod:()=>v(f.id),isActive:(a==null?void 0:a.id)===f.id,icon:Ir[f.status],"aria-controls":"panel-tilbakekreving-foreldelse",id:f.id.toString()},f.id))})}),e.jsxs(O,{justify:"end",children:[e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(er,{"aria-hidden":!0}),onClick:R,variant:"primary-neutral",type:"button",title:m.formatMessage({id:"TilbakekrevingTimeline.ZoomInn"})}),e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(rr,{"aria-hidden":!0}),onClick:A,variant:"primary-neutral",type:"button",title:m.formatMessage({id:"TilbakekrevingTimeline.ZoomUt"})}),e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(ve,{"aria-hidden":!0}),onClick:E,variant:"primary-neutral",type:"button",title:m.formatMessage({id:"TilbakekrevingTimeline.ScrollTilVenstre"})}),e.jsx(D,{className:z.margin,size:"small",icon:e.jsx(ce,{"aria-hidden":!0}),onClick:t,variant:"primary-neutral",type:"button",title:m.formatMessage({id:"TilbakekrevingTimeline.ScrollTilHogre"})})]})]})};Pe.__docgenInfo={description:`TilbakekrevingTimeLine
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const se=(r,n)=>y(r.fom).diff(y(n.fom)),Vr=()=>y().subtract(30,"months").format(_),Br=r=>r?[e.jsx(p,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Vr()}},"vurderForeldelse")]:[],N=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===b.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Nr=(r=[])=>r.map((n,a)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:N(n),isGodkjent:b.FORELDET!==n.foreldet&&b.UDEFINERT!==n.foreldet,id:a})),_r=r=>({foreldelsePerioder:r.map(a=>({fraDato:a.fom,tilDato:a.tom,begrunnelse:a.begrunnelse,foreldelseVurderingType:a.foreldet,foreldelsesfrist:a.foreldelsesfrist,oppdagelsesDato:a.oppdagelsesDato})),kode:X.VURDER_FORELDELSE}),Lr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Ur=r=>[...r].sort(Lr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===b.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:He(n.begrunnelse)})),De=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a,aksjonspunkt:d,alleMerknaderFraBeslutter:q,perioderForeldelse:m,readOnly:o,kodeverkSamlingFpTilbake:v,beregnBelop:c,behandlingUuid:T,formData:s,setFormData:g})=>{const k=l.useMemo(()=>Ur(m.perioder),[m.perioder]),[i,E]=l.useState(s||k),[t,R]=l.useState(i==null?void 0:i.find(N)),[A,w]=l.useState(!1),[f,M]=l.useState(!!s),j=u=>{const h=u?i.find(P=>P.fom===u.fom&&P.tom===u.tom):void 0;R(h)},ae=l.useCallback(()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===i.length-1?u:u+1;j(i[h])},[i,t]),I=l.useCallback(()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===0?u:u-1;j(i[h])},[i,t]),x=l.useCallback(()=>{j(void 0)},[t,i]),Fe=l.useCallback(u=>{const h=ze(u,"erSplittet"),C=i.filter(F=>F.fom!==h.fom&&F.tom!==h.tom).concat(h).sort(se);E(C),g(C),M(!0),x();const V=C.find(N);V&&j(V)},[i,x,N]),we=l.useCallback(u=>{const h=i.find(F=>F.fom===(t==null?void 0:t.fom)&&F.tom===(t==null?void 0:t.tom));if(h===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${t==null?void 0:t.fom} Tom: ${t==null?void 0:t.tom}`);const P=u.map(F=>({...h,...F,erSplittet:!0})),V=i.filter(F=>F.fom!==(t==null?void 0:t.fom)&&F.tom!==(t==null?void 0:t.tom)).concat(P).sort(se);E(V),g(V),M(!0),x(),j(P[0])},[i,t,x,N]),xe=l.useCallback(()=>{w(!0),r(_r(i))},[i]),Se=q[X.VURDER_FORELDELSE],Y=Nr(i),Ee=d&&d.status===ke.OPPRETTET,Ae=Y.every(u=>!u.isAksjonspunktOpen),U=t?Y.find(u=>u.fom===t.fom&&u.tom===t.tom):void 0;return e.jsx(Ye,{merknaderFraBeslutter:Se,withoutBorder:!0,children:e.jsxs(S,{gap:"4",children:[e.jsx(be,{size:"small",children:e.jsx(p,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(L,{children:e.jsx(p,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(L,{children:e.jsx(p,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),i&&d&&e.jsxs(S,{gap:"4",children:[Ee&&e.jsx(Je,{children:Br(d)}),e.jsx(Pe,{perioder:Y,valgtPeriode:U,setPeriode:j,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a}),t&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":U==null?void 0:U.id.toString(),children:e.jsx(ur,{borderWidth:"1",padding:"4",children:e.jsxs(S,{gap:"4",children:[e.jsx(je,{setNestePeriode:ae,setForrigePeriode:I,valgtPeriode:t,readOnly:o,oppdaterSplittedePerioder:we,behandlingUuid:T,beregnBelop:c,lukkPeriode:x}),e.jsx(he,{feilutbetaling:t.feilutbetaling,fom:t.fom,tom:t.tom}),e.jsx(qe,{periode:t,oppdaterPeriode:Fe,skjulPeriode:x,readOnly:o,kodeverkSamlingFpTilbake:v},t.fom)]})})}),e.jsx(O,{children:e.jsx(Xe,{isReadOnly:o,isDirty:f,isSubmittable:!t&&Ae,onClick:xe,isSubmitting:A})})]})]})})};De.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const Gr={perioder:[{fom:"2019-01-01",tom:"2019-01-31",belop:1e3,begrunnelse:"Foreldet",foreldelseVurderingType:b.FORELDET,foreldelsesfrist:"2020-04-01"},{fom:"2019-03-01",tom:"2019-03-31",belop:3e3,foreldelseVurderingType:b.UDEFINERT},{fom:"2019-02-01",tom:"2019-02-28",belop:3e3,begrunnelse:"Over foreldelsesfrist, med tillegsfrist brukes",foreldelseVurderingType:b.TILLEGGSFRIST,foreldelsesfrist:"2020-04-01",oppdagelsesDato:"2019-11-01"},{fom:"2019-04-01",tom:"2019-04-30",belop:4e3,foreldelseVurderingType:b.UDEFINERT}]},zr={[pe.FORELDELSE_VURDERING]:[{kode:b.FORELDET,navn:"Foreldet",kodeverk:"FORELDELSE_VURDERING"},{kode:b.TILLEGGSFRIST,navn:"Ikke foreldet, med tilleggsfrist",kodeverk:"FORELDELSE_VURDERING"},{kode:b.IKKE_FORELDET,navn:"Ikke foreldet",kodeverk:"FORELDELSE_VURDERING"}]},$n={title:"prosess-tilbakekreving-foreldelse/ForeldelseProsessIndex",component:Re,args:{submitCallback:Me("button-click"),behandling:{uuid:"1",versjon:1,status:Le.BEHANDLING_UTREDES},kodeverkSamlingFpTilbake:zr,isReadOnly:!1,setFormData:()=>{},perioderForeldelse:Gr,relasjonsRolleType:Z.MOR,beregnBelop:r=>Promise.resolve(r),alleMerknaderFraBeslutter:{},relasjonsRolleTypeKodeverk:[{kode:"MORA",kodeverk:"RELASJONSROLLE_TYPE",navn:"Mor"}]}},H={args:{aksjonspunkter:[{definisjon:X.VURDER_FORELDELSE,status:ke.OPPRETTET,begrunnelse:void 0,kanLoses:!0}]}},$={args:{aksjonspunkter:[]}};var oe,le,de;H.parameters={...H.parameters,docs:{...(oe=H.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: [{
...
}`,...(ge=(me=$.parameters)==null?void 0:me.docs)==null?void 0:ge.source}}};const Zn=["Default","UtenAksjonspunkt"];export{H as Default,$ as UtenAksjonspunkt,Zn as __namedExportsOrder,$n as default};
