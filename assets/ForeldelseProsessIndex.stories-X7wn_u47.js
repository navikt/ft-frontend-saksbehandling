import{$ as y,t as I,a as we,o as Fe,M as Re,O as X,k as xe,J as Se,R as Ae,b as N,V as oe,Z as Ee}from"./style-BhsXTo5S.js";import{i as H,aa as le,j as e,av as de,V as R,az as Me,H as A,aS as Oe,aT as Q,d as k,F as P,M as K,N as ue,L as ne,B as _,v as U,G as Ve,t as Be,r as F,aU as me,aV as ge,an as Ie,aW as Ne,ad as _e,ax as Ue,au as Le,I as Ke,aL as Ce,aA as Ge,aX as ze,P as $e,m as He}from"./iframe-_4umShaB.js";import{M as g}from"./message-jyMKE1c-.js";import{S as ee,T as W,a as Ze,b as Ye,c as We,d as Je,e as Xe,f as Qe}from"./Timeline-lRA1y2sG.js";import{S as er}from"./Scissors-BmgrkeAM.js";import{a as rr,S as nr}from"./SilhouetteFill-D50f5K9X.js";var Z=(r=>(r.VURDER_FORELDELSE="5003",r))(Z||{});const tr=we(3),ar=Fe(1500),ir=r=>r!==y.UDEFINERT?r:void 0,sr=r=>r.foreldet?r.foreldet:ir(r.foreldelseVurderingType),or=r=>({...r,foreldet:sr(r)}),pe=({skjulPeriode:r,readOnly:n,periode:t,oppdaterPeriode:s,kodeverkSamlingFpTilbake:v})=>{const p=H(),a=le({defaultValues:or(t)}),b=a.watch("foreldet"),f=b&&b===y.FORELDET,T=b&&b===y.TILLEGGSFRIST,d=v.ForeldelseVurderingType.filter(u=>u.kode!==y.IKKE_VURDERT);return e.jsx(de,{formMethods:a,onSubmit:u=>s(u),children:e.jsxs(R,{gap:"space-16",children:[e.jsx(Me,{name:"begrunnelse",control:a.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[I,tr,ar,Re],maxLength:1500,readOnly:n}),e.jsxs(A,{gap:"space-40",children:[e.jsx(Oe,{name:"foreldet",control:a.control,label:e.jsx(g,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[I],radios:d.map(u=>({label:u.navn,value:u.kode})),isReadOnly:n}),e.jsxs(R,{gap:"space-20",children:[(f||T)&&e.jsx(Q,{name:"foreldelsesfrist",control:a.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[I,X],isReadOnly:n}),T&&e.jsx(Q,{name:"oppdagelsesDato",control:a.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[I,X,xe],isReadOnly:n,fromDate:k("1970-01-01").toDate(),toDate:k().toDate()})]})]}),e.jsxs(A,{gap:"space-16",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!a.formState.isDirty||a.formState.isSubmitting||n,loading:a.formState.isSubmitting,children:e.jsx(g,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(g,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};pe.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}}]}},name:"perioder"}],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const gr="_margin_1dkor_37",J={margin:gr},pr=!1,ye=({valgtPeriode:r,beregnBelop:n,behandlingUuid:t,oppdaterSplittedePerioder:s,setNestePeriode:v,setForrigePeriode:p,readOnly:a,lukkPeriode:b})=>{const f=H(),[T,d]=F.useState(!1),[u,c]=F.useState(!1),o=h=>{d(!0),h.preventDefault()},x=()=>{d(!1)},i=h=>{c(!1);const S={belop:r.feilutbetaling,fom:h.forstePeriode.fom,tom:h.forstePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "},m={belop:r.feilutbetaling,fom:h.andrePeriode.fom,tom:h.andrePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "};n({behandlingUuid:t,perioder:[S,m]}).then(E=>{const{perioder:D}=E;if(D.some(V=>V.belop===0))c(!0);else{const V={fom:S.fom,tom:S.tom,feilutbetaling:D[0].belop},M={fom:m.fom,tom:m.tom,feilutbetaling:D[1].belop};x(),s([V,M])}})};return e.jsxs(A,{children:[e.jsxs(ne,{size:"small",children:[e.jsx(g,{id:"PeriodeController.Detaljer"}),pr]}),!a&&e.jsxs(e.Fragment,{children:[e.jsx(ee,{}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(er,{"aria-hidden":!0}),onClick:o,variant:"tertiary-neutral",type:"button",title:f.formatMessage({id:"PeriodeController.DelOppPerioden"}),children:e.jsx(g,{id:"PeriodeController.DelOppPerioden"})})]}),T&&e.jsx(ke,{cancelEvent:x,showModal:T,periodeData:r,splitPeriod:i,finnesBelopMed0Verdi:u}),e.jsx(ee,{}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(me,{"aria-hidden":!0}),onClick:p,variant:"secondary-neutral",type:"button",title:f.formatMessage({id:"PeriodeController.prevPeriod"}),children:e.jsx(g,{id:"PeriodeController.prevPeriodShort"})}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(ge,{"aria-hidden":!0}),onClick:v,variant:"secondary-neutral",type:"button",title:f.formatMessage({id:"PeriodeController.nextPeriod"}),iconPosition:"right",children:e.jsx(g,{id:"PeriodeController.nextPeriodShort"})}),e.jsx(P,{size:"xsmall",icon:e.jsx(Ie,{"aria-hidden":!0}),onClick:b,variant:"tertiary-neutral",type:"button",title:f.formatMessage({id:"PeriodeController.LukkPeriode"})})]})};ye.__docgenInfo={description:"",methods:[],displayName:"PeriodeController",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},beregnBelop:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BeregnBeløpParams) => Promise<BeregnBeløpResultat>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
  ...
  foreldelsesfrist?: Date;
  oppdagelsesDato?: Date;
}>`}]},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},lukkPeriode:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const kr="_infoSummary_112tw_1",yr="_positivNumber_112tw_7",br="_redNumber_112tw_11",vr="_resultName_112tw_16",C={infoSummary:kr,positivNumber:yr,redNumber:br,resultName:vr},be=({fom:r,tom:n,feilutbetaling:t})=>{const s=Ne(r,n);return e.jsxs(R,{gap:"space-8",className:C.infoSummary,children:[e.jsxs(A,{children:[e.jsx(ne,{size:"small",children:`${k(r).format(U)} - ${k(n).format(U)}`}),e.jsx(ee,{}),e.jsx(_,{size:"small",children:s.formattedString})]}),e.jsx(A,{gap:"space-16",children:e.jsxs(_,{size:"small",className:C.resultName,children:[e.jsx(g,{id:"PeriodeInformasjon.Feilutbetaling"}),":",e.jsx("span",{className:t?C.redNumber:C.positivNumber,children:_e(t)})]})})]})};be.__docgenInfo={description:`PeriodeInformasjon

Tilbakekreving periode oppsummering`,methods:[],displayName:"PeriodeInformasjon",props:{fom:{required:!0,tsType:{name:"string"},description:""},tom:{required:!0,tsType:{name:"string"},description:""},feilutbetaling:{required:!0,tsType:{name:"number"},description:""}}};const fr="_margin_1wl4t_1",G={margin:fr},cr=r=>{const n=r.isGodkjent?"success":"danger";return r.isAksjonspunktOpen?"warning":n},Tr=(r=[])=>r.map(n=>({id:n.id,fom:n.fom,tom:n.tom,status:cr(n)})),qr=r=>r===N.MOR||r===N.MEDMOR?e.jsx(rr,{width:20,height:20,color:"var(--ax-danger-300)"}):r===N.FAR?e.jsx(nr,{width:20,height:20,color:"var(--ax-accent-700)"}):e.jsx(We,{width:20,height:20}),jr={danger:e.jsx(Qe,{}),success:e.jsx(Xe,{}),warning:e.jsx(Je,{})},ve=({perioder:r,setPeriode:n,valgtPeriode:t,relasjonsRolleType:s,relasjonsRolleTypeKodeverk:v})=>{const p=H(),a=Tr(r),b=m=>{const O=r.find(E=>E.id===m);O&&n(O)},f=k(a[0].fom),T=k(a[a.length-1].tom),[d,u]=F.useState(f),[c,o]=F.useState(T),x=()=>{d.subtract(1,"month").isBefore(f)||(u(d.subtract(1,"month")),o(c.subtract(1,"month")))},i=()=>{c.add(1,"month").isAfter(T)||(u(d.add(1,"month")),o(c.add(1,"month")))},h=()=>{d.add(3,"month").isAfter(c)||(u(d.add(1,"month")),o(c.subtract(1,"month")))},S=()=>{c.add(1,"month").diff(d.subtract(1,"month"),"months")<36&&(u(d.subtract(1,"month")),o(c.add(1,"month")))};return e.jsxs(R,{gap:"space-16",children:[e.jsx(W,{startDate:d.toDate(),endDate:c.add(1,"days").toDate(),children:e.jsx(W.Row,{label:v.find(m=>m.kode===s)?.navn||"-",icon:qr(s),children:a.map(m=>e.jsx(W.Period,{start:k(m.fom).toDate(),end:k(m.tom).toDate(),status:m.status,onSelectPeriod:()=>b(m.id),isActive:t?.id===m.id,icon:jr[m.status],"aria-controls":"panel-tilbakekreving-foreldelse",id:m.id.toString()},m.id))})}),e.jsxs(A,{justify:"end",children:[e.jsx(P,{className:G.margin,size:"small",icon:e.jsx(Ze,{"aria-hidden":!0}),onClick:h,variant:"primary-neutral",type:"button",title:p.formatMessage({id:"TilbakekrevingTimeline.ZoomInn"})}),e.jsx(P,{className:G.margin,size:"small",icon:e.jsx(Ye,{"aria-hidden":!0}),onClick:S,variant:"primary-neutral",type:"button",title:p.formatMessage({id:"TilbakekrevingTimeline.ZoomUt"})}),e.jsx(P,{className:G.margin,size:"small",icon:e.jsx(me,{"aria-hidden":!0}),onClick:x,variant:"primary-neutral",type:"button",title:p.formatMessage({id:"TilbakekrevingTimeline.ScrollTilVenstre"})}),e.jsx(P,{className:G.margin,size:"small",icon:e.jsx(ge,{"aria-hidden":!0}),onClick:i,variant:"primary-neutral",type:"button",title:p.formatMessage({id:"TilbakekrevingTimeline.ScrollTilHogre"})})]})]})};ve.__docgenInfo={description:`TilbakekrevingTimeLine
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const se=(r,n)=>k(r.fom).diff(k(n.fom)),Pr=()=>k().subtract(30,"months").format(U),hr=r=>r?[e.jsx(g,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Pr()}},"vurderForeldelse")]:[],re=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===y.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Dr=(r=[])=>r.map((n,t)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:re(n),isGodkjent:y.FORELDET!==n.foreldet&&y.UDEFINERT!==n.foreldet,id:t})),wr=r=>({foreldelsePerioder:r.map(t=>({fraDato:t.fom,tilDato:t.tom,begrunnelse:t.begrunnelse,foreldelseVurderingType:t.foreldet,foreldelsesfrist:t.foreldelsesfrist,oppdagelsesDato:t.oppdagelsesDato})),kode:Z.VURDER_FORELDELSE}),Fr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Rr=r=>[...r].sort(Fr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===y.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:Ge(n.begrunnelse)})),fe=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t,aksjonspunkt:s,alleMerknaderFraBeslutter:v,perioderForeldelse:p,readOnly:a,kodeverkSamlingFpTilbake:b,beregnBelop:f,behandlingUuid:T,formData:d,setFormData:u})=>{const c=Rr(p.perioder),[o,x]=F.useState(d||c),[i,h]=F.useState(o?.find(re)),[S,m]=F.useState(!1),[O,E]=F.useState(!!d),D=l=>{const q=l?o.find(j=>j.fom===l.fom&&j.tom===l.tom):void 0;h(q)},te=()=>{const l=o.findIndex(j=>j.fom===i?.fom&&j.tom===i?.tom),q=l===o.length-1?l:l+1;D(o[q])},V=()=>{const l=o.findIndex(j=>j.fom===i?.fom&&j.tom===i?.tom),q=l===0?l:l-1;D(o[q])},M=()=>{D(void 0)},Te=l=>{const q=ze(l,"erSplittet"),L=o.filter(w=>w.fom!==q.fom&&w.tom!==q.tom).concat(q).sort(se);x(L),u(L),E(!0),M();const B=L.find(re);B&&D(B)},qe=l=>{const q=o.find(w=>w.fom===i?.fom&&w.tom===i?.tom);if(q===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${i?.fom} Tom: ${i?.tom}`);const j=l.map(w=>({...q,...w,erSplittet:!0})),B=o.filter(w=>w.fom!==i?.fom&&w.tom!==i?.tom).concat(j).sort(se);x(B),u(B),E(!0),M(),D(j[0])},je=()=>{m(!0),r(wr(o))},Pe=v[Z.VURDER_FORELDELSE],Y=Dr(o),he=s&&s.status===oe.OPPRETTET,De=Y.every(l=>!l.isAksjonspunktOpen),ae=i?Y.find(l=>l.fom===i.fom&&l.tom===i.tom):void 0;return e.jsx(Ue,{merknaderFraBeslutter:Pe,withoutBorder:!0,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(ue,{size:"small",level:"2",children:e.jsx(g,{id:"ForeldelseForm.Foreldelse"})}),!s&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),o&&s&&e.jsxs(R,{gap:"space-16",children:[he&&e.jsx(Le,{children:hr(s)}),e.jsx(ve,{perioder:Y,valgtPeriode:ae,setPeriode:D,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t}),i&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":ae?.id.toString(),children:e.jsx(Ke.New,{borderWidth:"1",padding:"4",children:e.jsxs(R,{gap:"space-16",children:[e.jsx(ye,{setNestePeriode:te,setForrigePeriode:V,valgtPeriode:i,readOnly:a,oppdaterSplittedePerioder:qe,behandlingUuid:T,beregnBelop:f,lukkPeriode:M}),e.jsx(be,{feilutbetaling:i.feilutbetaling,fom:i.fom,tom:i.tom}),e.jsx(pe,{periode:i,oppdaterPeriode:Te,skjulPeriode:M,readOnly:a,kodeverkSamlingFpTilbake:b},i.fom)]})})}),e.jsx(A,{children:e.jsx(Ce,{isReadOnly:a,isDirty:O,isSubmittable:!i&&De,onClick:je,isSubmitting:S})})]})]})})};fe.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
