    ...
    return <RhfFieldArray {...rest} fields={fields} append={append} remove={remove} emptyTemplate={{
      ...
      periodeTom: ''
        ...
        {(field, index, removeButton) => <HStack gap="2" key={field.id} align="end">
            <RhfDatepicker size={size} isReadOnly={readOnly} name={\`test.\${index}.periodeFom\`} label="Fra og med" control={control} />
            <RhfDatepicker size={size} isReadOnly={readOnly} name={\`test.\${index}.periodeTom\`} label="Til og med" control={control} />
            {removeButton}
          </HStack>}
      </RhfFieldArray>;
  }
