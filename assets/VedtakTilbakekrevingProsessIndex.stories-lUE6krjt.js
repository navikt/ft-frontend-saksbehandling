import{g as I,l as W,r as B,j as e,D as U,av as X,V as T,N as _,e as ee,L as x,B as b,aw as te,a7 as re,ar as ne,H as S,aR as ie,z as ae,aT as se,an as le,a9 as c,P as ue,k as ke}from"./iframe-C91bWaTK.js";import{a as de}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{e as oe,r as ge,y as M,a as K,m as me,Z as ve}from"./style-Cvq-FzCj.js";import{c as pe}from"./index-DUr4Unak.js";import{S as be}from"./PlusCircle-DB5K62oC.js";import{M as m}from"./message-xnSkYRgS.js";import{E as h}from"./ExpansionCard-BtYwhd7j.js";import{T as s}from"./Table-BM3p21o9.js";var E=(n=>(n.FORSETT="FORSETT",n.GROVT_UAKTSOM="GROVT_UAKTSOM",n.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",n))(E||{});const v={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"};var L=(n=>(n.FORESLA_VEDTAK="5004",n))(L||{});const ye="_addCircleIcon_84ecs_1",fe="_imageText_84ecs_7",ce="_addPeriode_84ecs_12",V={addCircleIcon:ye,imageText:fe,addPeriode:ce},C=ge(3),Te=K(4e3),qe=[C,M],Ae=[oe,C,M],H=({type:n,readOnly:i,fritekstPakrevet:r,maximumLength:t})=>{const a=I(),{watch:u}=W(),l=u(n)===void 0,[o,d]=B.useState(l&&!r),g=r?Ae:qe;return g.push(t?K(t):Te),e.jsxs(e.Fragment,{children:[o&&!i&&e.jsx(e.Fragment,{children:e.jsxs("div",{onClick:p=>{p.preventDefault(),d(!1)},onKeyDown:p=>{p.preventDefault(),d(!1)},className:V.addPeriode,role:"button",tabIndex:0,children:[e.jsx(be,{className:V.addCircleIcon,title:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),e.jsx(U,{size:"small",className:V.imageText,children:e.jsx(m,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})}),!o&&e.jsx(X,{name:n,label:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:g,maxLength:t||4e3,readOnly:i})]})};H.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{type:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},fritekstPakrevet:{required:!1,tsType:{name:"boolean"},description:""},maximumLength:{required:!1,tsType:{name:"number"},description:""}}};const he="_container_aetpe_1",je="_gulmarkering_aetpe_4",G={container:he,gulmarkering:je},R=({intl:n,vedtaksbrevAvsnitt:i,readOnly:r,perioderSomIkkeHarUtfyltObligatoriskVerdi:t,fritekstOppsummeringPakrevdMenIkkeUtfylt:a=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:u})=>e.jsxs(T,{gap:"2",className:G.container,children:[e.jsx(_,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),i.map(l=>{const o=l.underavsnittsliste,d=`${l.fom}_${l.tom}`,g=t.some(k=>k===d),p=l.avsnittstype===v.OPPSUMMERING&&a;return e.jsx(ee.Fragment,{children:e.jsxs(h,{"aria-label":"periode",defaultOpen:g||p,className:g||p?G.gulmarkering:"",children:[e.jsx(h.Header,{children:e.jsx(h.Title,{size:"small",children:l.overskrift?l.overskrift:n.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),e.jsx(h.Content,{children:e.jsx(T,{gap:"2",children:o.map(k=>e.jsxs(T,{gap:"2",children:[k.overskrift&&e.jsx(x,{size:"small",children:k.overskrift}),k.brødtekst&&e.jsx(b,{size:"small",children:k.brødtekst}),k.fritekstTillatt&&e.jsx(e.Fragment,{children:e.jsx(H,{type:k.underavsnittstype?`${d}.${k.underavsnittstype}`:l.avsnittstype,readOnly:r,fritekstPakrevet:k.fritekstPåkrevet,maximumLength:u?1e4:void 0})})]},(k.underavsnittstype||"")+k.overskrift+k.brødtekst))})})]})},l.avsnittstype+l.fom)})]});R.buildInitialValues=n=>n.filter(i=>i.underavsnittsliste.some(r=>r.fritekst)).reduce((i,r)=>{const a=r.underavsnittsliste.filter(l=>l.fritekst).reduce((l,o)=>({...l,[o.underavsnittstype?o.underavsnittstype:r.avsnittstype]:te(o.fritekst)}),{}),u=r.fom?{[`${r.fom}_${r.tom}`]:a}:a;return{...i,...u}},{});R.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"vedtaksbrevAvsnitt",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avsnittstype: string;
  fom?: string;
  tom?: string;
  overskrift?: string;
  ...
  underavsnittstype?: string;
  fritekstPåkrevet?: boolean;
}[]`,required:!0}}]}}],raw:"VedtaksbrevAvsnitt[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},perioderSomIkkeHarUtfyltObligatoriskVerdi:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},fritekstOppsummeringPakrevdMenIkkeUtfylt:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""}}};const Re="_buttonLink_sudxz_1",Pe="_padding_sudxz_8",Ve="_infoTextIcon_sudxz_14",w={buttonLink:Re,padding:Pe,infoTextIcon:Ve},z=n=>{const i=se(n,v.OPPSUMMERING);return{oppsummeringstekst:n[v.OPPSUMMERING],perioderMedTekst:Object.keys(i).map(r=>({fom:r.split("_")[0],tom:r.split("_")[1],faktaAvsnitt:i[r][v.FAKTA],foreldelseAvsnitt:i[r][v.FORELDELSE],vilkaarAvsnitt:i[r][v.VILKAR],saerligeGrunnerAvsnitt:i[r][v.SARLIGEGRUNNER],saerligeGrunnerAnnetAvsnitt:i[r][v.SARLIGEGRUNNER_ANNET]}))}},we=(n,i)=>n.some(r=>r.avsnittstype===v.OPPSUMMERING&&r.underavsnittsliste.some(t=>t.fritekstPåkrevet)&&!i[v.OPPSUMMERING]),Be=n=>({kode:L.FORESLA_VEDTAK,...z(n)}),xe=(n,i)=>n.reduce((r,t)=>{const a=`${t.fom}_${t.tom}`,u=i[a];return t.underavsnittsliste.some(d=>d.fritekstPåkrevet&&d.underavsnittstype===v.FAKTA)&&(!u||!u[v.FAKTA])||t.underavsnittsliste.some(d=>d.fritekstPåkrevet&&d.underavsnittstype===v.SARLIGEGRUNNER_ANNET)&&(!u||!u[v.SARLIGEGRUNNER_ANNET])?r.concat(a):r},[]),N=(n,i,r)=>t=>{n({uuid:i,...z(r)}),t.preventDefault()},Y=({submitCallback:n,readOnly:i,fetchPreviewVedtaksbrev:r,avsnittsliste:t,behandlingUuid:a,erRevurderingTilbakekrevingKlage:u,erRevurderingTilbakekrevingFeilBeløpBortfalt:l,formData:o,setFormData:d})=>{const g=t,p=B.useMemo(()=>o||R.buildInitialValues(g),[o,g]),k=I(),y=re({defaultValues:p}),f=y.watch(),P=we(g,f),q=xe(g,f),Q=P||q.length>0;return e.jsx(ne,{formMethods:y,onSubmit:A=>n(Be(A)),setDataOnUnmount:d,children:e.jsxs(T,{gap:"4",children:[e.jsx(R,{intl:k,vedtaksbrevAvsnitt:g,readOnly:i,perioderSomIkkeHarUtfyltObligatoriskVerdi:B.useMemo(()=>q,[]),fritekstOppsummeringPakrevdMenIkkeUtfylt:P,erRevurderingTilbakekrevingFeilBeløpBortfalt:l}),e.jsxs(S,{gap:"10",children:[e.jsx(ie,{text:k.formatMessage({id:"TilbakekrevingVedtakForm.TilGodkjenning"}),isReadOnly:i,isSubmittable:q.length===0&&!P,isSubmitting:y.formState.isSubmitting,isDirty:y.formState.isDirty,hasErrors:Q}),q.length===0&&e.jsx("div",{className:w.padding,children:e.jsx("a",{href:"",onClick:N(r,a,f),onKeyDown:A=>A.key==="Enter"?N(r,a,f)(A):null,className:pe(w.buttonLink,"lenke lenke--frittstaende"),children:e.jsx(m,{id:"TilbakekrevingVedtakForm.ForhandvisBrev"})})})]}),u&&e.jsxs(S,{children:[e.jsx(ae,{className:w.infoTextIcon}),e.jsx(m,{id:"TilbakekrevingVedtakForm.Infotekst.Klage"})]})]})})};Y.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakForm",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
  ...
  saerligeGrunnerAvsnitt: string;
  saerligeGrunnerAnnetAvsnitt: string;
}[]`,required:!0}}]}}]},name:"data"}],return:{name:"Promise",elements:[{name:"void"}],raw:"Promise<void>"}}},description:""},behandlingUuid:{required:!0,tsType:{name:"string"},description:""},erRevurderingTilbakekrevingKlage:{required:!1,tsType:{name:"boolean"},description:""},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""},formData:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"union",raw:"Record<string, string> | string",elements:[{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},{name:"string"}]}],raw:"Record<string, Record<string, string> | string>"},description:""},setFormData:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: FormValues) => void",signature:{arguments:[{type:{name:"Record",elements:[{name:"string"},{name:"union",raw:"Record<string, string> | string",elements:[{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},{name:"string"}]}],raw:"Record<string, Record<string, string> | string>"},name:"data"}],return:{name:"void"}}},description:""}}};const Ee="_table_gko8z_1",Se={table:Ee},$=({perioder:n,kodeverkSamlingFpTilbake:i})=>{const r=n.map(t=>{var a;return e.jsxs(s.Row,{children:[e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:e.jsx(le,{dateStringFom:t.periode.fom,dateStringTom:t.periode.tom})})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(t.feilutbetaltBeløp)})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:(a=i.Aktsomhet.find(u=>u.kode===t.vurdering))==null?void 0:a.navn})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:t.andelAvBeløp!==void 0&&t.andelAvBeløp!==null?`${t.andelAvBeløp}%`:""})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:t.renterProsent?`${t.renterProsent}%`:""})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(t.tilbakekrevingBeløp)})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(t.tilbakekrevingBeløpEtterSkatt)})})]},t.periode.fom)}).concat(e.jsxs(s.Row,{children:[e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Sum"})})}),e.jsx(s.DataCell,{children:e.jsx(b,{size:"small",children:c(n.reduce((t,a)=>t+a.feilutbetaltBeløp,0))})}),e.jsx(s.DataCell,{}),e.jsx(s.DataCell,{}),e.jsx(s.DataCell,{}),e.jsx(s.DataCell,{children:e.jsx(x,{size:"small",children:c(n.reduce((t,a)=>t+a.tilbakekrevingBeløp,0))})}),e.jsx(s.DataCell,{children:e.jsx(x,{size:"small",children:c(n.reduce((t,a)=>t+a.tilbakekrevingBeløpEtterSkatt,0))})})]},"sum"));return e.jsx("div",{className:Se.table,children:e.jsxs(s,{children:[e.jsx(s.Header,{children:e.jsxs(s.Row,{children:[e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Periode"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.FeilutbetaltBelop"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Vurdering"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.AndelAvBelop"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.Renter"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.ForSkatt"})}),e.jsx(s.HeaderCell,{scope:"col",children:e.jsx(m,{id:"TilbakekrevingVedtakPeriodeTabell.BelopSomTilbakekreves"})})]})}),e.jsx(s.Body,{children:r})]})})};$.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakPeriodeTabell",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  periode: {
    fom: string;
    tom: string;
  };
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavnTilbakekreving<K>[]"}}]}},description:""}}};const J=({submitCallback:n,readOnly:i,resultat:r,perioder:t,kodeverkSamlingFpTilbake:a,behandlingUuid:u,avsnittsliste:l,fetchPreviewVedtaksbrev:o,erRevurderingTilbakekrevingKlage:d,erRevurderingTilbakekrevingFeilBeløpBortfalt:g,formData:p,setFormData:k})=>{var y;return e.jsxs(T,{gap:"4",children:[e.jsx(_,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtak"})}),e.jsxs("div",{children:[e.jsx(U,{children:e.jsx(m,{id:"TilbakekrevingVedtak.Resultat"})}),e.jsx(b,{size:"small",children:(y=a.VedtakResultatType.find(f=>f.kode===r))==null?void 0:y.navn})]}),e.jsx($,{perioder:t,kodeverkSamlingFpTilbake:a}),e.jsx(Y,{submitCallback:n,readOnly:i,behandlingUuid:u,avsnittsliste:l,fetchPreviewVedtaksbrev:o,erRevurderingTilbakekrevingKlage:d,erRevurderingTilbakekrevingFeilBeløpBortfalt:g,formData:p,setFormData:k})]})};J.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtak",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
