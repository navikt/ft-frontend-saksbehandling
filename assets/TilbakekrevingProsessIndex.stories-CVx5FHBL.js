import{c as H,aa as We,j as e,aw as Je,M as ke,I as he,V as q,L as $,B as w,d as c,n as te,aT as qr,A as Ze,y as S,m as Rr,r as B,H as A,aU as Xe,aV as Qe,an as xr,ab as Ar,aW as Br,ae,i as C,aZ as ee,aS as z,U as P,D as je,at as er,a_ as Se,a$ as Pr,ax as wr,aA as de,E as Fr,aB as fe,ad as rr,b0 as De,b1 as Sr,ay as Or,av as Er,z as Vr,aL as Mr,aY as qe,P as Gr,h as Ir}from"./iframe-urfE7SSG.js";import{g as _r}from"./withIntl-Cs4_Wnlv.js";import{a as Dr}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{F as Oe,Y as nr}from"./index.es-y3XBOrzW.js";import{t as x,O as Ur,J as Nr,R as Lr,i as tr,l as Kr,a as Ge,o as Ie,N as Re}from"./style-BRT6EBbj.js";import{M as s}from"./message-DbJiGN2w.js";import{S as Ue,T as we,a as $r,b as zr,c as Hr,d as Cr,e as Yr,f as Wr}from"./Timeline-BAeHTPCk.js";import{S as Jr}from"./Scissors-DEcQjTcp.js";import{T as D}from"./Table-SOpCLzbc.js";import{T as Zr,m as ar}from"./nb_NO-Cp9BXtkx.js";import{a as Xr,S as Qr}from"./SilhouetteFill-DtrfRbB5.js";import"./preload-helper-D9Z9MdNV.js";const en="_button_8q57x_1",rn="_cancelButton_8q57x_5",Ne={button:en,cancelButton:rn},nn=(r,t)=>n=>n&&(Nr(n)(c(r.tom.toString()).subtract(1,"day"))||Lr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,tn=(r,t)=>{const n=c(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},i={fom:n.format(Rr),tom:t.tom};return{forstePeriode:a,andrePeriode:i}},ir=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:i})=>{const l=H(),u=We();return e.jsx(Je,{formMethods:u,onSubmit:g=>i(tn(g,r)),children:e.jsxs(ke,{open:t,"aria-label":l.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(ke.Header,{children:e.jsx(he,{size:"small",level:"2",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(ke.Body,{children:e.jsxs(q,{gap:"space-16",children:[e.jsxs("div",{children:[e.jsx($,{size:"small",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(w,{size:"small",children:`${c(r.fom.toString()).format(te)} - ${c(r.tom.toString()).format(te)}`})]}),e.jsx(qr,{name:"forstePeriodeTomDato",control:u.control,label:e.jsx(s,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[x,Ur,nn(r,l)],fromDate:c(r.fom).toDate(),toDate:c(r.tom).toDate()}),a&&e.jsx(Ze,{variant:"error",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(ke.Footer,{children:[e.jsx(S,{size:"small",variant:"primary",className:Ne.button,disabled:!u.formState.isDirty,children:e.jsx(s,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(S,{size:"small",variant:"secondary",onClick:n,className:Ne.cancelButton,type:"button",children:e.jsx(s,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};ir.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
