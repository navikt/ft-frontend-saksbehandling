import{i as Y,am as He,j as e,aF as Ce,a2 as ke,a0 as ye,X as R,Y as x,B as P,d as c,b as re,b3 as yr,a4 as Je,J as F,x as Or,r as _,H as f,b4 as We,b5 as Xe,K as Ar,an as Sr,b6 as Rr,aq as ne,u as $,bd as Z,b2 as D,O as M,h as Oe,aD as Ze,b9 as Pe,be as Er,aG as hr,aJ as oe,E as fr,aK as ce,ap as Qe,bc as Ke,aO as _r,L as Mr,aH as Pr,aE as Fr,$ as qr,aZ as Gr,a_ as Ae,P as jr,p as Ir}from"./iframe-DGClZT-o.js";import{g as Ur}from"./withIntl-CoTTzEWv.js";import{a as Lr}from"./alleTilbakekrevingKodeverk-BIIVe2EV.js";import{A as Fe}from"./index.es-BDctT3QU.js";import{t as h,O as Kr,J as wr,R as Nr,i as er,l as Vr,a as Ie,o as Ue,N as Se}from"./style-BsDKydG7.js";import{M as i}from"./message-DM_uILvT.js";import{S as we}from"./Spacer-BvwAKzKw.js";import{S as Br}from"./Scissors-C8b927IJ.js";import{T as K}from"./Table-B5NN45sO.js";import{T as xr,m as rr}from"./nb_NO-BBW8kDRF.js";import{T as _e,S as Dr,a as Yr,b as $r,c as zr,d as Hr}from"./Timeline-CURDGykT.js";import{a as Cr,S as Jr}from"./SilhouetteFill-DO03HFrI.js";import"./preload-helper-PPVm8Dsz.js";const Wr="_button_8q57x_1",Xr="_cancelButton_8q57x_5",Ne={button:Wr,cancelButton:Xr},Zr=(r,t)=>n=>n&&(wr(n)(c(r.tom.toString()).subtract(1,"day"))||Nr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,Qr=(r,t)=>{const n=c(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},l={fom:n.format(Or),tom:t.tom};return{forstePeriode:a,andrePeriode:l}},nr=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:l})=>{const s=Y(),u=He();return e.jsx(Ce,{formMethods:u,onSubmit:p=>l(Qr(p,r)),children:e.jsxs(ke,{open:t,"aria-label":s.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(ke.Header,{children:e.jsx(ye,{size:"small",level:"2",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(ke.Body,{children:e.jsxs(R,{gap:"space-16",children:[e.jsxs("div",{children:[e.jsx(x,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(P,{size:"small",children:`${c(r.fom.toString()).format(re)} - ${c(r.tom.toString()).format(re)}`})]}),e.jsx(yr,{name:"forstePeriodeTomDato",control:u.control,label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[h,Kr,Zr(r,s)],fromDate:c(r.fom).toDate(),toDate:c(r.tom).toDate()}),a&&e.jsx(Je,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(ke.Footer,{children:[e.jsx(F,{size:"small",variant:"primary",className:Ne.button,disabled:!u.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(F,{size:"small",variant:"secondary",onClick:n,className:Ne.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};nr.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
...
| 'ANNET'`,elements:[{name:"literal",value:"'GRAD_AV_UAKTSOMHET'"},{name:"literal",value:"'HELT_ELLER_DELVIS_NAVS_FEIL'"},{name:"literal",value:"'STOERRELSE_BELOEP'"},{name:"literal",value:"'TID_FRA_UTBETALING'"},{name:"literal",value:"'ANNET'"}],required:!0}},{key:"VilkårResultat",value:{name:"union",raw:"'FORSTO_BURDE_FORSTAATT' | 'FEIL_OPPLYSNINGER' | 'MANGELFULL_OPPLYSNING' | 'GOD_TRO'",elements:[{name:"literal",value:"'FORSTO_BURDE_FORSTAATT'"},{name:"literal",value:"'FEIL_OPPLYSNINGER'"},{name:"literal",value:"'MANGELFULL_OPPLYSNING'"},{name:"literal",value:"'GOD_TRO'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  GROVT_UAKTSOM?: AktsomhetData;
  SIMPEL_UAKTSOM?: AktsomhetData;
}`,signature:{properties:[{key:"FORSETT",value:{name:"AktsomhetData",required:!1}},{key:"GROVT_UAKTSOM",value:{name:"AktsomhetData",required:!1}},{key:"SIMPEL_UAKTSOM",value:{name:"AktsomhetData",required:!1}}]}},{name:"union",raw:"'FORSETT' | 'GROVT_UAKTSOM' | 'SIMPEL_UAKTSOM'",elements:[{name:"literal",value:"'FORSETT'"},{name:"literal",value:"'GROVT_UAKTSOM'"},{name:"literal",value:"'SIMPEL_UAKTSOM'"}],required:!0}],raw:"Pick<AktomhetMap, Aktsomhet>"}],required:!0}},{key:"GOD_TRO",value:{name:"InitialValuesGodTroForm",required:!0}}]}},{name:"union",raw:"'FORSTO_BURDE_FORSTAATT' | 'FEIL_OPPLYSNINGER' | 'MANGELFULL_OPPLYSNING' | 'GOD_TRO'",elements:[{name:"literal",value:"'FORSTO_BURDE_FORSTAATT'"},{name:"literal",value:"'FEIL_OPPLYSNINGER'"},{name:"literal",value:"'MANGELFULL_OPPLYSNING'"},{name:"literal",value:"'GOD_TRO'"}],required:!0}],raw:"Pick<VilkårResultatMap, VilkårResultat>"}]}]}],raw:"CustomVilkarsVurdertePeriode[]"},name:"data"}],return:{name:"void"}}},description:""}}};const nt=Ir(rr),cr=r=>e.jsx(jr,{value:nt,children:e.jsx(vr,{...r})});cr.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingProsessIndex",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},perioderForeldelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  perioder: FeilutbetalingPeriode[];
}`,signature:{properties:[{key:"perioder",value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
