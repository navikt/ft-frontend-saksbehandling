import{a as Me}from"./index-B-lxVbXh.js";import{m as b,S as pe,e as B,a as Oe,o as Ve,N as Ie,O as ee,b as Be,H as Ne,D as Le,h as Z,c as ke,d as _e}from"./style-_KQtzLUz.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as Y,a as L,G as Ue,K as Ce,h as Ke,w as Ge,i as ze,P as He,$ as $e}from"./index.es-KvXTwYBt.js";import{r as l}from"./index-DASCADcX.js";import{d as y}from"./dayjs.min-Cke173X9.js";import{e as ye,K as Ze,J as Ye,G as re,Q as Je}from"./index.es-DILXjbqq.js";import{M as p,l as We,V as Qe}from"./index.es-ZMAJiipA.js";import{b as fe}from"./index.esm-s_KxdRQ_.js";import{V as x,H as O}from"./VStack-CfnCueE0.js";import"./Theme-Bqc_BD0M.js";import{B as D}from"./Button-D87Irl5r.js";import{M as K}from"./Modal-Cf6h8GUk.js";import{H as be,L as te,a as _}from"./Label-CfBdhDeq.js";import{A as Xe}from"./Alert-vBIWixRy.js";import{S as ne,T as Q,a as er,b as rr,c as nr,d as tr,e as ar,f as ir}from"./Timeline-BnB9uLs-.js";import{S as sr}from"./Scissors-DzHI4ozx.js";import{S as ve,g as ce}from"./DatePicker-DURjvdAA.js";import{S as or}from"./XMark-KAXZPgUH.js";import{a as lr,S as dr}from"./SilhouetteFill-Dse_AnU7.js";import{B as ur}from"./Box-t-YAJNpB.js";/* empty css              */import"./v4-CtRu48qb.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Checkbox-9OjO7dif.js";import"./omit-B7stZg_p.js";import"./useId-BiFzyKmP.js";import"./ReadOnlyIcon-fpBUgZkh.js";import"./Loader-C31s9nuZ.js";import"./Provider-ChnEfPss.js";import"./useId-sDoo_C8F.js";import"./useFormField-BZtIeUXv.js";import"./Fieldset-DZVRdKGd.js";import"./Tag-BWaKO8vm.js";import"./Textarea-CArg_PMq.js";import"./index-CRSK7kgn.js";import"./index-BxWMR1Ay.js";import"./useClientLayoutEffect-Dt_TuINI.js";import"./Select-BQ6tobI2.js";import"./ChevronDown-DKSW_DmS.js";import"./Radio-QYcOLfdt.js";import"./useDatepicker-CPQkP5dz.js";import"./Date.Input-DmVXlpzX.js";import"./TextField-1A0BebA6.js";import"./PersonPencilFill-CoF6qBVB.js";import"./KeyVerticalFill-m_CavoP-.js";import"./Checkmark-abnGd_Ay.js";import"./BasePrimitive-eMFBMVLd.js";import"./floating-ui.react-CkbDYyWV.js";import"./ExclamationmarkTriangleFill-BFbmXhrr.js";import"./XMarkOctagonFill-Cj0h8cZo.js";import"./Popover-NZlUk6zR.js";var J=(r=>(r.VURDER_FORELDELSE="5003",r))(J||{});const mr=Oe(3),gr=Ve(1500),pr=r=>r!==b.UDEFINERT?r:void 0,kr=r=>r.foreldet?r.foreldet:pr(r.foreldelseVurderingType),yr=r=>({...r,foreldet:kr(r)}),qe=({skjulPeriode:r,readOnly:n,periode:a,oppdaterPeriode:d,kodeverkSamlingFpTilbake:q})=>{const m=Y(),o=fe({defaultValues:yr(a)}),v=o.watch("foreldet"),c=v&&v===b.FORELDET,T=v&&v===b.TILLEGGSFRIST,s=q[pe.FORELDELSE_VURDERING].filter(g=>g.kode!==b.IKKE_VURDERT);return e.jsx(ye,{formMethods:o,onSubmit:g=>d(g),children:e.jsxs(x,{gap:"4",children:[e.jsx(Ze,{name:"begrunnelse",label:m.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[B,mr,gr,Ie],maxLength:1500,readOnly:n}),e.jsxs(O,{gap:"10",children:[e.jsx(Ye,{name:"foreldet",label:e.jsx(p,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[B],radios:s.map(g=>({label:g.navn,value:g.kode})),isReadOnly:n}),e.jsxs(x,{gap:"5",children:[(c||T)&&e.jsx(re,{name:"foreldelsesfrist",label:m.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[B,ee],isReadOnly:n}),T&&e.jsx(re,{name:"oppdagelsesDato",label:m.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[B,ee,Be],isReadOnly:n,fromDate:y("1970-01-01").toDate(),toDate:y().toDate()})]})]}),e.jsxs(O,{gap:"4",children:[e.jsx(D,{size:"small",variant:"primary",disabled:!o.formState.isDirty||o.formState.isSubmitting||n,loading:o.formState.isSubmitting,children:e.jsx(p,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(D,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(p,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};qe.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const se=(r,n)=>y(r.fom).diff(y(n.fom)),Er=()=>y().subtract(30,"months").format(L),Ar=r=>r?[e.jsx(p,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Er()}},"vurderForeldelse")]:[],N=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===b.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Mr=(r=[])=>r.map((n,a)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:N(n),isGodkjent:b.FORELDET!==n.foreldet&&b.UDEFINERT!==n.foreldet,id:a})),Or=r=>({foreldelsePerioder:r.map(a=>({fraDato:a.fom,tilDato:a.tom,begrunnelse:a.begrunnelse,foreldelseVurderingType:a.foreldet,foreldelsesfrist:a.foreldelsesfrist,oppdagelsesDato:a.oppdagelsesDato})),kode:J.VURDER_FORELDELSE}),Vr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Ir=r=>[...r].sort(Vr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===b.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:ze(n.begrunnelse)})),De=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a,aksjonspunkt:d,alleMerknaderFraBeslutter:q,perioderForeldelse:m,readOnly:o,kodeverkSamlingFpTilbake:v,beregnBelop:c,behandlingUuid:T,formData:s,setFormData:g})=>{const k=l.useMemo(()=>Ir(m.perioder),[m.perioder]),[i,E]=l.useState(s||k),[t,R]=l.useState(i==null?void 0:i.find(N)),[A,w]=l.useState(!1),[f,M]=l.useState(!!s),j=u=>{const h=u?i.find(P=>P.fom===u.fom&&P.tom===u.tom):void 0;R(h)},ae=l.useCallback(()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===i.length-1?u:u+1;j(i[h])},[i,t]),V=l.useCallback(()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===0?u:u-1;j(i[h])},[i,t]),S=l.useCallback(()=>{j(void 0)},[t,i]),Fe=l.useCallback(u=>{const h=Ge(u,"erSplittet"),C=i.filter(F=>F.fom!==h.fom&&F.tom!==h.tom).concat(h).sort(se);E(C),g(C),M(!0),S();const I=C.find(N);I&&j(I)},[i,S,N]),we=l.useCallback(u=>{const h=i.find(F=>F.fom===(t==null?void 0:t.fom)&&F.tom===(t==null?void 0:t.tom));if(h===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${t==null?void 0:t.fom} Tom: ${t==null?void 0:t.tom}`);const P=u.map(F=>({...h,...F,erSplittet:!0})),I=i.filter(F=>F.fom!==(t==null?void 0:t.fom)&&F.tom!==(t==null?void 0:t.tom)).concat(P).sort(se);E(I),g(I),M(!0),S(),j(P[0])},[i,t,S,N]),Se=l.useCallback(()=>{w(!0),r(Or(i))},[i]),xe=q[J.VURDER_FORELDELSE],W=Mr(i),Ee=d&&d.status===ke.OPPRETTET,Ae=W.every(u=>!u.isAksjonspunktOpen),U=t?W.find(u=>u.fom===t.fom&&u.tom===t.tom):void 0;return e.jsx(We,{merknaderFraBeslutter:xe,withoutBorder:!0,children:e.jsxs(x,{gap:"4",children:[e.jsx(be,{size:"small",children:e.jsx(p,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(p,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(p,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),i&&d&&e.jsxs(x,{gap:"4",children:[Ee&&e.jsx(Qe,{children:Ar(d)}),e.jsx(Pe,{perioder:W,valgtPeriode:U,setPeriode:j,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a}),t&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":U==null?void 0:U.id.toString(),children:e.jsx(ur,{borderWidth:"1",padding:"4",children:e.jsxs(x,{gap:"4",children:[e.jsx(je,{setNestePeriode:ae,setForrigePeriode:V,valgtPeriode:t,readOnly:o,oppdaterSplittedePerioder:we,behandlingUuid:T,beregnBelop:c,lukkPeriode:S}),e.jsx(he,{feilutbetaling:t.feilutbetaling,fom:t.fom,tom:t.tom}),e.jsx(qe,{periode:t,oppdaterPeriode:Fe,skjulPeriode:S,readOnly:o,kodeverkSamlingFpTilbake:v},t.fom)]})})}),e.jsx(O,{children:e.jsx(Je,{isReadOnly:o,isDirty:f,isSubmittable:!t&&Ae,onClick:Se,isSubmitting:A})})]})]})})};De.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
