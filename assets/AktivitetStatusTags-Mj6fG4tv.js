import{j as i,H as u,f as o}from"./iframe-BL9U80vm.js";const m=({beregningsgrunnlagPeriode:n,kodeverkSamling:t})=>{const r=d(n,t);return r.length===0?null:i.jsx(u,{gap:"space-8",children:r.map(({visningsNavn:l,kode:e,tagType:a})=>i.jsx(o,{variant:a,title:l,children:l},e))})},g=n=>{switch(n){case"FL_SN":case"SN":return"alt2";case"FL":return"alt1";case"AT_SN":case"AT_FL":case"AT_FL_SN":case"AT":return"info";case"KUN_YTELSE":case"DP":case"TY":case"SP_AV_DP":case"AAP":case"PSB_AV_DP":case"VENTELØNN_VARTPENGER":return"success";case"MIDL_INAKTIV":case"MS":case"BA":case"IKKE_YRKESAKTIV":default:return"neutral"}},d=(n,t)=>{const r=n.flatMap(e=>e.beregningsgrunnlagPrStatusOgAndel||[]).filter(e=>e.erTilkommetAndel!==!0).map(e=>e.aktivitetStatus);return[...new Set(r)].map(e=>({visningsNavn:t.AktivitetStatus.find(({kode:s})=>s===e)?.navn||"",kode:e,tagType:g(e)})).sort((e,a)=>e.visningsNavn.localeCompare(a.visningsNavn))};m.__docgenInfo={description:"",methods:[],displayName:"AktivitetStatusTags",props:{beregningsgrunnlagPeriode:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
