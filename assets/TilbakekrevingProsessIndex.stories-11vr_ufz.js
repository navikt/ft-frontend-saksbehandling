import{c as z,ad as Je,j as e,av as Ze,M as be,O as qe,V as x,L as $,B as S,d as y,v as te,aS as jr,I as Xe,G as F,t as Rr,r as P,H as A,aT as Qe,aU as er,an as xr,ae as Br,aV as Ar,ag as ae,n as C,aX as ee,aR as H,z as w,D as je,as as rr,aY as Oe,aZ as Pr,aw as wr,az as me,E as Sr,aA as Te,ao as nr,a_ as De,a$ as Fr,ax as Or,au as Vr,J as Er,aK as Gr,aW as Re,P as Ir,m as _r}from"./iframe-iFYuR8eA.js";import{g as Ur}from"./withIntl-dhWrYKl7.js";import{a as Mr}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as R,O as Dr,J as Nr,R as Kr,l as tr,i as Lr,a as _e,o as Ue,M as xe,b as de,$ as Ve,Z as $r,y as ar}from"./style-DT-cn32O.js";import{M as i}from"./message-CAAytR0f.js";import{S as Ne,T as Se,a as Hr,b as zr,c as Cr,d as Yr,e as Wr,f as Jr}from"./Timeline-DdVHCYb_.js";import{S as Zr}from"./Scissors-Du9fclHh.js";import{T as M}from"./Table-Cpq8kLxj.js";import{T as Xr,m as sr}from"./nb_NO-qdtSKF8Z.js";import{a as Qr,S as en}from"./SilhouetteFill-BpxPYX82.js";import"./preload-helper-D9Z9MdNV.js";const rn="_button_8q57x_1",nn="_cancelButton_8q57x_5",Ke={button:rn,cancelButton:nn},tn=(r,t)=>n=>n&&(Nr(n)(y(r.tom.toString()).subtract(1,"day"))||Kr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,an=(r,t)=>{const n=y(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},s={fom:n.format(Rr),tom:t.tom};return{forstePeriode:a,andrePeriode:s}},ir=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:s})=>{const l=z(),u=Je();return e.jsx(Ze,{formMethods:u,onSubmit:k=>s(an(k,r)),children:e.jsxs(be,{open:t,"aria-label":l.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(be.Header,{children:e.jsx(qe,{size:"small",level:"2",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(be.Body,{children:e.jsxs(x,{gap:"space-16",children:[e.jsxs("div",{children:[e.jsx($,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(S,{size:"small",children:`${y(r.fom.toString()).format(te)} - ${y(r.tom.toString()).format(te)}`})]}),e.jsx(jr,{name:"forstePeriodeTomDato",control:u.control,label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[R,Dr,tn(r,l)],fromDate:y(r.fom).toDate(),toDate:y(r.tom).toDate()}),a&&e.jsx(Xe,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(be.Footer,{children:[e.jsx(F,{size:"small",variant:"primary",className:Ke.button,disabled:!u.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(F,{size:"small",variant:"secondary",onClick:n,className:Ke.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};ir.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
...
}`,...fe.parameters?.docs?.source}}};const xt=["Default","MedToPerioder"];export{ce as Default,fe as MedToPerioder,xt as __namedExportsOrder,Rt as default};
