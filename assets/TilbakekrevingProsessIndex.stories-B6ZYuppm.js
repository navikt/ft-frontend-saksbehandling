import{c as Ae,ad as gt,j as s,av as ct,M as jr,O as Nr,V as U,L as De,B as z,d as V,v as er,aS as Oa,I as ft,G as Z,t as Da,r as C,H as L,aT as kt,aU as pt,an as Pa,aV as Aa,ag as rr,n as Fe,aX as We,aR as Pe,z as H,D as Vr,as as ht,aY as fn,aZ as Fa,aw as Ba,az as fr,E as Ya,aA as Ar,ao as yt,a_ as Jn,a$ as Na,ax as Va,au as Ia,J as Ua,aK as Ea,aW as Ir,P as Ga,m as La}from"./iframe-v14nT4cW.js";import{g as Wa}from"./withIntl-DTl179MZ.js";import{a as Ca}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as I,O as Ha,J as za,R as $a,l as vt,i as Ka,a as jn,o as xn,M as Ur,b as gr,$ as kn,Z as Za,y as bt}from"./style-CPQhv4jP.js";import{M as k}from"./message-CRSMnX2m.js";import{S as Qn,T as on,a as Ja,b as Qa,c as Xa,d as es,e as rs,f as ns}from"./Timeline-D9noD--K.js";import{S as ts}from"./Scissors-C6kyfUX8.js";import{T as fe}from"./Table-djEPbukv.js";import{T as as,m as Tt}from"./nb_NO-DNnJQvXP.js";import{a as ss,S as is}from"./SilhouetteFill-BDg030cq.js";import"./preload-helper-D9Z9MdNV.js";const ls="_button_8q57x_1",os="_cancelButton_8q57x_5",Xn={button:ls,cancelButton:os},us=(e,r)=>n=>n&&(za(n)(V(e.tom.toString()).subtract(1,"day"))||$a(n)(e.fom))?r.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,ds=(e,r)=>{const n=V(e.forstePeriodeTomDato).add(1,"days"),t={fom:r.fom,tom:e.forstePeriodeTomDato},a={fom:n.format(Da),tom:r.tom};return{forstePeriode:t,andrePeriode:a}},_t=({periodeData:e,showModal:r,cancelEvent:n,finnesBelopMed0Verdi:t,splitPeriod:a})=>{const i=Ae(),l=gt();return s.jsx(ct,{formMethods:l,onSubmit:o=>a(ds(o,e)),children:s.jsxs(jr,{open:r,"aria-label":i.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[s.jsx(jr.Header,{children:s.jsx(Nr,{size:"small",level:"2",children:s.jsx(k,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),s.jsx(jr.Body,{children:s.jsxs(U,{gap:"space-16",children:[s.jsxs("div",{children:[s.jsx(De,{size:"small",children:s.jsx(k,{id:"DelOppPeriodeModalImpl.Periode"})}),s.jsx(z,{size:"small",children:`${V(e.fom.toString()).format(er)} - ${V(e.tom.toString()).format(er)}`})]}),s.jsx(Oa,{name:"forstePeriodeTomDato",control:l.control,label:s.jsx(k,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[I,Ha,us(e,i)],fromDate:V(e.fom).toDate(),toDate:V(e.tom).toDate()}),t&&s.jsx(ft,{variant:"error",children:s.jsx(k,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),s.jsxs(jr.Footer,{children:[s.jsx(Z,{size:"small",variant:"primary",className:Xn.button,disabled:!l.formState.isDirty,children:s.jsx(k,{id:"DelOppPeriodeModalImpl.Ok"})}),s.jsx(Z,{size:"small",variant:"secondary",onClick:n,className:Xn.cancelButton,type:"button",children:s.jsx(k,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};_t.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
...
}`,...Pr.parameters?.docs?.source}}};const xd=["Default","MedToPerioder"];export{Dr as Default,Pr as MedToPerioder,xd as __namedExportsOrder,jd as default};
