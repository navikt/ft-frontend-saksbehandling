import{a as Pr}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as nr,G as Fr,J as C,Z as tr,X as we,t as Sr,U as wr,K as oe,Q as Vr}from"./index.es-SFqXkZt8.js";import{g as Or}from"./withIntl-Hv9Qcjmf.js";import{a as _r}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as x,O as Er,H as Ir,D as Mr,l as ar,i as Gr,a as Ie,o as Me,N as he,S as ce,h as fe,I as Dr,m as Ve,d as Nr}from"./style-CcQVkQsf.js";import{u as z,d as q,P as Q,A as Ur,i as Lr,j as ee,h as Te,K as sr,k as je,a as Kr,n as Cr}from"./index.es-DxogalCq.js";import{r as T}from"./index-DASCADcX.js";import{h as M}from"./moment-C5S46NFB.js";import{M as i,Y as J,b as Ue,t as $r,L as zr}from"./index.es-sk3JG121.js";import{c as ir,u as Ge}from"./ReadOnlyIcon-DezK7_1v.js";import{M as pe}from"./Modal-BsdIhMBu.js";import{H as qe,L as $,a as S,D as xe,E as Hr}from"./Label-C-_BY61p.js";import{V as R,H as E}from"./VStack-CjRg3Zfs.js";import{A as lr}from"./Alert-CsAGiB4k.js";import{B as w}from"./Button-CiEWTRO4.js";import{S as Le,T as Fe,a as Yr,b as Jr,c as Wr,d as Xr,e as Zr,f as Qr}from"./Timeline-BPJ7-mZB.js";import{S as en}from"./Scissors-DzHI4ozx.js";import{S as or,a as ur}from"./DatePicker-CtFgYtE3.js";import{S as rn}from"./XMark-KAXZPgUH.js";import{T as K}from"./Table-BE-bAmGe.js";import{T as nn,m as dr}from"./nb_NO-svnjcYmh.js";import{a as tn,S as an}from"./SilhouetteFill-Dse_AnU7.js";import{B as sn}from"./Box-BRUAy9sN.js";/* empty css              */import"./v4-CtRu48qb.js";import"./Checkbox-sga406yY.js";import"./clsx-B-dksMZM.js";import"./omit-B7stZg_p.js";import"./useId-BiFzyKmP.js";import"./useFormField-BJl8SNDY.js";import"./Fieldset-D02MJfZs.js";import"./Tag-CCjwuauJ.js";import"./Textarea-BJ2JSFef.js";import"./index-CL4jvrHg.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BxWMR1Ay.js";import"./useClientLayoutEffect-Dt_TuINI.js";import"./create-context-Bo0OP0Ib.js";import"./Loader-DokcRViZ.js";import"./Provider-DeC0qy30.js";import"./Select-BQeaFgvO.js";import"./ChevronDown-DKSW_DmS.js";import"./useId-sDoo_C8F.js";import"./Radio-DX13p-wz.js";import"./useDatepicker-UNp_ANWf.js";import"./useDateTranslationContext-CJAj3RHb.js";import"./TextField-y4U1ZNhM.js";import"./PersonPencilFill-CoF6qBVB.js";import"./KeyVerticalFill-m_CavoP-.js";import"./Checkmark-abnGd_Ay.js";import"./floating-ui.react-C49gkrzP.js";import"./Theme-s5aaJqOF.js";import"./BasePrimitive-CQFd8qnq.js";import"./ExclamationmarkTriangleFill-BFbmXhrr.js";import"./XMarkOctagonFill-Cj0h8cZo.js";import"./Popover-DD4koGWt.js";var De=(r=>(r.VURDER_TILBAKEKREVING="5002",r))(De||{});const ln="_button_8q57x_1",on="_cancelButton_8q57x_5",Ke={button:ln,cancelButton:on},un=(r,t)=>n=>n&&(Ir(n)(q(r.tom.toString()).subtract(1,"day"))||Mr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,dn=(r,t)=>{const n=q(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},s={fom:n.format(Ur),tom:t.tom};return{forstePeriode:a,andrePeriode:s}},mr=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:s})=>{const d=z(),m=ir();return e.jsx(nr,{formMethods:m,onSubmit:k=>s(dn(k,r)),children:e.jsxs(pe,{open:t,"aria-label":d.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(pe.Header,{children:e.jsx(qe,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(pe.Body,{children:e.jsxs(R,{gap:"4",children:[e.jsxs("div",{children:[e.jsx($,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(S,{size:"small",children:`${q(r.fom.toString()).format(Q)} - ${q(r.tom.toString()).format(Q)}`})]}),e.jsx(Fr,{name:"forstePeriodeTomDato",label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[x,Er,un(r,d)],fromDate:q(r.fom).toDate(),toDate:q(r.tom).toDate()}),a&&e.jsx(lr,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(pe.Footer,{children:[e.jsx(w,{size:"small",variant:"primary",className:Ke.button,disabled:!m.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(w,{size:"small",variant:"secondary",onClick:n,className:Ke.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};mr.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
