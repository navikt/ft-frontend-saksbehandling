...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const N=({beregningsgrunnlag:e,beregningsgrunnlagsvilkår:r,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t})=>n.jsxs(A,{gap:"space-8",paddingBlock:"space-16",children:[n.jsx(b,{beregningsgrunnlag:e,beregningsgrunnlagsvilkår:r,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t}),e.inntektsgrunnlag&&e.sammenligningsgrunnlagPrStatus?.[0]?.sammenligningsgrunnlagFom&&n.jsx(q,{sammenligningsgrunnlagFom:e.sammenligningsgrunnlagPrStatus[0].sammenligningsgrunnlagFom,sammenligningsgrunnlagInntekter:e.inntektsgrunnlag.sammenligningsgrunnlagInntekter,arbeidsgiverOpplysningerPerId:t})]});N.__docgenInfo={description:"",methods:[],displayName:"TabInnhold",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const K=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),V=e=>e.some(r=>K.has(r.definisjon)&&r.kanLoses),B=(e,r)=>{const a=e.vilkårsperiodeFom;return(r?.perioder??[]).filter(l=>l.vurderesIBehandlingen&&!l.erForlengelse).some(l=>l.periode.fom===a)},h=(e,r)=>{const a=M(e,r),t=a.find(s=>s.skalVurderes&&s.harAvklaringsbehov)?.bgIndex??0,[l,d]=f.useState(t);return{tabOptions:a,currentTabValue:l.toString(),onTabChange:s=>d(Number(s))}},M=(e,r)=>e.map((a,t)=>({bgIndex:t,skalVurderes:B(a,r),harAvklaringsbehov:V(a.avklaringsbehov),skjæringstidspunkt:a.skjaeringstidspunktBeregning,optionLabel:R(a.skjaeringstidspunktBeregning)})).sort((a,t)=>v(a.skjæringstidspunkt).diff(v(t.skjæringstidspunkt))),j=L(D),y=({beregningsgrunnlagListe:e,beregningsgrunnlagsvilkår:r,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t})=>{const{tabOptions:l,currentTabValue:d,onTabChange:s}=h(e,r);return n.jsx(S,{value:j,children:n.jsxs(u,{value:d,onChange:s,children:[l.length>1&&n.jsx(u.List,{children:l.map(i=>n.jsx(u.Tab,{value:i.bgIndex.toString(),label:i.optionLabel,icon:i.harAvklaringsbehov?n.jsx(G,{"aria-hidden":!0,color:"var(--ax-bg-warning-strong)"}):void 0},i.bgIndex))}),l.map(i=>n.jsx(u.Panel,{value:i.bgIndex.toString(),"aria-label":i.optionLabel,children:n.jsx(N,{beregningsgrunnlag:e[i.bgIndex],beregningsgrunnlagsvilkår:r,kodeverkSamling:a,arbeidsgiverOpplysningerPerId:t})},i.bgIndex))]})})};y.__docgenInfo={description:"",methods:[],displayName:"BeregningProsessIndex",props:{beregningsgrunnlagListe:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
}`,...m.parameters?.docs?.source}}};const Z=["CaseArbeidstakerMedEttArbeidsforholdFP","ToGrunnlagHvorEnHarÅpentAP"];export{o as CaseArbeidstakerMedEttArbeidsforholdFP,m as ToGrunnlagHvorEnHarÅpentAP,Z as __namedExportsOrder,X as default};
