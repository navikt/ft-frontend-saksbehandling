import{a as Z}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{D as ee,N as re,O as te}from"./index.es-DrV1Wcq6.js";import{a as ne}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as ie,r as ae,y as _,a as O,I as U,j as se,d as le}from"./style-B1grEWaQ.js";import{u as M,j as ue,V as de,a as c,b as oe,r as ke}from"./index.es-Bs6SSTCM.js";import{r as x,e as ge}from"./index-DNHX5htx.js";import{u as me,b as ve}from"./index.esm-CkkEN1rj.js";import{c as pe}from"./index-DFtWylL1.js";import{S as be}from"./PlusCircle-Bh9z4REp.js";import{D as L,H as K,L as B,a as b}from"./Label-CYbek38p.js";import{M as m}from"./message-B4eBuUqZ.js";import{V as T,H as S}from"./VStack-xkjQwvKn.js";import"./Theme-C_brBVJK.js";import{E as h}from"./ExpansionCard-ypp3LTjM.js";import{S as fe}from"./ExclamationmarkTriangleFill-DrBUO71d.js";import{n as ye}from"./index.es-BiGVFuAv.js";import{T as s}from"./Table-CAbNZsjR.js";/* empty css              */import"./v4-CtRu48qb.js";import"./dayjs.min-Cke173X9.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Button-Cc809GDC.js";import"./Loader-42dkOmtz.js";import"./omit-B7stZg_p.js";import"./useId-CsAOvYkp.js";import"./Provider-BZs7ODlm.js";import"./Checkbox-BaSR81FM.js";import"./ReadOnlyIcon-BUzfiMc5.js";import"./useId-SP_zdaIa.js";import"./useFormField-Bu2NUIkp.js";import"./Fieldset-B4jGbpi0.js";import"./Tag-ntoonGP8.js";import"./Textarea-BjE6whUD.js";import"./index-DU09BupE.js";import"./index-7Fg4giie.js";import"./useClientLayoutEffect-pkze6c0k.js";import"./Select-CvyZY3UD.js";import"./ChevronDown-6T9JsqER.js";import"./Radio-Pmn7OwXu.js";import"./useDatepicker-CuBmBNa3.js";import"./Date.Input-D651xWgA.js";import"./DatePicker-hprz5Yye.js";import"./useControllableState-CEDyyUuG.js";import"./Modal-DdoS0OAm.js";import"./floating-ui.react-D9M9yXN8.js";import"./XMark-6H9iuGiv.js";import"./Popover-uyW-ft96.js";import"./TextField-DY81zaLa.js";import"./BasePrimitive-gBgyIEwX.js";import"./Alert-Ja4tf6sE.js";import"./XMarkOctagonFill-Dr7RQDrl.js";import"./PersonPencilFill-DqunLdn1.js";import"./Box-C3b4VC_S.js";import"./KeyVerticalFill-DmgzHF4Z.js";var E=(n=>(n.FORSETT="FORSETT",n.GROVT_UAKTSOM="GROVT_UAKTSOM",n.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",n))(E||{});const v={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"};var C=(n=>(n.FORESLA_VEDTAK="5004",n))(C||{});const ce="_addCircleIcon_84ecs_1",Te="_imageText_84ecs_7",qe="_addPeriode_84ecs_12",w={addCircleIcon:ce,imageText:Te,addPeriode:qe},H=ae(3),Ae=O(4e3),he=[H,_],je=[ie,H,_],z=({type:n,readOnly:i,fritekstPakrevet:t,maximumLength:r})=>{const a=M(),{watch:u}=me(),l=u(n)===void 0,[k,o]=x.useState(l&&!t),g=t?je:he;return g.push(r?O(r):Ae),e.jsxs(e.Fragment,{children:[k&&!i&&e.jsx(e.Fragment,{children:e.jsxs("div",{onClick:p=>{p.preventDefault(),o(!1)},onKeyDown:p=>{p.preventDefault(),o(!1)},className:w.addPeriode,role:"button",tabIndex:0,children:[e.jsx(be,{className:w.addCircleIcon,title:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),e.jsx(L,{size:"small",className:w.imageText,children:e.jsx(m,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})}),!k&&e.jsx(ee,{name:n,label:a.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:g,maxLength:r||4e3,readOnly:i})]})};z.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{type:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},fritekstPakrevet:{required:!1,tsType:{name:"boolean"},description:""},maximumLength:{required:!1,tsType:{name:"number"},description:""}}};const Pe="_container_aetpe_1",Re="_gulmarkering_aetpe_4",G={container:Pe,gulmarkering:Re},P=({intl:n,vedtaksbrevAvsnitt:i,readOnly:t,perioderSomIkkeHarUtfyltObligatoriskVerdi:r,fritekstOppsummeringPakrevdMenIkkeUtfylt:a=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:u})=>e.jsxs(T,{gap:"2",className:G.container,children:[e.jsx(K,{size:"small",children:e.jsx(m,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),i.map(l=>{const k=l.underavsnittsliste,o=`${l.fom}_${l.tom}`,g=r.some(d=>d===o),p=l.avsnittstype===v.OPPSUMMERING&&a;return e.jsx(ge.Fragment,{children:e.jsxs(h,{"aria-label":"periode",defaultOpen:g||p,className:g||p?G.gulmarkering:"",children:[e.jsx(h.Header,{children:e.jsx(h.Title,{size:"small",children:l.overskrift?l.overskrift:n.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),e.jsx(h.Content,{children:e.jsx(T,{gap:"2",children:k.map(d=>e.jsxs(T,{gap:"2",children:[d.overskrift&&e.jsx(B,{size:"small",children:d.overskrift}),d.brødtekst&&e.jsx(b,{size:"small",children:d.brødtekst}),d.fritekstTillatt&&e.jsx(e.Fragment,{children:e.jsx(z,{type:d.underavsnittstype?`${o}.${d.underavsnittstype}`:l.avsnittstype,readOnly:t,fritekstPakrevet:d.fritekstPåkrevet,maximumLength:u?1e4:void 0})})]},(d.underavsnittstype||"")+d.overskrift+d.brødtekst))})})]})},l.avsnittstype+l.fom)})]});P.buildInitialValues=n=>n.filter(i=>i.underavsnittsliste.some(t=>t.fritekst)).reduce((i,t)=>{const a=t.underavsnittsliste.filter(l=>l.fritekst).reduce((l,k)=>({...l,[k.underavsnittstype?k.underavsnittstype:t.avsnittstype]:ue(k.fritekst)}),{}),u=t.fom?{[`${t.fom}_${t.tom}`]:a}:a;return{...i,...u}},{});P.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"vedtaksbrevAvsnitt",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avsnittstype: string;
  fom?: string;
  tom?: string;
  overskrift?: string;
  ...
  underavsnittstype?: string;
  fritekstPåkrevet?: boolean;
}[]`,required:!0}}]}}],raw:"VedtaksbrevAvsnitt[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},perioderSomIkkeHarUtfyltObligatoriskVerdi:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},fritekstOppsummeringPakrevdMenIkkeUtfylt:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""}}};const we="_buttonLink_sudxz_1",Ve="_padding_sudxz_8",xe="_infoTextIcon_sudxz_14",V={buttonLink:we,padding:Ve,infoTextIcon:xe},Y=n=>{const i=de(n,v.OPPSUMMERING);return{oppsummeringstekst:n[v.OPPSUMMERING],perioderMedTekst:Object.keys(i).map(t=>({fom:t.split("_")[0],tom:t.split("_")[1],faktaAvsnitt:i[t][v.FAKTA],foreldelseAvsnitt:i[t][v.FORELDELSE],vilkaarAvsnitt:i[t][v.VILKAR],saerligeGrunnerAvsnitt:i[t][v.SARLIGEGRUNNER],saerligeGrunnerAnnetAvsnitt:i[t][v.SARLIGEGRUNNER_ANNET]}))}},Be=(n,i)=>n.some(t=>t.avsnittstype===v.OPPSUMMERING&&t.underavsnittsliste.some(r=>r.fritekstPåkrevet)&&!i[v.OPPSUMMERING]),Ee=n=>({kode:C.FORESLA_VEDTAK,...Y(n)}),Se=(n,i)=>n.reduce((t,r)=>{const a=`${r.fom}_${r.tom}`,u=i[a];return r.underavsnittsliste.some(o=>o.fritekstPåkrevet&&o.underavsnittstype===v.FAKTA)&&(!u||!u[v.FAKTA])||r.underavsnittsliste.some(o=>o.fritekstPåkrevet&&o.underavsnittstype===v.SARLIGEGRUNNER_ANNET)&&(!u||!u[v.SARLIGEGRUNNER_ANNET])?t.concat(a):t},[]),N=(n,i,t)=>r=>{n({uuid:i,...Y(t)}),r.preventDefault()},$=({submitCallback:n,readOnly:i,fetchPreviewVedtaksbrev:t,avsnittsliste:r,behandlingUuid:a,erRevurderingTilbakekrevingKlage:u,erRevurderingTilbakekrevingFeilBeløpBortfalt:l,formData:k,setFormData:o})=>{const g=r,p=x.useMemo(()=>k||P.buildInitialValues(g),[k,g]),d=M(),f=ve({defaultValues:p}),y=f.watch(),R=Be(g,y),q=Se(g,y),X=R||q.length>0;return e.jsx(re,{formMethods:f,onSubmit:A=>n(Ee(A)),setDataOnUnmount:o,children:e.jsxs(T,{gap:"4",children:[e.jsx(P,{intl:d,vedtaksbrevAvsnitt:g,readOnly:i,perioderSomIkkeHarUtfyltObligatoriskVerdi:x.useMemo(()=>q,[]),fritekstOppsummeringPakrevdMenIkkeUtfylt:R,erRevurderingTilbakekrevingFeilBeløpBortfalt:l}),e.jsxs(S,{gap:"10",children:[e.jsx(te,{text:d.formatMessage({id:"TilbakekrevingVedtakForm.TilGodkjenning"}),isReadOnly:i,isSubmittable:q.length===0&&!R,isSubmitting:f.formState.isSubmitting,isDirty:f.formState.isDirty,hasErrors:X}),q.length===0&&e.jsx("div",{className:V.padding,children:e.jsx("a",{href:"",onClick:N(t,a,y),onKeyDown:A=>A.key==="Enter"?N(t,a,y)(A):null,className:pe(V.buttonLink,"lenke lenke--frittstaende"),children:e.jsx(m,{id:"TilbakekrevingVedtakForm.ForhandvisBrev"})})})]}),u&&e.jsxs(S,{children:[e.jsx(fe,{className:V.infoTextIcon}),e.jsx(m,{id:"TilbakekrevingVedtakForm.Infotekst.Klage"})]})]})})};$.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakForm",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`{
  perioderMedTekst: {
    fom: string;
    tom: string;
    faktaAvsnitt: string;
