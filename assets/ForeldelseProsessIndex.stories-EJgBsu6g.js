...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const se=(r,n)=>y(r.fom).diff(y(n.fom)),Er=()=>y().subtract(30,"months").format(L),Ar=r=>r?[e.jsx(p,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Er()}},"vurderForeldelse")]:[],N=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===b.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Mr=(r=[])=>r.map((n,a)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:N(n),isGodkjent:b.FORELDET!==n.foreldet&&b.UDEFINERT!==n.foreldet,id:a})),Or=r=>({foreldelsePerioder:r.map(a=>({fraDato:a.fom,tilDato:a.tom,begrunnelse:a.begrunnelse,foreldelseVurderingType:a.foreldet,foreldelsesfrist:a.foreldelsesfrist,oppdagelsesDato:a.oppdagelsesDato})),kode:W.VURDER_FORELDELSE}),Vr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Ir=r=>[...r].sort(Vr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===b.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:ze(n.begrunnelse)})),De=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a,aksjonspunkt:d,alleMerknaderFraBeslutter:q,perioderForeldelse:m,readOnly:o,kodeverkSamlingFpTilbake:v,beregnBelop:c,behandlingUuid:T,formData:s,setFormData:g})=>{const k=l.useMemo(()=>Ir(m.perioder),[m.perioder]),[i,E]=l.useState(s||k),[t,R]=l.useState(i==null?void 0:i.find(N)),[A,w]=l.useState(!1),[f,M]=l.useState(!!s),j=u=>{const h=u?i.find(P=>P.fom===u.fom&&P.tom===u.tom):void 0;R(h)},ae=l.useCallback(()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===i.length-1?u:u+1;j(i[h])},[i,t]),V=l.useCallback(()=>{const u=i.findIndex(P=>P.fom===(t==null?void 0:t.fom)&&P.tom===(t==null?void 0:t.tom)),h=u===0?u:u-1;j(i[h])},[i,t]),S=l.useCallback(()=>{j(void 0)},[t,i]),Fe=l.useCallback(u=>{const h=Ge(u,"erSplittet"),U=i.filter(F=>F.fom!==h.fom&&F.tom!==h.tom).concat(h).sort(se);E(U),g(U),M(!0),S();const I=U.find(N);I&&j(I)},[i,S,N]),we=l.useCallback(u=>{const h=i.find(F=>F.fom===(t==null?void 0:t.fom)&&F.tom===(t==null?void 0:t.tom));if(h===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${t==null?void 0:t.fom} Tom: ${t==null?void 0:t.tom}`);const P=u.map(F=>({...h,...F,erSplittet:!0})),I=i.filter(F=>F.fom!==(t==null?void 0:t.fom)&&F.tom!==(t==null?void 0:t.tom)).concat(P).sort(se);E(I),g(I),M(!0),S(),j(P[0])},[i,t,S,N]),Se=l.useCallback(()=>{w(!0),r(Or(i))},[i]),xe=q[W.VURDER_FORELDELSE],X=Mr(i),Ee=d&&d.status===ke.OPPRETTET,Ae=X.every(u=>!u.isAksjonspunktOpen),C=t?X.find(u=>u.fom===t.fom&&u.tom===t.tom):void 0;return e.jsx(Xe,{merknaderFraBeslutter:xe,withoutBorder:!0,children:e.jsxs(x,{gap:"4",children:[e.jsx(be,{size:"small",children:e.jsx(p,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(p,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(p,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),i&&d&&e.jsxs(x,{gap:"4",children:[Ee&&e.jsx(Je,{children:Ar(d)}),e.jsx(Pe,{perioder:X,valgtPeriode:C,setPeriode:j,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a}),t&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":C==null?void 0:C.id.toString(),children:e.jsx(ur,{borderWidth:"1",padding:"4",children:e.jsxs(x,{gap:"4",children:[e.jsx(je,{setNestePeriode:ae,setForrigePeriode:V,valgtPeriode:t,readOnly:o,oppdaterSplittedePerioder:we,behandlingUuid:T,beregnBelop:c,lukkPeriode:S}),e.jsx(he,{feilutbetaling:t.feilutbetaling,fom:t.fom,tom:t.tom}),e.jsx(qe,{periode:t,oppdaterPeriode:Fe,skjulPeriode:S,readOnly:o,kodeverkSamlingFpTilbake:v},t.fom)]})})}),e.jsx(O,{children:e.jsx(We,{isReadOnly:o,isDirty:f,isSubmittable:!t&&Ae,onClick:Se,isSubmitting:A})})]})]})})};De.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
...
}`,...(ge=(me=$.parameters)==null?void 0:me.docs)==null?void 0:ge.source}}};const Cn=["Default","UtenAksjonspunkt"];export{H as Default,$ as UtenAksjonspunkt,Cn as __namedExportsOrder,_n as default};
