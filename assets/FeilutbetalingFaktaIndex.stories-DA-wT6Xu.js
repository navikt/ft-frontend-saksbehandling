import{a as W}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{Z as U,e as X,U as Z,K as Q}from"./index.es-SFqXkZt8.js";import{a as J}from"./alleKodeverk-LoqTPBoT.js";import{a as ee}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as _,I as x,a as ne,o as re,N as te,z as $,u as ae,$ as N,W as ie,X as se}from"./style-CcQVkQsf.js";import{P as E,u as le,h as oe,a as de,n as ue}from"./index.es-DxogalCq.js";import{u as ge,d as pe,c as me}from"./ReadOnlyIcon-DezK7_1v.js";import{h as P}from"./moment-C5S46NFB.js";import{M as g,L as ke,Q as c,t as ye}from"./index.es-sk3JG121.js";import{T as y}from"./Table-BE-bAmGe.js";import{H as B}from"./VStack-CjRg3Zfs.js";import"./index-DASCADcX.js";import{L as D,D as F,a as j}from"./Label-C-_BY61p.js";import{B as be}from"./Button-CiEWTRO4.js";/* empty css              */import"./v4-CtRu48qb.js";import"./Checkbox-sga406yY.js";import"./clsx-B-dksMZM.js";import"./omit-B7stZg_p.js";import"./useId-BiFzyKmP.js";import"./useFormField-BJl8SNDY.js";import"./Fieldset-D02MJfZs.js";import"./Tag-CCjwuauJ.js";import"./Textarea-BJ2JSFef.js";import"./index-CL4jvrHg.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BxWMR1Ay.js";import"./useClientLayoutEffect-Dt_TuINI.js";import"./create-context-Bo0OP0Ib.js";import"./Loader-DokcRViZ.js";import"./Provider-DeC0qy30.js";import"./Select-BQeaFgvO.js";import"./ChevronDown-DKSW_DmS.js";import"./useId-sDoo_C8F.js";import"./Radio-DX13p-wz.js";import"./useDatepicker-UNp_ANWf.js";import"./useDateTranslationContext-CJAj3RHb.js";import"./DatePicker-CtFgYtE3.js";import"./Modal-BsdIhMBu.js";import"./floating-ui.react-C49gkrzP.js";import"./XMark-KAXZPgUH.js";import"./Popover-DD4koGWt.js";import"./Theme-s5aaJqOF.js";import"./Checkmark-abnGd_Ay.js";import"./TextField-y4U1ZNhM.js";import"./Alert-CsAGiB4k.js";import"./ExclamationmarkTriangleFill-BFbmXhrr.js";import"./XMarkOctagonFill-Cj0h8cZo.js";import"./PersonPencilFill-CoF6qBVB.js";import"./Box-BRUAy9sN.js";import"./BasePrimitive-CQFd8qnq.js";import"./KeyVerticalFill-m_CavoP-.js";var K=(t=>(t.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",t))(K||{});const ve="_feilutbetalingTable_1bepb_1",ce="_redText_1bepb_8",V={feilutbetalingTable:ve,redText:ce},q="perioder",he=(t,o)=>{const r=t.find(a=>a.hendelseType===o);return r!=null&&r.hendelseUndertyper&&r.hendelseUndertyper.length>0?r.hendelseUndertyper:void 0},H=({perioder:t,årsaker:o,readOnly:r,behandlePerioderSamlet:a,kodeverkSamlingFpTilbake:s})=>{const{control:u,watch:l,setValue:p,getValues:b}=ge(),{fields:h}=pe({control:u,name:q}),v=(n,m,d)=>{a&&h.forEach((w,i)=>{m!==i&&(d?b(`${q}.${i}.årsak`)===d&&p(`${q}.${i}.${d}.underÅrsak`,n):p(`${q}.${i}.årsak`,n))})};return e.jsx("div",{className:V.feilutbetalingTable,children:e.jsxs(y,{children:[e.jsx(y.Header,{children:e.jsxs(y.Row,{children:[e.jsx(y.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Period"})}),e.jsx(y.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Hendelse"})}),e.jsx(y.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Beløp"})})]})}),e.jsx(y.Body,{children:h.map((n,m)=>{const d=l(`${q}.${m}.årsak`),w=he(o,d);return e.jsxs(y.Row,{children:[e.jsx(y.DataCell,{children:`${P(n.fom).format(E)} - ${P(n.tom).format(E)}`}),e.jsxs(y.DataCell,{children:[e.jsx(U,{name:`${q}.${m}.årsak`,selectValues:o.map(i=>{var f;return e.jsx("option",{value:i.hendelseType,children:(f=s[x.HENDELSE_TYPE].find(A=>A.kode===i.hendelseType))==null?void 0:f.navn},i.hendelseType)}),validate:[_],disabled:r,onChange:i=>v(i.target.value,m),label:""}),w&&e.jsx(U,{name:`${q}.${m}.${d}.underÅrsak`,selectValues:w.map(i=>{var f;return e.jsx("option",{value:i,children:(f=s[x.HENDELSE_UNDERTYPE].find(A=>A.kode===i))==null?void 0:f.navn},i)}),validate:[_],disabled:r,onChange:i=>v(i.target.value,m,d),label:""})]}),e.jsxs(y.DataCell,{className:V.redText,children:[t?t[m].belop:null," "]})]},n.id)})})]})})};H.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingPerioderFieldArray",props:{perioder:{required:!0,tsType:{name:"signature['perioder']",raw:"FeilutbetalingFakta['behandlingFakta']['perioder']"},description:""},årsaker:{required:!0,tsType:{name:"Array",raw:"FeilutbetalingÅrsak['hendelseTyper']"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},behandlePerioderSamlet:{required:!0,tsType:{name:"boolean"},description:""},kodeverkSamlingFpTilbake:{required:!0,tsType:{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
