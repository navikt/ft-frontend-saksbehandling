import{aP as F,aQ as K,d as V,x as B,j as n,r as M,an as d,E as h,aR as j,X as O,Y as f,a8 as w,H as c,B as U,aS as Y,a3 as J,a1 as x,a2 as H}from"./iframe-B1oxwsZ5.js";import{I as z,T as I}from"./index.es-BDctT3QU.js";import{T as i}from"./Table-DFTxr62J.js";import{M as m}from"./message-_dAdiGPZ.js";import{S as C}from"./Spacer-ihXM8nYw.js";var k=(e=>(e.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS="FASTSETT_BG_AT_FL",e.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE="VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN",e.VURDER_VARIG_ENDRET_ARBEIDSSITUASJON="VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV",e.FASTSETT_BRUTTO_BEREGNINGSGRUNNLAG_SELVSTENDIG_NAERINGSDRIVENDE="FASTSETT_BG_SN",e.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD="FASTSETT_BG_TB_ARB",e.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET="FASTSETT_BG_SN_NY_I_ARB_LIVT",e.VURDER_GRADERING_UTEN_BEREGNINGSGRUNNLAG="VURDER_GRADERING_UTEN_BG",e))(k||{});const X=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),Se=new Set(["VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV","VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_SN_NY_I_ARB_LIVT"]),pe=new Set(["FASTSETT_BG_AT_FL","FASTSETT_BG_TB_ARB"]),fe=e=>e.some(r=>$(r)&&r.kanLoses),$=e=>X.has(e.definisjon),T=(...e)=>r=>e.includes(r.definisjon),_e=(e,r)=>(r?.perioder?r.perioder.filter(l=>l.vurderesIBehandlingen&&!l.erForlengelse):[]).some(l=>l.periode.fom===e),Le=e=>e.length>0?e[0].beregningsgrunnlagPrStatusOgAndel??[]:[],Q=e=>e.overstyrtPrAar!==null&&e.overstyrtPrAar!==void 0?!0:e.erTilkommetAndel===!1&&e.lagtTilAvSaksbehandler===!1,W=(e,r)=>{const t=e.perioder.find(({periode:l})=>l.fom===r);if(!t)throw new Error(`Finner ikke vilkårsperiode med fom ${r}`);return t};var P=(e=>(e.OPPFYLT="OPPFYLT",e.IKKE_OPPFYLT="IKKE_OPPFYLT",e.IKKE_VURDERT="IKKE_VURDERT",e))(P||{});const Z={AT:1,FL:2,DP:3,SP_AV_DP:4,PSB_AV_DP:5,AAP:6,KUN_YTELSE:7,MS:8,BA:9,SN:10},ee=260,ne=new Set([I.ARBEIDSFORHOLD_AVSLUTTET,I.NATURALYTELSE_TILKOMMER,I.NATURALYTELSE_BORTFALT]),re=e=>e.besteberegningPrAar||e.besteberegningPrAar===0?e.besteberegningPrAar:e.overstyrtPrAar||e.overstyrtPrAar===0?e.overstyrtPrAar:e.beregnetPrAar??0,ae=(e,r)=>{switch(e){case"AT":case"FL":return r.find(T(k.FASTSETT_BEREGNINGSGRUNNLAG_ARBEIDSTAKER_FRILANS,k.FASTSETT_BEREGNINGSGRUNNLAG_TIDSBEGRENSET_ARBEIDSFORHOLD));case"SN":return r.find(T(k.FASTSETT_BEREGNINGSGRUNNLAG_SN_NY_I_ARBEIDSLIVET,k.VURDER_VARIG_ENDRET_ELLER_NYOPPSTARTET_NAERING_SELVSTENDIG_NAERINGSDRIVENDE));case"BA":return r.find(T(k.VURDER_VARIG_ENDRET_ARBEIDSSITUASJON));default:return}},te=({arbeidsforhold:e})=>{const r=e?.naturalytelseBortfaltPrÅr,t=e?.naturalytelseTilkommetPrÅr||0;return r?r-t:0},le=({beregnetPrAar:e,pgiSnitt:r})=>{const t=e!=null,l=r!=null;return t||l},ie=(e,r)=>{const t=e.filter(Q);return Map.groupBy(t,a=>a.aktivitetStatus).entries().map(([a,u])=>{const N=ae(a,r),o=u.every(le),g=u.reduce((s,A)=>re(A)+s,0),v=u.reduce((s,A)=>te(A)+s,0),R=(g||0)+(v||0),E=o&&!K(N);return{inntekt:g,bortfaltNaturalytelse:v,inntektPlussNaturalytelse:R,erFerdigBeregnet:E,aktivitetStatus:a}}).toArray().sort(me)},se=e=>e.some(r=>ne.has(r)),ue=e=>e?V(e.beregningsgrunnlagPeriodeFom).subtract(1,"day").format(B):void 0,oe=({avklaringsbehov:e,skjaeringstidspunktBeregning:r,beregningsgrunnlagPeriode:t,grunnbeløp:l,dekningsgrad:a,ytelsesspesifiktGrunnlag:u})=>{const N=a!==100;return t.filter(o=>o.beregningsgrunnlagPeriodeFom===r||se(o.periodeAarsaker??[])).sort(F("beregningsgrunnlagPeriodeFom")).map((o,g,v)=>{const{beregningsgrunnlagPeriodeFom:R,beregningsgrunnlagPrStatusOgAndel:E,bruttoInkludertBortfaltNaturalytelsePrAar:s,redusertPrAar:A,avkortetPrAar:S}=o,b=ie(E||[],e),p=de(b,l),y=b.every(q=>q.erFerdigBeregnet);return{harBruttoOver6G:p,fom:R,tom:ue(v[g+1]),andeler:b,redusertMed:y&&A?-(A/.8)*.2:void 0,avkortetMed:y&&s&&S?-s+S:void 0,totalInntektEtterAvkortningOgReduksjon:y?Ee(o,b,p,N):void 0,dagsats:y?ve(o,u):void 0}})},_=e=>Z[e.aktivitetStatus]||100,me=(e,r)=>_(e)-_(r),de=(e,r)=>G(e)>r*6,ge=e=>!!e&&e.includes("MIDL_INAKTIV"),G=e=>e.reduce((r,t)=>(t.inntektPlussNaturalytelse||0)+r,0),Ee=({avkortetPrAar:e,redusertPrAar:r},t,l,a)=>a&&r?r:l&&e?e:G(t),ve=({avkortetPrAar:e,dagsats:r},t)=>t?.ytelsetype!==z.FORELDREPENGER&&e?Math.round(e/ee):r||0,Ae="_table_1nfdc_1",ke="_periodeLabel_1nfdc_14",L={table:Ae,periodeLabel:ke},D=({beregningsgrunnlag:{grunnbeløp:e,dekningsgrad:r,aktivitetStatus:t=[]},vilkarStatus:l,tabellPeriode:a,skalVisePeriode:u,kodeverkSamling:N})=>{const o=r!==100,g=l===P.OPPFYLT,v=l===P.IKKE_OPPFYLT,R=o?"redusert":a.harBruttoOver6G?"avkortet":void 0,E=a.andeler.map(s=>n.jsxs(M.Fragment,{children:[n.jsxs(i.Row,{children:[n.jsx(i.DataCell,{textSize:"small",children:Ne(s.aktivitetStatus,N)}),n.jsx(i.DataCell,{textSize:"small",align:"right",children:s.erFerdigBeregnet?n.jsx(d,{beløp:s.inntekt,kr:!0}):n.jsx(h,{size:"small",children:n.jsx(j,{children:n.jsx(m,{id:"Dagsats.IkkeBeregnet"})})})})]}),!!s.bortfaltNaturalytelse&&n.jsxs(i.Row,{children:[n.jsx(i.DataCell,{textSize:"small",children:n.jsx(m,{id:"Dagsats.Naturalytelser"})}),n.jsx(i.DataCell,{textSize:"small",align:"right",children:n.jsx(d,{beløp:s.bortfaltNaturalytelse,kr:!0})})]})]},`andel_${s.aktivitetStatus}`));return g&&a.avkortetMed&&E.push(n.jsxs(i.Row,{children:[n.jsx(i.DataCell,{textSize:"small",children:n.jsx(m,{id:"Dagsats.AvkortetOver6G",values:{grunnbeløp:n.jsx(d,{beløp:e*6,kr:!0})}})}),n.jsx(i.DataCell,{textSize:"small",align:"right",children:n.jsx(d,{beløp:a.avkortetMed,kr:!0})})]})),g&&a.redusertMed&&E.push(n.jsxs(i.Row,{children:[n.jsx(i.DataCell,{textSize:"small",children:n.jsx(m,{id:"Dagsats.Redusert"})}),n.jsx(i.DataCell,{textSize:"small",align:"right",children:n.jsx(d,{beløp:a.redusertMed,kr:!0})})]})),n.jsxs(O,{gap:"space-8",children:[u&&n.jsx(f,{size:"small",className:L.periodeLabel,children:n.jsx(m,{id:"Dagsats.Periode",values:{periode:w(a.fom,a.tom)}})}),n.jsxs(i,{size:"small",className:L.table,children:[n.jsx(i.Body,{children:E}),!!a.totalInntektEtterAvkortningOgReduksjon&&E.length>1&&n.jsx("tfoot",{children:n.jsxs(i.Row,{children:[n.jsx(i.HeaderCell,{textSize:"small",children:n.jsx(m,{id:"Dagsats.TotalÅrsinntekt",values:{type:R}})}),n.jsx(i.HeaderCell,{textSize:"small",align:"right",children:n.jsx(d,{beløp:a.totalInntektEtterAvkortningOgReduksjon,kr:!0})})]})})]}),g&&a.dagsats&&n.jsxs(c,{"data-row-type":"summary",paddingInline:"space-8",children:[n.jsx(U,{size:"small",children:n.jsx(m,{id:"Dagsats.BeregnetDagsats",values:{b:Y,inntekt:n.jsx(d,{beløp:a.totalInntektEtterAvkortningOgReduksjon,kr:!0})}})}),n.jsx(C,{}),n.jsx(f,{size:"small",children:n.jsx(d,{beløp:a.dagsats,kr:!0})})]}),v&&n.jsx(J,{variant:"error",size:"small",inline:!0,children:n.jsx(m,{id:ge(t)?"Dagsats.VilkårIkkeOppfyltMidlertidigInaktiv":"Dagsats.VilkårIkkeOppfylt",values:{grunnbeløp:n.jsx(d,{beløp:e,kr:!0})}})})]})},Ne=(e,r)=>{const t=r.AktivitetStatus.find(l=>l.kode===e)?.navn??e;return n.jsx(m,{id:"Dagsats.FastsattÅrsinntekt",values:{aktivitetStatus:t}})};D.__docgenInfo={description:"",methods:[],displayName:"Dagsats",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const Re=({beregningsgrunnlag:e,beregningsgrunnlagsvilkår:r,kodeverkSamling:t})=>{const l=W(r,e.vilkårsperiodeFom),a=oe(e);return n.jsxs(x.New,{background:"neutral-soft",padding:"5",flexBasis:"0%",flexGrow:"1",children:[n.jsx(H,{size:"small",level:"4",children:n.jsx(m,{id:"Dagsats.Tittel"})}),a.map(u=>n.jsx(D,{beregningsgrunnlag:e,vilkarStatus:l.vilkarStatus,tabellPeriode:u,skalVisePeriode:a.length>1,kodeverkSamling:t},u.fom))]})};Re.__docgenInfo={description:"",methods:[],displayName:"Dagsatser",props:{beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};export{k as A,Re as D,P as V,Q as a,pe as b,$ as c,_e as e,Le as f,fe as h,T as m,Se as Å};
