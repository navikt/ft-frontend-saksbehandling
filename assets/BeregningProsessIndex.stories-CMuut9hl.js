import{j as n,a0 as A,W as m,a1 as R,r as b,aL as N,O as y,a3 as P,d,P as I,i as f}from"./iframe-Djwm1jj-.js";import{a as p}from"./alleKodeverk-BqlsAwOV.js";import{M as u}from"./message-B6EghVSt.js";/* empty css              */import"./preload-helper-PPVm8Dsz.js";const g=r=>({avklaringsbehov:[],skjaeringstidspunktBeregning:"2025-01-01",vilkårsperiodeFom:"2025-01-01",beregningsgrunnlagPeriode:[],dekningsgrad:80,grunnbeløp:99858,faktaOmBeregning:{andelerForFaktaOmBeregning:[],saksopplysninger:{lønnsendringSaksopplysning:[],kortvarigeArbeidsforhold:[]}},erOverstyrtInntekt:!1,...r}),v=({skjæringstidspunktVelger:r})=>n.jsx(A.New,{background:"neutral-soft",padding:"5",children:n.jsxs(m,{gap:"space-8",children:[n.jsx(R,{size:"large",level:"2",children:n.jsx(u,{id:"BeregningsgrunnlagFakta.Tittel"})}),r]})});v.__docgenInfo={description:"",methods:[],displayName:"GrunnlagForBeregning",props:{skjæringstidspunktVelger:{required:!0,tsType:{name:"ReactNode"},description:""},beregningsgrunnlag:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const T=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),S=r=>r.some(a=>T.has(a.definisjon)&&a.kanLoses),G=(r,a)=>{const e=r.vilkårsperiodeFom;return(a?.perioder?a.perioder.filter(i=>i.vurderesIBehandlingen&&!i.erForlengelse):[]).some(i=>i.periode.fom===e)},_=(r,a)=>{const e=L(r,a),t=e.find(l=>l.skalVurderes&&l.harAvklaringsbehov)?.bgIndex??0,[i,o]=b.useState(t),k=l=>{o(Number(l.target.value))};return{aktivtBeregningsgrunnlag:r[i],skjæringstidspunktVelger:e.length===0?n.jsx(N,{size:"small",label:n.jsx(u,{id:"SkjæringstidspunktVelger.Label"}),value:e[0].optionLabel}):n.jsx(y,{label:n.jsx(u,{id:"SkjæringstidspunktVelger.Label"}),onChange:k,children:e.map(l=>n.jsxs("option",{value:l.bgIndex,children:[l.harAvklaringsbehov&&n.jsx(n.Fragment,{children:"⚠️"})," ",l.optionLabel]},l.bgIndex))})}},L=(r,a)=>r.map((e,t)=>({bgIndex:t,skalVurderes:G(e,a),harAvklaringsbehov:S(e.avklaringsbehov),skjæringstidspunkt:e.skjaeringstidspunktBeregning,optionLabel:n.jsx(u,{id:"SkjæringstidspunktVelger.ValueLabel",values:{dato:P(e.skjaeringstidspunktBeregning)}})})).sort((e,t)=>d(e.skjæringstidspunkt).diff(d(t.skjæringstidspunkt))),q={"BeregningsgrunnlagFakta.Tittel":"Grunnlag for beregning","SkjæringstidspunktVelger.Label":"Skjæringsgrunnlag","SkjæringstidspunktVelger.ValueLabel":"Skjæringstidspunkt for beregning {dato}"},D=f(q),E=({beregningsgrunnlagListe:r,beregningsgrunnlagsvilkår:a,kodeverkSamling:e,arbeidsgiverOpplysningerPerId:t})=>{const{aktivtBeregningsgrunnlag:i,skjæringstidspunktVelger:o}=_(r,a);return n.jsx(I,{value:D,children:n.jsx(m,{gap:"space-8",children:n.jsx(v,{beregningsgrunnlag:i,beregningsgrunnlagsvilkår:a,kodeverkSamling:e,arbeidsgiverOpplysningerPerId:t,skjæringstidspunktVelger:o})})})};E.__docgenInfo={description:"",methods:[],displayName:"BeregningProsessIndex",props:{beregningsgrunnlagListe:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const F={999999998:{identifikator:"999999998",navn:"Gardslien transport og Gardiner AS",erPrivatPerson:!1}},j={component:E,args:{kodeverkSamling:p,arbeidsgiverOpplysningerPerId:F,beregningsgrunnlagsvilkår:null}},s={args:{beregningsgrunnlagListe:[g({skjaeringstidspunktBeregning:"2023-02-01"}),g({skjaeringstidspunktBeregning:"2024-02-01"})]}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    beregningsgrunnlagListe: [lagBG({
      skjaeringstidspunktBeregning: '2023-02-01'
    }), lagBG({
      skjaeringstidspunktBeregning: '2024-02-01'
    })]
  }
}`,...s.parameters?.docs?.source}}};const O=["VisningAvFaktaUtenAksjonspunkt"];export{s as VisningAvFaktaUtenAksjonspunkt,O as __namedExportsOrder,j as default};
