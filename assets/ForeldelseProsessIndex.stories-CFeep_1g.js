import{F as f,_ as Fe}from"./index.es-DELgJj0W.js";import{i as H,an as oe,j as e,aH as le,V as R,aL as we,H as A,a_ as he,L as Re,a$ as Y,d as y,A as P,Q as K,X as de,N as ne,B as _,b as U,Y as xe,x as Se,r as h,b0 as ue,b1 as me,G as Ae,b2 as Ee,ar as Me,I as Oe,b3 as Ve,aJ as Be,aG as Ie,W as Ne,aY as _e,aM as Ue,aZ as Le,P as Ke,n as Ce}from"./iframe-CcPU-1-g.js";import{t as N,a as Ge,o as ze,N as $e,O as Q,F as He,J as Ze,R as We}from"./style-BiWYtjjm.js";import{M as g}from"./message-CHIxPOGW.js";import{S as ee,T as X,a as Xe,b as Je,c as Ye,d as Qe,e as er}from"./Timeline-Cb_5lepx.js";import{S as rr}from"./Scissors-YbkACw_2.js";import{a as nr,S as tr}from"./SilhouetteFill-CnPWtCVp.js";import"./preload-helper-PPVm8Dsz.js";var Z=(r=>(r.VURDER_FORELDELSE="5003",r))(Z||{});const ir=Ge(3),ar=ze(1500),sr=r=>r!==f.UDEFINERT?r:void 0,or=r=>r.foreldet?r.foreldet:sr(r.foreldelseVurderingType),lr=r=>({...r,foreldet:or(r)}),ge=({skjulPeriode:r,readOnly:n,periode:t,oppdaterPeriode:d,kodeverkSamlingFpTilbake:b})=>{const p=H(),i=oe({defaultValues:lr(t)}),k=i.watch("foreldet"),c=k&&k===f.FORELDET,T=k&&k===f.TILLEGGSFRIST,u=b.ForeldelseVurderingType.filter(s=>s.kode!==f.IKKE_VURDERT&&s.kode!==f.UDEFINERT);return e.jsx(le,{formMethods:i,onSubmit:s=>d(s),children:e.jsxs(R,{gap:"space-16",children:[e.jsx(we,{name:"begrunnelse",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[N,ir,ar,$e],maxLength:1500,readOnly:n}),e.jsxs(A,{gap:"space-40",children:[e.jsx(he,{name:"foreldet",control:i.control,legend:e.jsx(g,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[N],readOnly:n,children:u.map(s=>e.jsx(Re,{value:s.kode,size:"small",children:s.navn},s.kode))}),e.jsxs(R,{gap:"space-20",children:[(c||T)&&e.jsx(Y,{name:"foreldelsesfrist",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[N,Q],readOnly:n}),T&&e.jsx(Y,{name:"oppdagelsesDato",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[N,Q,He],readOnly:n,fromDate:y("1970-01-01").toDate(),toDate:y().toDate()})]})]}),e.jsxs(A,{gap:"space-16",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!i.formState.isDirty||i.formState.isSubmitting||n,loading:i.formState.isSubmitting,children:e.jsx(g,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(g,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ge.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}}]}},name:"perioder"}],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const pr="_margin_1dkor_37",J={margin:pr},yr=!1,ye=({valgtPeriode:r,beregnBelop:n,behandlingUuid:t,oppdaterSplittedePerioder:d,setNestePeriode:b,setForrigePeriode:p,readOnly:i,lukkPeriode:k})=>{const c=H(),[T,u]=h.useState(!1),[s,v]=h.useState(!1),o=D=>{u(!0),D.preventDefault()},x=()=>{u(!1)},a=D=>{v(!1);const S={belop:r.feilutbetaling,fom:D.forstePeriode.fom,tom:D.forstePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "},m={belop:r.feilutbetaling,fom:D.andrePeriode.fom,tom:D.andrePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "};n({behandlingUuid:t,perioder:[S,m]}).then(E=>{const{perioder:F}=E;if(F.some(B=>B.belop===0))v(!0);else{const B={fom:S.fom,tom:S.tom,feilutbetaling:F[0].belop},M={fom:m.fom,tom:m.tom,feilutbetaling:F[1].belop};x(),d([B,M])}})};return e.jsxs(A,{children:[e.jsxs(ne,{size:"small",children:[e.jsx(g,{id:"PeriodeController.Detaljer"}),yr]}),!i&&e.jsxs(e.Fragment,{children:[e.jsx(ee,{}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(rr,{"aria-hidden":!0}),onClick:o,variant:"tertiary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.DelOppPerioden"}),children:e.jsx(g,{id:"PeriodeController.DelOppPerioden"})})]}),T&&e.jsx(pe,{cancelEvent:x,showModal:T,periodeData:r,splitPeriod:a,finnesBelopMed0Verdi:s}),e.jsx(ee,{}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(ue,{"aria-hidden":!0}),onClick:p,variant:"secondary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.prevPeriod"}),children:e.jsx(g,{id:"PeriodeController.prevPeriodShort"})}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(me,{"aria-hidden":!0}),onClick:b,variant:"secondary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.nextPeriod"}),iconPosition:"right",children:e.jsx(g,{id:"PeriodeController.nextPeriodShort"})}),e.jsx(P,{size:"xsmall",icon:e.jsx(Ae,{"aria-hidden":!0}),onClick:k,variant:"tertiary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.LukkPeriode"})})]})};ye.__docgenInfo={description:"",methods:[],displayName:"PeriodeController",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},beregnBelop:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BeregnBeløpParams) => Promise<BeregnBeløpResultat>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  navn: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const se=(r,n)=>y(r.fom).diff(y(n.fom)),Dr=()=>y().subtract(30,"months").format(U),Fr=r=>r?[e.jsx(g,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Dr()}},"vurderForeldelse")]:[],re=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===f.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),wr=(r=[])=>r.map((n,t)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:re(n),isGodkjent:f.FORELDET!==n.foreldet&&f.UDEFINERT!==n.foreldet,id:t})),hr=r=>({foreldelsePerioder:r.map(t=>({fraDato:t.fom,tilDato:t.tom,begrunnelse:t.begrunnelse,foreldelseVurderingType:t.foreldet,foreldelsesfrist:t.foreldelsesfrist,oppdagelsesDato:t.oppdagelsesDato})),kode:Z.VURDER_FORELDELSE}),Rr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,xr=r=>[...r].sort(Rr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===f.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:Ue(n.begrunnelse)})),be=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t,aksjonspunkt:d,alleMerknaderFraBeslutter:b,perioderForeldelse:p,readOnly:i,kodeverkSamlingFpTilbake:k,beregnBelop:c,behandlingUuid:T,formData:u,setFormData:s})=>{const v=xr(p.perioder),[o,x]=h.useState(u||v),[a,D]=h.useState(o?.find(re)),[S,m]=h.useState(!1),[V,E]=h.useState(!!u),F=l=>{const j=l?o.find(q=>q.fom===l.fom&&q.tom===l.tom):void 0;D(j)},te=()=>{const l=o.findIndex(q=>q.fom===a?.fom&&q.tom===a?.tom),j=l===o.length-1?l:l+1;F(o[j])},B=()=>{const l=o.findIndex(q=>q.fom===a?.fom&&q.tom===a?.tom),j=l===0?l:l-1;F(o[j])},M=()=>{F(void 0)},ve=l=>{const j=Le(l,"erSplittet"),L=o.filter(w=>w.fom!==j.fom&&w.tom!==j.tom).concat(j).sort(se);x(L),s(L),E(!0),M();const I=L.find(re);I&&F(I)},Te=l=>{const j=o.find(w=>w.fom===a?.fom&&w.tom===a?.tom);if(j===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${a?.fom} Tom: ${a?.tom}`);const q=l.map(w=>({...j,...w,erSplittet:!0})),I=o.filter(w=>w.fom!==a?.fom&&w.tom!==a?.tom).concat(q).sort(se);x(I),s(I),E(!0),M(),F(q[0])},je=()=>{m(!0),r(hr(o))},qe=b[Z.VURDER_FORELDELSE],W=wr(o),Pe=Ve(d),De=W.every(l=>!l.isAksjonspunktOpen),ie=a?W.find(l=>l.fom===a.fom&&l.tom===a.tom):void 0;return e.jsx(Be,{merknaderFraBeslutter:qe,withoutBorder:!0,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(de,{size:"small",level:"2",children:e.jsx(g,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),o&&d&&e.jsxs(R,{gap:"space-16",children:[Pe&&e.jsx(Ie,{children:Fr(d)}),e.jsx(ke,{perioder:W,valgtPeriode:ie,setPeriode:F,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t}),a&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":ie?.id.toString(),children:e.jsx(Ne.New,{borderWidth:"1",padding:"4",children:e.jsxs(R,{gap:"space-16",children:[e.jsx(ye,{setNestePeriode:te,setForrigePeriode:B,valgtPeriode:a,readOnly:i,oppdaterSplittedePerioder:Te,behandlingUuid:T,beregnBelop:c,lukkPeriode:M}),e.jsx(fe,{feilutbetaling:a.feilutbetaling,fom:a.fom,tom:a.tom}),e.jsx(ge,{periode:a,oppdaterPeriode:ve,skjulPeriode:M,readOnly:i,kodeverkSamlingFpTilbake:k},a.fom)]})})}),e.jsx(A,{children:e.jsx(_e,{isReadOnly:i,isDirty:V,isSubmittable:!a&&De,onClick:je,isSubmitting:S})})]})]})})};be.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
  ...
  kode: T;
  navn: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const{action:Er}=__STORYBOOK_MODULE_ACTIONS__,Mr={perioder:[{fom:"2019-01-01",tom:"2019-01-31",belop:1e3,begrunnelse:"Foreldet",foreldelseVurderingType:f.FORELDET,foreldelsesfrist:"2020-04-01"},{fom:"2019-03-01",tom:"2019-03-31",belop:3e3,foreldelseVurderingType:f.UDEFINERT},{fom:"2019-02-01",tom:"2019-02-28",belop:3e3,begrunnelse:"Over foreldelsesfrist, med tillegsfrist brukes",foreldelseVurderingType:f.TILLEGGSFRIST,foreldelsesfrist:"2020-04-01",oppdagelsesDato:"2019-11-01"},{fom:"2019-04-01",tom:"2019-04-30",belop:4e3,foreldelseVurderingType:f.UDEFINERT}]},Or={ForeldelseVurderingType:[{kode:f.FORELDET,navn:"Foreldet"},{kode:f.TILLEGGSFRIST,navn:"Ikke foreldet, med tilleggsfrist"},{kode:f.IKKE_FORELDET,navn:"Ikke foreldet"}]},Cr={component:ce,args:{submitCallback:Er("submit"),behandlingUuid:"1",kodeverkSamlingFpTilbake:Or,isReadOnly:!1,setFormData:()=>{},perioderForeldelse:Mr,relasjonsRolleType:O.MOR,beregnBelop:()=>Promise.resolve({perioder:[{belop:1e4},{belop:12e3}]}),alleMerknaderFraBeslutter:{},relasjonsRolleTypeKodeverk:[{kode:O.MOR,navn:"Mor"}]}},z={args:{aksjonspunkter:[{definisjon:Z.VURDER_FORELDELSE,status:Fe.OPPRETTET,begrunnelse:void 0,kanLoses:!0}]}},$={args:{aksjonspunkter:[]}};z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: [{
