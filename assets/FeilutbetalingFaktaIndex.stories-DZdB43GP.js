import{a as z}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{Y as U,N as X,y as W,D as J}from"./index.es-Cl5LGJKI.js";import{a as Q}from"./alleKodeverk-LoqTPBoT.js";import{a as Z}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as R,I as j,r as ee,a as ne,y as re,z as L,u as te,$ as N,W as ae,X as ie}from"./style-BOw45aH0.js";import{u as se,j as le,K as oe,b as de,r as ue}from"./index.es-CfR2N-CV.js";import{u as ge,c as pe,b as me}from"./index.esm-CkkEN1rj.js";import{n as M,m as B,J as ke,s as ye,X as be}from"./index.es-aqSZ_kXa.js";import{T as b}from"./Table-CAbNZsjR.js";import{M as u}from"./message-DsiJ2xI1.js";import{E as O,L as D,D as T,a as q}from"./Label-CYbek38p.js";import{V as k,H as I}from"./VStack-xkjQwvKn.js";import"./index-DNHX5htx.js";import"./Theme-C_brBVJK.js";import{B as ve}from"./Button-Cc809GDC.js";/* empty css              */import"./v4-CtRu48qb.js";import"./dayjs.min-Cke173X9.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Checkbox-BaSR81FM.js";import"./omit-B7stZg_p.js";import"./useId-CsAOvYkp.js";import"./ReadOnlyIcon-BUzfiMc5.js";import"./Loader-42dkOmtz.js";import"./Provider-BZs7ODlm.js";import"./useId-SP_zdaIa.js";import"./useFormField-Bu2NUIkp.js";import"./Fieldset-B4jGbpi0.js";import"./Tag-ntoonGP8.js";import"./Textarea-BjE6whUD.js";import"./index-DU09BupE.js";import"./index-7Fg4giie.js";import"./useClientLayoutEffect-pkze6c0k.js";import"./Select-CvyZY3UD.js";import"./ChevronDown-6T9JsqER.js";import"./Radio-Pmn7OwXu.js";import"./useDatepicker-CuBmBNa3.js";import"./Date.Input-D651xWgA.js";import"./DatePicker-hprz5Yye.js";import"./useControllableState-CEDyyUuG.js";import"./Modal-DdoS0OAm.js";import"./floating-ui.react-D9M9yXN8.js";import"./XMark-6H9iuGiv.js";import"./Popover-uyW-ft96.js";import"./TextField-DY81zaLa.js";import"./Alert-Ja4tf6sE.js";import"./ExclamationmarkTriangleFill-DrBUO71d.js";import"./XMarkOctagonFill-Dr7RQDrl.js";import"./PersonPencilFill-DqunLdn1.js";import"./Box-C3b4VC_S.js";import"./BasePrimitive-gBgyIEwX.js";import"./KeyVerticalFill-DmgzHF4Z.js";var K=(r=>(r.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",r))(K||{});const A="perioder",he=(r,g)=>{const t=r.find(a=>a.hendelseType===g);return t!=null&&t.hendelseUndertyper&&t.hendelseUndertyper.length>0?t.hendelseUndertyper:void 0},Y=({perioder:r,årsaker:g,readOnly:t,behandlePerioderSamlet:a,kodeverkSamlingFpTilbake:s})=>{const{control:d,watch:l,setValue:p,getValues:v}=ge(),{fields:c}=pe({control:d,name:A}),h=(n,m,o)=>{a&&c.forEach((x,i)=>{m!==i&&(o?v(`${A}.${i}.årsak`)===o&&p(`${A}.${i}.${o}.underÅrsak`,n):p(`${A}.${i}.årsak`,n))})};return e.jsxs(b,{children:[e.jsx(b.Header,{children:e.jsxs(b.Row,{children:[e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Period"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Hendelse"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Beløp"})})]})}),e.jsx(b.Body,{children:c.map((n,m)=>{const o=l(`${A}.${m}.årsak`),x=he(g,o);return e.jsxs(b.Row,{children:[e.jsx(b.DataCell,{children:e.jsx(M,{dateStringFom:n.fom,dateStringTom:n.tom})}),e.jsxs(b.DataCell,{children:[e.jsx(U,{name:`${A}.${m}.årsak`,selectValues:g.map(i=>{var f;return e.jsx("option",{value:i.hendelseType,children:(f=s[j.HENDELSE_TYPE].find(P=>P.kode===i.hendelseType))==null?void 0:f.navn},i.hendelseType)}),validate:[R],disabled:t,onChange:i=>h(i.target.value,m),label:""}),x&&e.jsx(U,{name:`${A}.${m}.${o}.underÅrsak`,selectValues:x.map(i=>{var f;return e.jsx("option",{value:i,children:(f=s[j.HENDELSE_UNDERTYPE].find(P=>P.kode===i))==null?void 0:f.navn},i)}),validate:[R],disabled:t,onChange:i=>h(i.target.value,m,o),label:""})]}),e.jsx(b.DataCell,{align:"right",children:e.jsx(O,{children:r?e.jsx(B,{beløp:r[m].belop}):null})})]},n.id)})})]})};Y.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingPerioderFieldArray",props:{perioder:{required:!0,tsType:{name:"signature['perioder']",raw:"FeilutbetalingFakta['behandlingFakta']['perioder']"},description:""},årsaker:{required:!0,tsType:{name:"Array",raw:"FeilutbetalingÅrsak['hendelseTyper']"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},behandlePerioderSamlet:{required:!0,tsType:{name:"boolean"},description:""},kodeverkSamlingFpTilbake:{required:!0,tsType:{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<KodeverkType, KodeverkMedNavn[]>"},description:""}}};const ce="_textarea_1pt2d_1",fe={textarea:ce},Fe=ee(3),H=4e3,Te=ne(H),$=r=>r.behandlingFakta.perioder?[...r.behandlingFakta.perioder].sort(oe):[],je=r=>{const{behandlingFakta:{begrunnelse:g}}=r;return{begrunnelse:le(g),perioder:$(r).map(t=>{const{fom:a,tom:s,feilutbetalingÅrsakDto:d}=t,l={fom:a,tom:s};if(!d)return l;const{hendelseType:p,hendelseUndertype:v}=d;return{...l,årsak:p,[p]:{underÅrsak:v||null}}})}},qe=(r,g)=>{const t=r.perioder.map(a=>{const s=g.find(l=>l.hendelseType===a.årsak),d=s!=null&&s.hendelseUndertyper?s.hendelseUndertyper.find(l=>{var p;return l===((p=a[a.årsak])==null?void 0:p.underÅrsak)}):void 0;return{fom:a.fom,tom:a.tom,årsak:{hendelseType:s==null?void 0:s.hendelseType,hendelseUndertype:d}}});return{kode:K.AVKLAR_FAKTA_FOR_FEILUTBETALING,begrunnelse:r.begrunnelse,feilutbetalingFakta:t}},Ae=(r,g)=>{const{hendelseTyper:t}=r;return t.sort((a,s)=>{var n,m;const d=((n=g[j.HENDELSE_TYPE].find(o=>o.kode===a.hendelseType))==null?void 0:n.navn)||"",l=((m=g[j.HENDELSE_TYPE].find(o=>o.kode===s.hendelseType))==null?void 0:m.navn)||"",p=d.startsWith("§"),v=l.startsWith("§"),c=p?d.replace(/\D/g,""):d,h=v?l.replace(/\D/g,""):l;return p&&v?c-h:c.localeCompare(h)})},G=({hasOpenAksjonspunkter:r,feilutbetalingAarsak:g,feilutbetalingFakta:t,readOnly:a,alleMerknaderFraBeslutter:s,kodeverkSamlingFpTilbake:d,kodeverkSamlingFpsak:l,formData:p,setFormData:v,submitCallback:c})=>{var f,P;const h=se(),n=t.behandlingFakta,m=je(t),o=me({defaultValues:p||m}),x=o.watch("behandlePerioderSamlet")||!1,i=Ae(g,d);return e.jsxs(k,{gap:"4",children:[r&&e.jsx(ke,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Aksjonspunkt"})}),e.jsx(X,{formMethods:o,onSubmit:F=>c(qe(F,i)),setDataOnUnmount:v,children:e.jsxs(k,{gap:"4",children:[e.jsxs(I,{gap:"10",wrap:!0,children:[e.jsxs(k,{gap:"4",children:[e.jsx(D,{size:"small",children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Feilutbetaling"})}),e.jsxs(I,{justify:"space-between",children:[e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.PeriodeMedFeilutbetaling"})}),e.jsx(q,{size:"small",children:e.jsx(M,{dateStringFom:n.totalPeriodeFom,dateStringTom:n.totalPeriodeTom})})]}),e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.FeilutbetaltBeløp"})}),e.jsx(O,{size:"small",children:e.jsx(B,{beløp:n.aktuellFeilUtbetaltBeløp})})]}),e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.TidligereVarseltBeløp"})}),e.jsx(q,{size:"small",children:n.tidligereVarseltBeløp?e.jsx(B,{beløp:n.tidligereVarseltBeløp}):e.jsx(u,{id:"FeilutbetalingInfoPanel.IkkeVarslet"})})]})]}),e.jsx(W,{name:"behandlePerioderSamlet",label:h.formatMessage({id:"FeilutbetalingInfoPanel.BehandlePerioderSamlet"}),readOnly:a}),e.jsx(ye,{merknaderFraBeslutter:s[K.AVKLAR_FAKTA_FOR_FEILUTBETALING],withoutBorder:!0,children:e.jsx(Y,{perioder:$(t),behandlePerioderSamlet:x,årsaker:i,readOnly:a,kodeverkSamlingFpTilbake:d})})]}),e.jsxs(k,{gap:"4",children:[e.jsx(D,{size:"small",children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Revurdering"})}),e.jsxs(I,{gap:"4",children:[e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Årsaker"})}),n.behandlingÅrsaker&&e.jsx(q,{size:"small",children:n.behandlingÅrsaker.map(F=>{var y;return(y=l[j.BEHANDLING_AARSAK].find(w=>w.kode===F.behandlingArsakType))==null?void 0:y.navn}).join(", ")})]}),n.datoForRevurderingsvedtak&&e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.DatoForRevurdering"})}),e.jsx(q,{size:"small",children:e.jsx(be,{dateString:n.datoForRevurderingsvedtak})})]})]}),e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Resultat"})}),n.behandlingsresultat&&e.jsx(q,{size:"small",children:(f=l[j.BEHANDLING_AARSAK].find(F=>{var y;return F.kode===((y=n.behandlingsresultat)==null?void 0:y.type)}))==null?void 0:f.navn})]}),e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Konsekvens"})}),n.behandlingsresultat&&e.jsx(q,{size:"small",children:n.behandlingsresultat.konsekvenserForYtelsen.map(F=>{var y;return(y=l[j.KONSEKVENS_FOR_YTELSEN].find(w=>w.kode===F))==null?void 0:y.navn}).join(", ")})]}),e.jsxs(k,{gap:"1",children:[e.jsx(T,{children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Tilbakekrevingsvalg"})}),n.tilbakekrevingValg&&e.jsx(q,{size:"small",children:(P=d[j.TILBAKEKR_VIDERE_BEH].find(F=>{var y;return F.kode===((y=n.tilbakekrevingValg)==null?void 0:y.videreBehandling)}))==null?void 0:P.navn})]})]})]}),e.jsx("div",{className:fe.textarea,children:e.jsx(J,{name:"begrunnelse",label:h.formatMessage({id:"FeilutbetalingInfoPanel.Begrunnelse"}),validate:[R,Fe,Te,re],maxLength:H,readOnly:a})}),e.jsx("div",{children:e.jsx(ve,{variant:"primary",size:"small",disabled:a||!o.formState.isDirty||o.formState.isSubmitting,loading:o.formState.isSubmitting,children:e.jsx(u,{id:"FeilutbetalingInfoPanel.Confirm"})})})]})})]})};G.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingInfoPanel",props:{feilutbetalingFakta:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  behandlingFakta: {
    perioder?: {
      fom: string;
      tom: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<KodeverkType, KodeverkMedNavn[]>"},description:""},isAksjonspunktOpen:{required:!0,tsType:{name:"boolean"},description:""},alleMerknaderFraBeslutter:{required:!0,tsType:{name:"signature",type:"object",raw:"{ [key: string]: { notAccepted?: boolean } }",signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:"{ notAccepted?: boolean }",signature:{properties:[{key:"notAccepted",value:{name:"boolean",required:!1}}]},required:!0}}]}},description:""}}};const Ee={behandlingFakta:{perioder:[{fom:"2018-01-01",tom:"2018-01-31",belop:1e3},{fom:"2018-02-01",tom:"2018-02-28",belop:5e3},{fom:"2018-03-01",tom:"2018-03-15",belop:100}],totalPeriodeFom:"2019-01-01",totalPeriodeTom:"2019-01-02",aktuellFeilUtbetaltBeløp:1e4,tidligereVarseltBeløp:5e3,behandlingÅrsaker:[{behandlingArsakType:ie.FEIL_I_LOVANDVENDELSE}],behandlingsresultat:{type:ae.INNVILGET,konsekvenserForYtelsen:[N.FORELDREPENGER_OPPHØRER,N.ENDRING_I_BEREGNING]},tilbakekrevingValg:{videreBehandling:te.TILBAKEKR_INNTREKK},datoForRevurderingsvedtak:"2019-01-01"}},we=[{ytelseType:L.FORELDREPENGER,hendelseTyper:[{hendelseType:"MEDLEMSKAP",hendelseUndertyper:[]},{hendelseType:"OKONOMI_FEIL",hendelseUndertyper:["OKONOMI_FEIL_TREKK"]},{hendelseType:"BEREGNING_TYPE",hendelseUndertyper:["IKKE_BOSATT"]}]}],Ie=Z,Re=Q,Bn={component:C,args:{submitCallback:z("button-click"),isReadOnly:!1,setFormData:()=>{},feilutbetalingFakta:Ee,feilutbetalingAarsak:we,kodeverkSamlingFpsak:Re,kodeverkSamlingFpTilbake:Ie,fagsakYtelseTypeKode:L.FORELDREPENGER,alleMerknaderFraBeslutter:{},isAksjonspunktOpen:!0}},E={};var _,V,S;E.parameters={...E.parameters,docs:{...(_=E.parameters)==null?void 0:_.docs,source:{originalSource:"{}",...(S=(V=E.parameters)==null?void 0:V.docs)==null?void 0:S.source}}};const Kn=["Default"];export{E as Default,Kn as __namedExportsOrder,Bn as default};
