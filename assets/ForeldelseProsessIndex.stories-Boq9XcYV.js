import{$ as y,t as I,a as Ee,o as Oe,N as Me,O as Q,k as Ve,J as Be,V as Ie,b as N,c as pe,Z as Ne}from"./style-BbH34Im7.js";import{h as Z,aa as ke,j as e,as as ye,V as S,aw as _e,H as O,aN as Ue,aO as ee,q as p,F as P,M as C,O as be,L as te,B as _,v as U,G as Le,t as Ke,r as F,aP as fe,aQ as ve,ak as Ce,aR as Ge,ad as ze,au as $e,ar as He,J as Ze,aS as Ye,ax as Je,aT as We,P as Xe,l as Qe}from"./iframe-DQj-1hI0.js";import{M as m}from"./message-Y2g9lHpZ.js";import{S as re,T as W,a as er,b as rr,c as nr,d as tr,e as ar,f as sr}from"./Timeline-BppvazUD.js";import{S as ir}from"./Scissors-DhoggEEO.js";import{a as or,S as lr}from"./SilhouetteFill-B34OLEaG.js";var Y=(r=>(r.VURDER_FORELDELSE="5003",r))(Y||{});const ur=Ee(3),dr=Oe(1500),mr=r=>r!==y.UDEFINERT?r:void 0,gr=r=>r.foreldet?r.foreldet:mr(r.foreldelseVurderingType),pr=r=>({...r,foreldet:gr(r)}),ce=({skjulPeriode:r,readOnly:n,periode:a,oppdaterPeriode:o,kodeverkSamlingFpTilbake:f})=>{const g=Z(),s=ke({defaultValues:pr(a)}),b=s.watch("foreldet"),v=b&&b===y.FORELDET,T=b&&b===y.TILLEGGSFRIST,u=f.ForeldelseVurderingType.filter(d=>d.kode!==y.IKKE_VURDERT);return e.jsx(ye,{formMethods:s,onSubmit:d=>o(d),children:e.jsxs(S,{gap:"4",children:[e.jsx(_e,{name:"begrunnelse",control:s.control,label:g.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[I,ur,dr,Me],maxLength:1500,readOnly:n}),e.jsxs(O,{gap:"10",children:[e.jsx(Ue,{name:"foreldet",control:s.control,label:e.jsx(m,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[I],radios:u.map(d=>({label:d.navn,value:d.kode})),isReadOnly:n}),e.jsxs(S,{gap:"5",children:[(v||T)&&e.jsx(ee,{name:"foreldelsesfrist",control:s.control,label:g.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[I,Q],isReadOnly:n}),T&&e.jsx(ee,{name:"oppdagelsesDato",control:s.control,label:g.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[I,Q,Ve],isReadOnly:n,fromDate:p("1970-01-01").toDate(),toDate:p().toDate()})]})]}),e.jsxs(O,{gap:"4",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!s.formState.isDirty||s.formState.isSubmitting||n,loading:s.formState.isSubmitting,children:e.jsx(m,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(m,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ce.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  foreldelsesfrist?: Date;
  oppdagelsesDato?: Date;
}>`}]},name:"values"}],return:{name:"void"}}},description:""},skjulPeriode:{required:!0,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent"},name:"event"}],return:{name:"void"}}},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""}}};const kr="_button_8q57x_1",yr="_cancelButton_8q57x_5",se={button:kr,cancelButton:yr},br=(r,n)=>a=>a&&(Be(a)(p(r.tom.toString()).subtract(1,"day"))||Ie(a)(r.fom))?n.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,fr=(r,n)=>{const a=p(r.forstePeriodeTomDato).add(1,"days"),o={fom:n.fom,tom:r.forstePeriodeTomDato},f={fom:a.format(Ke),tom:n.tom};return{forstePeriode:o,andrePeriode:f}},Te=({periodeData:r,showModal:n,cancelEvent:a,finnesBelopMed0Verdi:o,splitPeriod:f})=>{const g=Z(),s=ke();return e.jsx(ye,{formMethods:s,onSubmit:b=>f(fr(b,r)),children:e.jsxs(C,{width:"medium",open:n,"aria-label":g.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:a,children:[e.jsx(C.Header,{children:e.jsx(be,{size:"small",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(C.Body,{children:e.jsxs(S,{gap:"4",children:[e.jsxs("div",{children:[e.jsx(te,{size:"small",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(_,{size:"small",children:`${p(r.fom.toString()).format(U)} - ${p(r.tom.toString()).format(U)}`})]}),e.jsx(ee,{name:"forstePeriodeTomDato",control:s.control,label:e.jsx(m,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[I,Q,br(r,g)],fromDate:p(r.fom).toDate(),toDate:p(r.tom).toDate()}),o&&e.jsx(Le,{variant:"error",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(C.Footer,{children:[e.jsx(P,{size:"small",variant:"primary",className:se.button,disabled:!s.formState.isDirty,children:e.jsx(m,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:a,className:se.cancelButton,type:"button",children:e.jsx(m,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};Te.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const ie=(r,n)=>p(r.fom).diff(p(n.fom)),Sr=()=>p().subtract(30,"months").format(U),xr=r=>r?[e.jsx(m,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Sr()}},"vurderForeldelse")]:[],ne=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===y.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Ar=(r=[])=>r.map((n,a)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:ne(n),isGodkjent:y.FORELDET!==n.foreldet&&y.UDEFINERT!==n.foreldet,id:a})),Er=r=>({foreldelsePerioder:r.map(a=>({fraDato:a.fom,tilDato:a.tom,begrunnelse:a.begrunnelse,foreldelseVurderingType:a.foreldet,foreldelsesfrist:a.foreldelsesfrist,oppdagelsesDato:a.oppdagelsesDato})),kode:Y.VURDER_FORELDELSE}),Or=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Mr=r=>[...r].sort(Or).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===y.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:Je(n.begrunnelse)})),Pe=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a,aksjonspunkt:o,alleMerknaderFraBeslutter:f,perioderForeldelse:g,readOnly:s,kodeverkSamlingFpTilbake:b,beregnBelop:v,behandlingUuid:T,formData:u,setFormData:d})=>{const c=Mr(g.perioder),[i,x]=F.useState(u||c),[t,D]=F.useState(i==null?void 0:i.find(ne)),[A,R]=F.useState(!1),[k,E]=F.useState(!!u),q=l=>{const j=l?i.find(h=>h.fom===l.fom&&h.tom===l.tom):void 0;D(j)},ae=()=>{const l=i.findIndex(h=>h.fom===(t==null?void 0:t.fom)&&h.tom===(t==null?void 0:t.tom)),j=l===i.length-1?l:l+1;q(i[j])},V=()=>{const l=i.findIndex(h=>h.fom===(t==null?void 0:t.fom)&&h.tom===(t==null?void 0:t.tom)),j=l===0?l:l-1;q(i[j])},M=()=>{q(void 0)},we=l=>{const j=We(l,"erSplittet"),K=i.filter(w=>w.fom!==j.fom&&w.tom!==j.tom).concat(j).sort(ie);x(K),d(K),E(!0),M();const B=K.find(ne);B&&q(B)},Re=l=>{const j=i.find(w=>w.fom===(t==null?void 0:t.fom)&&w.tom===(t==null?void 0:t.tom));if(j===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${t==null?void 0:t.fom} Tom: ${t==null?void 0:t.tom}`);const h=l.map(w=>({...j,...w,erSplittet:!0})),B=i.filter(w=>w.fom!==(t==null?void 0:t.fom)&&w.tom!==(t==null?void 0:t.tom)).concat(h).sort(ie);x(B),d(B),E(!0),M(),q(h[0])},Fe=()=>{R(!0),r(Er(i))},Se=f[Y.VURDER_FORELDELSE],J=Ar(i),xe=o&&o.status===pe.OPPRETTET,Ae=J.every(l=>!l.isAksjonspunktOpen),L=t?J.find(l=>l.fom===t.fom&&l.tom===t.tom):void 0;return e.jsx($e,{merknaderFraBeslutter:Se,withoutBorder:!0,children:e.jsxs(S,{gap:"4",children:[e.jsx(be,{size:"small",children:e.jsx(m,{id:"ForeldelseForm.Foreldelse"})}),!o&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(m,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(m,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),i&&o&&e.jsxs(S,{gap:"4",children:[xe&&e.jsx(He,{children:xr(o)}),e.jsx(he,{perioder:J,valgtPeriode:L,setPeriode:q,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:a}),t&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":L==null?void 0:L.id.toString(),children:e.jsx(Ze,{borderWidth:"1",padding:"4",children:e.jsxs(S,{gap:"4",children:[e.jsx(qe,{setNestePeriode:ae,setForrigePeriode:V,valgtPeriode:t,readOnly:s,oppdaterSplittedePerioder:Re,behandlingUuid:T,beregnBelop:v,lukkPeriode:M}),e.jsx(je,{feilutbetaling:t.feilutbetaling,fom:t.fom,tom:t.tom}),e.jsx(ce,{periode:t,oppdaterPeriode:we,skjulPeriode:M,readOnly:s,kodeverkSamlingFpTilbake:b},t.fom)]})})}),e.jsx(O,{children:e.jsx(Ye,{isReadOnly:s,isDirty:k,isSubmittable:!t&&Ae,onClick:Fe,isSubmitting:A})})]})]})})};Pe.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const{action:Ir}=__STORYBOOK_MODULE_ACTIONS__,Nr={perioder:[{fom:"2019-01-01",tom:"2019-01-31",belop:1e3,begrunnelse:"Foreldet",foreldelseVurderingType:y.FORELDET,foreldelsesfrist:"2020-04-01"},{fom:"2019-03-01",tom:"2019-03-31",belop:3e3,foreldelseVurderingType:y.UDEFINERT},{fom:"2019-02-01",tom:"2019-02-28",belop:3e3,begrunnelse:"Over foreldelsesfrist, med tillegsfrist brukes",foreldelseVurderingType:y.TILLEGGSFRIST,foreldelsesfrist:"2020-04-01",oppdagelsesDato:"2019-11-01"},{fom:"2019-04-01",tom:"2019-04-30",belop:4e3,foreldelseVurderingType:y.UDEFINERT}]},_r={ForeldelseVurderingType:[{kode:y.FORELDET,navn:"Foreldet",kodeverk:"FORELDELSE_VURDERING"},{kode:y.TILLEGGSFRIST,navn:"Ikke foreldet, med tilleggsfrist",kodeverk:"FORELDELSE_VURDERING"},{kode:y.IKKE_FORELDET,navn:"Ikke foreldet",kodeverk:"FORELDELSE_VURDERING"}]},$r={component:De,args:{submitCallback:Ir("button-click"),behandling:{uuid:"1",versjon:1,status:Ne.BEHANDLING_UTREDES},kodeverkSamlingFpTilbake:_r,isReadOnly:!1,setFormData:()=>{},perioderForeldelse:Nr,relasjonsRolleType:N.MOR,beregnBelop:()=>Promise.resolve({perioder:[{belop:1e4},{belop:12e3}]}),alleMerknaderFraBeslutter:{},relasjonsRolleTypeKodeverk:[{kode:N.MOR,kodeverk:"RELASJONSROLLE_TYPE",navn:"Mor"}]}},$={args:{aksjonspunkter:[{definisjon:Y.VURDER_FORELDELSE,status:pe.OPPRETTET,begrunnelse:void 0,kanLoses:!0}]}},H={args:{aksjonspunkter:[]}};var oe,le,ue;$.parameters={...$.parameters,docs:{...(oe=$.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: [{
...
}`,...(ue=(le=$.parameters)==null?void 0:le.docs)==null?void 0:ue.source}}};var de,me,ge;H.parameters={...H.parameters,docs:{...(de=H.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: []
  }
}`,...(ge=(me=H.parameters)==null?void 0:me.docs)==null?void 0:ge.source}}};const Hr=["Default","UtenAksjonspunkt"];export{$ as Default,H as UtenAksjonspunkt,Hr as __namedExportsOrder,$r as default};
