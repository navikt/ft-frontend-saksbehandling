import{j as e,B as c}from"./iframe-BYGivzjd.js";import{g as l}from"./withIntl-DD913uBB.js";import{R as m}from"./ReadMore-uxz7kklE.js";import{M as o}from"./message-E7ZULg9i.js";import{S as h}from"./Checkmark-CV9p1xlI.js";const p="_checkBlaIkon_e3roh_1",k="_container_e3roh_5",x="_rad_e3roh_11",a={checkBlaIkon:p,container:k,rad:x},s=({saksopplysninger:d})=>e.jsx("div",{className:a.container,children:d.map((t,i)=>e.jsxs("div",{className:a.rad,children:[t.readMoreContent&&e.jsx(m,{size:"small",header:e.jsx(o,{id:t.textId}),children:t.readMoreContent}),!t.readMoreContent&&e.jsxs(e.Fragment,{children:[e.jsx(h,{className:a.checkBlaIkon,height:35,width:35}),e.jsx(c,{size:"small",children:e.jsx(o,{id:t.textId})})]})]},`BlaBoksMedCheckmarkListe-${t.textId}-${i}`))});s.__docgenInfo={description:"",methods:[],displayName:"BlaBoksMedCheckmarkListe",props:{saksopplysninger:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  textId: string;
