import{$ as y,t as I,a as Ee,o as Me,N as Oe,O as Q,k as Ve,J as Be,V as Ie,b as N,c as pe,Z as Ne}from"./style-DwzfyvPu.js";import{h as Z,aa as ke,j as e,as as ye,V as S,aw as _e,H as M,aP as Ue,aQ as ee,q as p,F as P,M as C,O as be,L as te,B as _,v as U,G as Le,t as Ke,r as F,aR as fe,aS as ve,ak as Ce,aT as Ge,ad as ze,au as $e,ar as He,J as Ze,aI as Ye,ax as Je,aU as We,P as Xe,l as Qe}from"./iframe-CGbGlz93.js";import{M as m}from"./message-BuAGu6WY.js";import{S as re,T as W,a as er,b as rr,c as nr,d as tr,e as ar,f as sr}from"./Timeline-DsC6DnRV.js";import{S as ir}from"./Scissors-D0yrE-5c.js";import{a as or,S as lr}from"./SilhouetteFill-BWMKY_D7.js";var Y=(r=>(r.VURDER_FORELDELSE="5003",r))(Y||{});const ur=Ee(3),dr=Me(1500),mr=r=>r!==y.UDEFINERT?r:void 0,gr=r=>r.foreldet?r.foreldet:mr(r.foreldelseVurderingType),pr=r=>({...r,foreldet:gr(r)}),ce=({skjulPeriode:r,readOnly:n,periode:a,oppdaterPeriode:o,kodeverkSamlingFpTilbake:f})=>{const g=Z(),s=ke({defaultValues:pr(a)}),b=s.watch("foreldet"),v=b&&b===y.FORELDET,T=b&&b===y.TILLEGGSFRIST,u=f.ForeldelseVurderingType.filter(d=>d.kode!==y.IKKE_VURDERT);return e.jsx(ye,{formMethods:s,onSubmit:d=>o(d),children:e.jsxs(S,{gap:"4",children:[e.jsx(_e,{name:"begrunnelse",control:s.control,label:g.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[I,ur,dr,Oe],maxLength:1500,readOnly:n}),e.jsxs(M,{gap:"10",children:[e.jsx(Ue,{name:"foreldet",control:s.control,label:e.jsx(m,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[I],radios:u.map(d=>({label:d.navn,value:d.kode})),isReadOnly:n}),e.jsxs(S,{gap:"5",children:[(v||T)&&e.jsx(ee,{name:"foreldelsesfrist",control:s.control,label:g.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[I,Q],isReadOnly:n}),T&&e.jsx(ee,{name:"oppdagelsesDato",control:s.control,label:g.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[I,Q,Ve],isReadOnly:n,fromDate:p("1970-01-01").toDate(),toDate:p().toDate()})]})]}),e.jsxs(M,{gap:"4",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!s.formState.isDirty||s.formState.isSubmitting||n,loading:s.formState.isSubmitting,children:e.jsx(m,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(m,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ce.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
