import{r as P,c as D,e as f,u as $,j as e,v as C,aC as H,V as R,U as G,L,B as h,aD as J,i as z,ae as W,ay as Y,H as Q,aN as X,N as Z,aO as ee,au as te,aw as p,l as re,p as ne}from"./iframe-BmpCVi_B.js";import{a as ae}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as ie,a as se,N as j,o as O}from"./style-BYSiIcrA.js";import{M as v}from"./message-6w1kNqXM.js";import{E as c}from"./ExpansionCard-CrcRkw-H.js";import{L as le}from"./Link-DpndOr_2.js";import{T as s}from"./Table-BNbUzJqQ.js";import"./preload-helper-PPVm8Dsz.js";var ue=function(n,a){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&a.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(n);i<r.length;i++)a.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(n,r[i])&&(t[r[i]]=n[r[i]]);return t};const ke=P.forwardRef((n,a)=>{var{title:t,titleId:r}=n,i=ue(n,["title","titleId"]);let k=D();return k=t?r||"title-"+k:void 0,f.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",width:"1em",height:"1em",fill:"none",viewBox:"0 0 24 24",focusable:!1,role:"img",ref:a,"aria-labelledby":k},i),t?f.createElement("title",{id:k},t):null,f.createElement("path",{fill:"currentColor",fillRule:"evenodd",d:"M3.75 12a8.25 8.25 0 1 1 16.5 0 8.25 8.25 0 0 1-16.5 0M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25m0 4.5a.75.75 0 0 1 .75.75v3.75h3.75a.75.75 0 0 1 0 1.5h-3.75v3.75a.75.75 0 0 1-1.5 0v-3.75H7.5a.75.75 0 0 1 0-1.5h3.75V7.5a.75.75 0 0 1 .75-.75",clipRule:"evenodd"}))}),oe="_addPeriodeButton_zdgvo_2",de={addPeriodeButton:oe},w=se(3),ve=O(4e3),ge=[w,j],me=[ie,w,j],V=({name:n,readOnly:a,fritekstPakrevet:t,maximumLength:r})=>{const{watch:i,control:k}=$(),l=i(n)===void 0,[d,o]=P.useState(l&&!t),g=t?me:ge;g.push(r?O(r):ve);const m=u=>{u.preventDefault(),o(!1)};return e.jsxs(e.Fragment,{children:[d&&!a&&e.jsx("div",{children:e.jsx(C,{icon:e.jsx(ke,{"aria-hidden":!0}),variant:"tertiary",type:"button",size:"xsmall",onClick:m,className:de.addPeriodeButton,children:e.jsx(v,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})}),!d&&e.jsx(H,{name:n,control:k,label:e.jsx(v,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:g,maxLength:r||4e3,readOnly:a})]})};V.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{name:{required:!0,tsType:{name:"FieldPath",elements:[{name:"intersection",raw:`{
  [key: string]: {
  ...
  underavsnittstype?: \`\${UnderavsnittType}\`;
  fritekstPåkrevet?: boolean;
}[]`,required:!0}}]}}],raw:"VedtaksbrevAvsnitt[]"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},perioderSomIkkeHarUtfyltObligatoriskVerdi:{required:!0,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:""},fritekstOppsummeringPakrevdMenIkkeUtfylt:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},erRevurderingTilbakekrevingFeilBeløpBortfalt:{required:!1,tsType:{name:"boolean"},description:""}}};var U=(n=>(n.FORESLA_VEDTAK="5004",n))(U||{});const F=n=>({oppsummeringstekst:n.OPPSUMMERING,perioderMedTekst:Object.entries(ee(n,"OPPSUMMERING")).map(([a,t])=>({fom:a.split("_")[0],tom:a.split("_")[1],faktaAvsnitt:t.FAKTA,foreldelseAvsnitt:t.FORELDELSE,vilkaarAvsnitt:t.VILKÅR,saerligeGrunnerAvsnitt:t.SÆRLIGEGRUNNER,saerligeGrunnerAnnetAvsnitt:t.SÆRLIGEGRUNNER_ANNET}))}),fe=(n,a)=>n.some(t=>t.avsnittstype==="OPPSUMMERING"&&t.underavsnittsliste.some(r=>r.fritekstPåkrevet)&&!a.OPPSUMMERING),Te=n=>({kode:U.FORESLA_VEDTAK,...F(n)}),be=(n,a)=>n.reduce((t,r)=>{const i=`${r.fom}_${r.tom}`,k=a[i];return r.underavsnittsliste.some(o=>o.fritekstPåkrevet&&o.underavsnittstype==="FAKTA")&&!k?.FAKTA||r.underavsnittsliste.some(o=>o.fritekstPåkrevet&&o.underavsnittstype==="SÆRLIGEGRUNNER_ANNET")&&!k?.SÆRLIGEGRUNNER_ANNET?t.concat(i):t},[]),S=(n,a,t)=>r=>{n({uuid:a,...F(t)}),r.preventDefault()},B=({submitCallback:n,readOnly:a,fetchPreviewVedtaksbrev:t,avsnittsliste:r,behandlingUuid:i,erRevurderingTilbakekrevingKlage:k,erRevurderingTilbakekrevingFeilBeløpBortfalt:l,formData:d,setFormData:o})=>{const g=r,m=d||q.buildInitialValues(g),u=z(),y=W({defaultValues:m}),T=y.watch(),I=fe(g,T),b=be(g,T),_=I||b.length>0;return e.jsx(Y,{formMethods:y,onSubmit:A=>n(Te(A)),setDataOnUnmount:o,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(q,{intl:u,vedtaksbrevAvsnitt:g,readOnly:a,perioderSomIkkeHarUtfyltObligatoriskVerdi:b,fritekstOppsummeringPakrevdMenIkkeUtfylt:I,erRevurderingTilbakekrevingFeilBeløpBortfalt:l}),e.jsxs(Q,{gap:"space-16",align:"center",children:[e.jsx(X,{text:u.formatMessage({id:"TilbakekrevingVedtakForm.TilGodkjenning"}),isReadOnly:a,isSubmittable:b.length===0&&!I,isSubmitting:y.formState.isSubmitting,hasErrors:_}),b.length===0&&e.jsx(le,{href:"",onClick:S(t,i,T),onKeyDown:A=>A.key==="Enter"?S(t,i,T)(A):null,children:e.jsx(v,{id:"TilbakekrevingVedtakForm.ForhandvisBrev"})})]}),k&&e.jsx(Z,{inline:!0,variant:"warning",contentMaxWidth:!1,children:e.jsx(v,{id:"TilbakekrevingVedtakForm.Infotekst.Klage"})})]})})};B.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakForm",props:{submitCallback:{required:!0,tsType:{name:"signature",type:"function",raw:"(aksjonspunktData: ForeslaVedtakTilbakekrevingAp) => Promise<void>",signature:{arguments:[{type:{name:"intersection",raw:`HentForhåndvisningVedtaksbrevPdf &
