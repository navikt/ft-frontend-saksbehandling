import{a as W}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{Y as K,$ as X,w as J,N as Q}from"./index.es-By6D3vxG.js";import{a as Z}from"./alleKodeverk-LoqTPBoT.js";import{a as ee}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as _,I as q,a as ne,o as re,N as te,z as O,u as ae,$ as U,W as ie,X as se}from"./style-CDo75Bwh.js";import{E,u as le,b as oe,P as de,r as ue}from"./index.es-DlflYTfv.js";import{u as ge,c as pe,b as me}from"./index.esm-FZjZzVNN.js";import{h as A}from"./moment-C5S46NFB.js";import{M as g,W as ke,a as ye}from"./index.es-EHDFgqo0.js";import{T as b}from"./Table-C5sJMb2u.js";import{V as k,H as B}from"./VStack-xkjQwvKn.js";import"./index-DNHX5htx.js";import"./Theme-C_brBVJK.js";import{L as D,D as F,a as j}from"./Label-CYbek38p.js";import{B as be}from"./Button-Cc809GDC.js";/* empty css              */import"./v4-CtRu48qb.js";import"./dayjs.min-Cke173X9.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Checkbox-BaSR81FM.js";import"./omit-B7stZg_p.js";import"./useId-CsAOvYkp.js";import"./ReadOnlyIcon-BUzfiMc5.js";import"./Loader-42dkOmtz.js";import"./Provider-BZs7ODlm.js";import"./useId-SP_zdaIa.js";import"./useFormField-Bu2NUIkp.js";import"./Fieldset-B4jGbpi0.js";import"./Tag-ntoonGP8.js";import"./Textarea-BjE6whUD.js";import"./index-DU09BupE.js";import"./index-7Fg4giie.js";import"./useClientLayoutEffect-pkze6c0k.js";import"./Select-CvyZY3UD.js";import"./ChevronDown-6T9JsqER.js";import"./Radio-Pmn7OwXu.js";import"./useDatepicker-Bm8fLnqa.js";import"./Date.Input-D651xWgA.js";import"./DatePicker-CrEkBviX.js";import"./Checkmark-DkINtRdf.js";import"./Modal-OqvqWSjt.js";import"./floating-ui.react-CQaPAoM5.js";import"./XMark-6H9iuGiv.js";import"./Popover-D6iHV8xT.js";import"./TextField-DY81zaLa.js";import"./Alert-Ja4tf6sE.js";import"./ExclamationmarkTriangleFill-DrBUO71d.js";import"./XMarkOctagonFill-Dr7RQDrl.js";import"./PersonPencilFill-DqunLdn1.js";import"./Box-C3b4VC_S.js";import"./BasePrimitive-gBgyIEwX.js";import"./KeyVerticalFill-DmgzHF4Z.js";var N=(t=>(t.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",t))(N||{});const ve="_feilutbetalingTable_1bepb_1",ce="_redText_1bepb_8",V={feilutbetalingTable:ve,redText:ce},P="perioder",he=(t,o)=>{const r=t.find(a=>a.hendelseType===o);return r!=null&&r.hendelseUndertyper&&r.hendelseUndertyper.length>0?r.hendelseUndertyper:void 0},Y=({perioder:t,årsaker:o,readOnly:r,behandlePerioderSamlet:a,kodeverkSamlingFpTilbake:s})=>{const{control:u,watch:l,setValue:p,getValues:v}=ge(),{fields:h}=pe({control:u,name:P}),c=(n,m,d)=>{a&&h.forEach((w,i)=>{m!==i&&(d?v(`${P}.${i}.årsak`)===d&&p(`${P}.${i}.${d}.underÅrsak`,n):p(`${P}.${i}.årsak`,n))})};return e.jsx("div",{className:V.feilutbetalingTable,children:e.jsxs(b,{children:[e.jsx(b.Header,{children:e.jsxs(b.Row,{children:[e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Period"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Hendelse"})}),e.jsx(b.HeaderCell,{scope:"col",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Beløp"})})]})}),e.jsx(b.Body,{children:h.map((n,m)=>{const d=l(`${P}.${m}.årsak`),w=he(o,d);return e.jsxs(b.Row,{children:[e.jsx(b.DataCell,{children:`${A(n.fom).format(E)} - ${A(n.tom).format(E)}`}),e.jsxs(b.DataCell,{children:[e.jsx(K,{name:`${P}.${m}.årsak`,selectValues:o.map(i=>{var f;return e.jsx("option",{value:i.hendelseType,children:(f=s[q.HENDELSE_TYPE].find(x=>x.kode===i.hendelseType))==null?void 0:f.navn},i.hendelseType)}),validate:[_],disabled:r,onChange:i=>c(i.target.value,m),label:""}),w&&e.jsx(K,{name:`${P}.${m}.${d}.underÅrsak`,selectValues:w.map(i=>{var f;return e.jsx("option",{value:i,children:(f=s[q.HENDELSE_UNDERTYPE].find(x=>x.kode===i))==null?void 0:f.navn},i)}),validate:[_],disabled:r,onChange:i=>c(i.target.value,m,d),label:""})]}),e.jsxs(b.DataCell,{className:V.redText,children:[t?t[m].belop:null," "]})]},n.id)})})]})})};Y.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingPerioderFieldArray",props:{perioder:{required:!0,tsType:{name:"signature['perioder']",raw:"FeilutbetalingFakta['behandlingFakta']['perioder']"},description:""},årsaker:{required:!0,tsType:{name:"Array",raw:"FeilutbetalingÅrsak['hendelseTyper']"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},behandlePerioderSamlet:{required:!0,tsType:{name:"boolean"},description:""},kodeverkSamlingFpTilbake:{required:!0,tsType:{name:"Record",elements:[{name:"KodeverkType"},{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  kode: string;
  navn: string;
  kodeverk: string;
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"}],raw:"Record<KodeverkType, KodeverkMedNavn[]>"},description:""}}};const fe="_textarea_14pq5_1",Te="_redText_14pq5_7",L={textarea:fe,redText:Te},Fe=ne(3),H=4e3,je=re(H),G=t=>t.behandlingFakta.perioder?[...t.behandlingFakta.perioder].sort((o,r)=>A(o.fom).diff(A(r.fom))):[],qe=t=>{const{behandlingFakta:{begrunnelse:o}}=t;return{begrunnelse:oe(o),perioder:G(t).map(r=>{const{fom:a,tom:s,feilutbetalingÅrsakDto:u}=r,l={fom:a,tom:s};if(!u)return l;const{hendelseType:p,hendelseUndertype:v}=u;return{...l,årsak:p,[p]:{underÅrsak:v||null}}})}},Pe=(t,o)=>{const r=t.perioder.map(a=>{const s=o.find(l=>l.hendelseType===a.årsak),u=s!=null&&s.hendelseUndertyper?s.hendelseUndertyper.find(l=>{var p;return l===((p=a[a.årsak])==null?void 0:p.underÅrsak)}):void 0;return{fom:a.fom,tom:a.tom,årsak:{hendelseType:s==null?void 0:s.hendelseType,hendelseUndertype:u}}});return{kode:N.AVKLAR_FAKTA_FOR_FEILUTBETALING,begrunnelse:t.begrunnelse,feilutbetalingFakta:r}},Ae=(t,o)=>{const{hendelseTyper:r}=t;return r.sort((a,s)=>{var n,m;const u=((n=o[q.HENDELSE_TYPE].find(d=>d.kode===a.hendelseType))==null?void 0:n.navn)||"",l=((m=o[q.HENDELSE_TYPE].find(d=>d.kode===s.hendelseType))==null?void 0:m.navn)||"",p=u.startsWith("§"),v=l.startsWith("§"),h=p?u.replace(/\D/g,""):u,c=v?l.replace(/\D/g,""):l;return p&&v?h-c:h.localeCompare(c)})},C=({hasOpenAksjonspunkter:t,feilutbetalingAarsak:o,feilutbetalingFakta:r,readOnly:a,alleMerknaderFraBeslutter:s,kodeverkSamlingFpTilbake:u,kodeverkSamlingFpsak:l,formData:p,setFormData:v,submitCallback:h})=>{var f,x;const c=le(),n=r.behandlingFakta,m=qe(r),d=me({defaultValues:p||m}),w=d.watch("behandlePerioderSamlet")||!1,i=Ae(o,u);return e.jsxs(k,{gap:"4",children:[t&&e.jsx(ke,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Aksjonspunkt"})}),e.jsx(X,{formMethods:d,onSubmit:T=>h(Pe(T,i)),setDataOnUnmount:v,children:e.jsxs(k,{gap:"4",children:[e.jsxs(B,{gap:"10",wrap:!0,children:[e.jsxs(k,{gap:"4",children:[e.jsx(D,{size:"small",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Feilutbetaling"})}),e.jsxs(B,{justify:"space-between",children:[e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.PeriodeMedFeilutbetaling"})}),e.jsx(j,{size:"small",children:`${A(n.totalPeriodeFom).format(E)} - ${A(n.totalPeriodeTom).format(E)}`})]}),e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.FeilutbetaltBeløp"})}),e.jsx(j,{size:"small",className:L.redText,children:n.aktuellFeilUtbetaltBeløp})]}),e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.TidligereVarseltBeløp"})}),e.jsx(j,{size:"small",children:n.tidligereVarseltBeløp?n.tidligereVarseltBeløp:e.jsx(g,{id:"FeilutbetalingInfoPanel.IkkeVarslet"})})]})]}),e.jsx(J,{name:"behandlePerioderSamlet",label:c.formatMessage({id:"FeilutbetalingInfoPanel.BehandlePerioderSamlet"}),readOnly:a}),e.jsx(ye,{merknaderFraBeslutter:s[N.AVKLAR_FAKTA_FOR_FEILUTBETALING],withoutBorder:!0,children:e.jsx(Y,{perioder:G(r),behandlePerioderSamlet:w,årsaker:i,readOnly:a,kodeverkSamlingFpTilbake:u})})]}),e.jsxs(k,{gap:"4",children:[e.jsx(D,{size:"small",children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Revurdering"})}),e.jsxs(B,{gap:"4",children:[e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Årsaker"})}),n.behandlingÅrsaker&&e.jsx(j,{size:"small",children:n.behandlingÅrsaker.map(T=>{var y;return(y=l[q.BEHANDLING_AARSAK].find(R=>R.kode===T.behandlingArsakType))==null?void 0:y.navn}).join(", ")})]}),n.datoForRevurderingsvedtak&&e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.DatoForRevurdering"})}),e.jsx(j,{size:"small",children:A(n.datoForRevurderingsvedtak).format(E)})]})]}),e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Resultat"})}),n.behandlingsresultat&&e.jsx(j,{size:"small",children:(f=l[q.BEHANDLING_AARSAK].find(T=>{var y;return T.kode===((y=n.behandlingsresultat)==null?void 0:y.type)}))==null?void 0:f.navn})]}),e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Konsekvens"})}),n.behandlingsresultat&&e.jsx(j,{size:"small",children:n.behandlingsresultat.konsekvenserForYtelsen.map(T=>{var y;return(y=l[q.KONSEKVENS_FOR_YTELSEN].find(R=>R.kode===T))==null?void 0:y.navn}).join(", ")})]}),e.jsxs(k,{gap:"1",children:[e.jsx(F,{children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Tilbakekrevingsvalg"})}),n.tilbakekrevingValg&&e.jsx(j,{size:"small",children:(x=u[q.TILBAKEKR_VIDERE_BEH].find(T=>{var y;return T.kode===((y=n.tilbakekrevingValg)==null?void 0:y.videreBehandling)}))==null?void 0:x.navn})]})]})]}),e.jsx("div",{className:L.textarea,children:e.jsx(Q,{name:"begrunnelse",label:c.formatMessage({id:"FeilutbetalingInfoPanel.Begrunnelse"}),validate:[_,Fe,je,te],maxLength:H,readOnly:a})}),e.jsx("div",{children:e.jsx(be,{variant:"primary",size:"small",disabled:a||!d.formState.isDirty||d.formState.isSubmitting,loading:d.formState.isSubmitting,children:e.jsx(g,{id:"FeilutbetalingInfoPanel.Confirm"})})})]})})]})};C.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingInfoPanel",props:{feilutbetalingFakta:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  behandlingFakta: {
    perioder?: {
      fom: string;
      tom: string;
