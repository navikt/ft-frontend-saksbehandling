import{F as y,_ as Fe}from"./index.es-DELgJj0W.js";import{i as H,an as oe,j as e,aH as le,V as R,aL as we,H as E,a_ as he,L as Re,a$ as Y,d as k,A as P,Q as K,$ as de,N as ne,B as _,b as L,W as xe,x as Se,r as h,b0 as ue,b1 as me,G as Ee,b2 as Ae,ar as Me,I as Oe,b3 as Ve,aJ as Ie,aG as Be,X as Ne,aS as _e,aM as Le,aT as Ue,P as Ke,n as Ce}from"./iframe-D7mg31af.js";import{t as N,a as Ge,o as ze,N as $e,O as Q,F as He,J as Ze,R as Je}from"./style-LLSrx7qI.js";import{M as g}from"./message-nD0mvDUg.js";import{S as ee,T as W,a as We,b as Xe,c as Ye,d as Qe,e as er}from"./Timeline-DIlHmodO.js";import{S as rr}from"./Scissors-CpAJoxja.js";import{a as nr,S as tr}from"./SilhouetteFill-D_rmTzlW.js";import"./preload-helper-PPVm8Dsz.js";var Z=(r=>(r.VURDER_FORELDELSE="5003",r))(Z||{});const ir=Ge(3),ar=ze(1500),sr=r=>r!==y.UDEFINERT?r:void 0,or=r=>r.foreldet?r.foreldet:sr(r.foreldelseVurderingType),lr=r=>({...r,foreldet:or(r)}),ge=({skjulPeriode:r,readOnly:n,periode:t,oppdaterPeriode:d,kodeverkSamlingFpTilbake:b})=>{const p=H(),i=oe({defaultValues:lr(t)}),f=i.watch("foreldet"),c=f&&f===y.FORELDET,T=f&&f===y.TILLEGGSFRIST,u=b.ForeldelseVurderingType.filter(s=>s.kode!==y.IKKE_VURDERT&&s.kode!==y.UDEFINERT);return e.jsx(le,{formMethods:i,onSubmit:s=>d(s),children:e.jsxs(R,{gap:"space-16",children:[e.jsx(we,{name:"begrunnelse",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[N,ir,ar,$e],maxLength:1500,readOnly:n}),e.jsxs(E,{gap:"space-40",children:[e.jsx(he,{name:"foreldet",control:i.control,legend:e.jsx(g,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[N],readOnly:n,children:u.map(s=>e.jsx(Re,{value:s.kode,size:"small",children:s.navn},s.kode))}),e.jsxs(R,{gap:"space-20",children:[(c||T)&&e.jsx(Y,{name:"foreldelsesfrist",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[N,Q],readOnly:n}),T&&e.jsx(Y,{name:"oppdagelsesDato",control:i.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[N,Q,He],readOnly:n,fromDate:k("1970-01-01").toDate(),toDate:k().toDate()})]})]}),e.jsxs(E,{gap:"space-16",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!i.formState.isDirty||i.formState.isSubmitting||n,loading:i.formState.isSubmitting,children:e.jsx(g,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(g,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ge.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const se=(r,n)=>k(r.fom).diff(k(n.fom)),Dr=()=>k().subtract(30,"months").format(L),Fr=r=>r?[e.jsx(g,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Dr()}},"vurderForeldelse")]:[],re=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===y.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),wr=(r=[])=>r.map((n,t)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:re(n),isGodkjent:y.FORELDET!==n.foreldet&&y.UDEFINERT!==n.foreldet,id:t})),hr=r=>({foreldelsePerioder:r.map(t=>({fraDato:t.fom,tilDato:t.tom,begrunnelse:t.begrunnelse,foreldelseVurderingType:t.foreldet,foreldelsesfrist:t.foreldelsesfrist,oppdagelsesDato:t.oppdagelsesDato})),kode:Z.VURDER_FORELDELSE}),Rr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,xr=r=>[...r].sort(Rr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===y.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:Le(n.begrunnelse)})),be=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t,aksjonspunkt:d,alleMerknaderFraBeslutter:b,perioderForeldelse:p,readOnly:i,kodeverkSamlingFpTilbake:f,beregnBelop:c,behandlingUuid:T,formData:u,setFormData:s})=>{const v=xr(p.perioder),[o,x]=h.useState(u||v),[a,D]=h.useState(o?.find(re)),[S,m]=h.useState(!1),[V,A]=h.useState(!!u),F=l=>{const j=l?o.find(q=>q.fom===l.fom&&q.tom===l.tom):void 0;D(j)},te=()=>{const l=o.findIndex(q=>q.fom===a?.fom&&q.tom===a?.tom),j=l===o.length-1?l:l+1;F(o[j])},I=()=>{const l=o.findIndex(q=>q.fom===a?.fom&&q.tom===a?.tom),j=l===0?l:l-1;F(o[j])},M=()=>{F(void 0)},ve=l=>{const j=Ue(l,"erSplittet"),U=o.filter(w=>w.fom!==j.fom&&w.tom!==j.tom).concat(j).sort(se);x(U),s(U),A(!0),M();const B=U.find(re);B&&F(B)},Te=l=>{const j=o.find(w=>w.fom===a?.fom&&w.tom===a?.tom);if(j===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${a?.fom} Tom: ${a?.tom}`);const q=l.map(w=>({...j,...w,erSplittet:!0})),B=o.filter(w=>w.fom!==a?.fom&&w.tom!==a?.tom).concat(q).sort(se);x(B),s(B),A(!0),M(),F(q[0])},je=()=>{m(!0),r(hr(o))},qe=b[Z.VURDER_FORELDELSE],J=wr(o),Pe=Ve(d),De=J.every(l=>!l.isAksjonspunktOpen),ie=a?J.find(l=>l.fom===a.fom&&l.tom===a.tom):void 0;return e.jsx(Ie,{merknaderFraBeslutter:qe,withoutBorder:!0,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(de,{size:"small",level:"2",children:e.jsx(g,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),o&&d&&e.jsxs(R,{gap:"space-16",children:[Pe&&e.jsx(Be,{children:Fr(d)}),e.jsx(fe,{perioder:J,valgtPeriode:ie,setPeriode:F,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t}),a&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":ie?.id.toString(),children:e.jsx(Ne.New,{borderWidth:"1",padding:"4",children:e.jsxs(R,{gap:"space-16",children:[e.jsx(ke,{setNestePeriode:te,setForrigePeriode:I,valgtPeriode:a,readOnly:i,oppdaterSplittedePerioder:Te,behandlingUuid:T,beregnBelop:c,lukkPeriode:M}),e.jsx(ye,{feilutbetaling:a.feilutbetaling,fom:a.fom,tom:a.tom}),e.jsx(ge,{periode:a,oppdaterPeriode:ve,skjulPeriode:M,readOnly:i,kodeverkSamlingFpTilbake:f},a.fom)]})})}),e.jsx(E,{children:e.jsx(_e,{isReadOnly:i,isDirty:V,isSubmittable:!a&&De,onClick:je,isSubmitting:S})})]})]})})};be.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  status: string;
  begrunnelse?: string;
  vilkarType?: string;
