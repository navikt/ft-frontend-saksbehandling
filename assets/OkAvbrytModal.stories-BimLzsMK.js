import{j as e,M as r,J as m,z as o,h as p}from"./iframe-ssyF9cFN.js";import{m as g}from"./nb_NO-D4PbtzLx.js";import"./preload-helper-D9Z9MdNV.js";const a=p(g),l=({text:s,okButtonText:c,showModal:d,cancel:n,submit:u})=>e.jsxs(r,{width:"small",open:d,"aria-label":s,onClose:n,children:[e.jsx(r.Body,{children:e.jsx(m,{size:"small",level:"2",children:s})}),e.jsxs(r.Footer,{children:[e.jsx(o,{variant:"primary",size:"small",onClick:u,autoFocus:!0,type:"button",children:c||a.formatMessage({id:"OkAvbrytModal.Ok"})}),e.jsx(o,{variant:"secondary",size:"small",onClick:n,type:"button",children:a.formatMessage({id:"OkAvbrytModal.Avbryt"})})]})]});l.__docgenInfo={description:`OkAvbrytModal
