import{i as Y,an as He,j as e,aH as Ce,Q as ke,$ as ye,V as R,N as D,B as P,d as c,b as re,a$ as yr,W as Je,A as F,x as Or,r as M,H as E,b0 as We,b1 as Xe,G as Ar,ao as Sr,b2 as Rr,ar as ne,u as $,bD as Z,a_ as K,L as _,f as Oe,aE as Ze,bE as Pe,bF as hr,aI as fr,aL as oe,E as Er,aM as ce,aq as Qe,bG as we,bH as Mr,I as _r,aJ as Pr,aG as Fr,X as qr,aS as Gr,aT as Ae,P as jr,n as Ur}from"./iframe-CPmh237e.js";import{g as Lr}from"./withIntl-UUhdL49k.js";import{a as Ir}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{F as Fe}from"./index.es-DELgJj0W.js";import{t as f,O as wr,J as Vr,R as Nr,i as er,l as Br,a as Ue,o as Le,N as Se}from"./style-LdkD-lxs.js";import{M as i}from"./message-PqDknaOk.js";import{S as Ve,T as Me,a as xr,b as Dr,c as Kr,d as Yr,e as $r}from"./Timeline-DC0XauzS.js";import{S as zr}from"./Scissors-C2JnNt5w.js";import{T as w}from"./Table-shE8wzP8.js";import{T as Hr,m as rr}from"./nb_NO-BsP3LdKQ.js";import{a as Cr,S as Jr}from"./SilhouetteFill-DacYxwg_.js";import"./preload-helper-PPVm8Dsz.js";const Wr="_button_8q57x_1",Xr="_cancelButton_8q57x_5",Ne={button:Wr,cancelButton:Xr},Zr=(r,t)=>n=>n&&(Vr(n)(c(r.tom.toString()).subtract(1,"day"))||Nr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,Qr=(r,t)=>{const n=c(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},l={fom:n.format(Or),tom:t.tom};return{forstePeriode:a,andrePeriode:l}},nr=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:l})=>{const s=Y(),u=He();return e.jsx(Ce,{formMethods:u,onSubmit:p=>l(Qr(p,r)),children:e.jsxs(ke,{open:t,"aria-label":s.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(ke.Header,{children:e.jsx(ye,{size:"small",level:"2",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(ke.Body,{children:e.jsxs(R,{gap:"space-16",children:[e.jsxs("div",{children:[e.jsx(D,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(P,{size:"small",children:`${c(r.fom.toString()).format(re)} - ${c(r.tom.toString()).format(re)}`})]}),e.jsx(yr,{name:"forstePeriodeTomDato",control:u.control,label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[f,wr,Zr(r,s)],fromDate:c(r.fom).toDate(),toDate:c(r.tom).toDate()}),a&&e.jsx(Je,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(ke.Footer,{children:[e.jsx(F,{size:"small",variant:"primary",className:Ne.button,disabled:!u.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(F,{size:"small",variant:"secondary",onClick:n,className:Ne.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};nr.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
...
}`,...ve.parameters?.docs?.source}}};const yt=["Default","MedToPerioder"];export{Te as Default,ve as MedToPerioder,yt as __namedExportsOrder,bt as default};
