import{a as Pr}from"./index-B-lxVbXh.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as nr,G as Fr,J as $,Z as tr,X as we,t as Sr,U as wr,K as oe,Q as Vr}from"./index.es-D-FkWqxL.js";import{g as Or}from"./withIntl-BVIBk2t2.js";import{a as _r}from"./alleTilbakekrevingKodeverk-dIUSSyeF.js";import{e as x,O as Er,H as Ir,D as Mr,l as ar,i as Gr,a as Ie,o as Me,N as he,S as ce,h as fe,I as Dr,m as Ve,d as Nr}from"./style-CT9PZ6u7.js";import{e as z,i as Q,A as Ur,r as Lr,$ as ee,l as Te,Z as sr,W as je,P as Kr,V as $r}from"./index.es-bwVch3Q4.js";import{r as T}from"./index-DASCADcX.js";import{h as M}from"./moment-C5S46NFB.js";import{M as i,q as W,f as Ue,l as Cr,V as zr}from"./index.es-DoPYHR-i.js";import{b as ir,u as Ge}from"./index.esm-s_KxdRQ_.js";import{d as q}from"./dayjs.min-Cke173X9.js";import{M as pe}from"./Modal-BDpe_Rzz.js";import{H as qe,L as C,a as S,D as xe,E as Hr}from"./Label-CfBdhDeq.js";import{V as R,H as E}from"./VStack-CfnCueE0.js";import"./Theme-Bqc_BD0M.js";import{A as lr}from"./Alert-vBIWixRy.js";import{B as w}from"./Button-D87Irl5r.js";import{S as Le,T as Fe,a as Yr,b as Wr,c as Jr,d as Zr,e as Xr,f as Qr}from"./Timeline-P5Y9z71I.js";import{S as en}from"./Scissors-DzHI4ozx.js";import{S as or,g as ur}from"./DatePicker-aX7RVMBD.js";import{S as rn}from"./XMark-KAXZPgUH.js";import{T as K}from"./Table-CMFYEO3g.js";import{T as nn,m as dr}from"./nb_NO-ChPtz-b_.js";import{a as tn,S as an}from"./SilhouetteFill-Dse_AnU7.js";import{B as sn}from"./Box-t-YAJNpB.js";/* empty css              */import"./v4-CtRu48qb.js";import"./Checkbox-9OjO7dif.js";import"./omit-B7stZg_p.js";import"./useId-BiFzyKmP.js";import"./ReadOnlyIcon-fpBUgZkh.js";import"./Loader-C31s9nuZ.js";import"./Provider-ChnEfPss.js";import"./useId-sDoo_C8F.js";import"./useFormField-BZtIeUXv.js";import"./Fieldset-DZVRdKGd.js";import"./Tag-BWaKO8vm.js";import"./Textarea-DBPd7-5x.js";import"./index-CL4jvrHg.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-BxWMR1Ay.js";import"./useClientLayoutEffect-Dt_TuINI.js";import"./Select-BQ6tobI2.js";import"./ChevronDown-DKSW_DmS.js";import"./Radio-QYcOLfdt.js";import"./useDatepicker-qsb-M2FM.js";import"./Date.Input-DmVXlpzX.js";import"./TextField-1A0BebA6.js";import"./PersonPencilFill-CoF6qBVB.js";import"./KeyVerticalFill-m_CavoP-.js";import"./Checkmark-abnGd_Ay.js";import"./floating-ui.react-CCcN9eYl.js";import"./BasePrimitive-eMFBMVLd.js";import"./ExclamationmarkTriangleFill-BFbmXhrr.js";import"./XMarkOctagonFill-Cj0h8cZo.js";import"./Popover-BstGxgho.js";var De=(r=>(r.VURDER_TILBAKEKREVING="5002",r))(De||{});const ln="_button_8q57x_1",on="_cancelButton_8q57x_5",Ke={button:ln,cancelButton:on},un=(r,t)=>n=>n&&(Ir(n)(q(r.tom.toString()).subtract(1,"day"))||Mr(n)(r.fom))?t.formatMessage({id:"DelOppPeriodeModalImpl.DatoUtenforPeriode"}):null,dn=(r,t)=>{const n=q(r.forstePeriodeTomDato).add(1,"days"),a={fom:t.fom,tom:r.forstePeriodeTomDato},s={fom:n.format(Ur),tom:t.tom};return{forstePeriode:a,andrePeriode:s}},mr=({periodeData:r,showModal:t,cancelEvent:n,finnesBelopMed0Verdi:a,splitPeriod:s})=>{const d=z(),m=ir();return e.jsx(nr,{formMethods:m,onSubmit:k=>s(dn(k,r)),children:e.jsxs(pe,{open:t,"aria-label":d.formatMessage({id:"DelOppPeriodeModalImpl.ModalDescription"}),onClose:n,width:"medium",children:[e.jsx(pe.Header,{children:e.jsx(qe,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.DelOppPerioden"})})}),e.jsx(pe.Body,{children:e.jsxs(R,{gap:"4",children:[e.jsxs("div",{children:[e.jsx(C,{size:"small",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Periode"})}),e.jsx(S,{size:"small",children:`${q(r.fom.toString()).format(Q)} - ${q(r.tom.toString()).format(Q)}`})]}),e.jsx(Fr,{name:"forstePeriodeTomDato",label:e.jsx(i,{id:"DelOppPeriodeModalImpl.AngiTomDato"}),validate:[x,Er,un(r,d)],fromDate:q(r.fom).toDate(),toDate:q(r.tom).toDate()}),a&&e.jsx(lr,{variant:"error",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.BelopEr0"})})]})}),e.jsxs(pe.Footer,{children:[e.jsx(w,{size:"small",variant:"primary",className:Ke.button,disabled:!m.formState.isDirty,children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Ok"})}),e.jsx(w,{size:"small",variant:"secondary",onClick:n,className:Ke.cancelButton,type:"button",children:e.jsx(i,{id:"DelOppPeriodeModalImpl.Avbryt"})})]})]})})};mr.__docgenInfo={description:"",methods:[],displayName:"DelOppPeriodeModal",props:{periodeData:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  fom: string;
  tom: string;
...
Behandlingspunkt Tilbakekreving. Setter opp en tidslinje som lar en velge periode. Ved valg blir et detaljevindu vist.`,methods:[],displayName:"TilbakekrevingForm",props:{perioderForeldelse:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  erSplittet?: boolean;
  feilutbetaling?: number;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}},{key:"erSplittet",value:{name:"boolean",required:!1}},{key:"feilutbetaling",value:{name:"number",required:!1}}]}},{name:"InitialValuesDetailForm"}]}],raw:"CustomVilkarsVurdertePeriode[]"},name:"data"}],return:{name:"void"}}},description:""}}};const dt=$r(dr),Br=({behandling:r,perioderForeldelse:t,vilkarvurderingsperioder:n,vilkarvurdering:a,beregnBelop:s,kodeverkSamlingFpTilbake:d,submitCallback:m,alleMerknaderFraBeslutter:k,isReadOnly:g,formData:b,setFormData:o,relasjonsRolleType:p,relasjonsRolleTypeKodeverk:u})=>e.jsx(Kr,{value:dt,children:e.jsx(Rr,{behandlingUuid:r.uuid,perioderForeldelse:t,perioder:n.perioder,rettsgebyr:n.rettsgebyr,vilkarvurdering:a,submitCallback:m,readOnly:g,relasjonsRolleType:p,relasjonsRolleTypeKodeverk:u,alleMerknaderFraBeslutter:k,kodeverkSamlingFpTilbake:d,beregnBelop:s,formData:b,setFormData:o})});Br.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingProsessIndex",props:{behandling:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  versjon: number;
  uuid: string;
  status: string;
  type: string;
...
}`,...(rr=(er=ve.parameters)==null?void 0:er.docs)==null?void 0:rr.source}}};const fa=["Default","MedToPerioder"];export{ye as Default,ve as MedToPerioder,fa as __namedExportsOrder,ca as default};
