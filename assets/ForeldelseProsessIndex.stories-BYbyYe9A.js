import{A as k}from"./index.es-BDctT3QU.js";import{k as Z,al as oe,j as e,aE as le,W as R,aI as Fe,H as S,aY as we,N as he,aZ as Y,d as y,I as P,Z as L,a1 as de,X as ne,B as _,b as U,a2 as Re,x as xe,r as h,a_ as ue,a$ as me,J as Ae,b0 as Se,ao as Ee,K as Me,b1 as Oe,aG as Ve,aD as Be,a0 as Ie,aW as Ne,aJ as _e,aX as Ue,P as Ke,i as Le}from"./iframe-B0_JiVPH.js";import{t as N,a as Ce,o as Ge,N as ze,O as Q,F as $e,J as Ze,R as He}from"./index.es-CKMDOG0c.js";import{M as g}from"./message-BTjlQhqf.js";import{S as ee,T as X,a as We,b as Xe,c as Je,d as Ye,e as Qe}from"./Timeline-Bfm4_BPi.js";import{S as er}from"./Scissors-DIRaoeGV.js";import{a as rr,S as nr}from"./SilhouetteFill-BwBeaBOJ.js";/* empty css              */import"./preload-helper-PPVm8Dsz.js";var H=(r=>(r.VURDER_FORELDELSE="5003",r))(H||{});const tr=Ce(3),ar=Ge(1500),ir=r=>r!==k.UDEFINERT?r:void 0,sr=r=>r.foreldet?r.foreldet:ir(r.foreldelseVurderingType),or=r=>({...r,foreldet:sr(r)}),ge=({skjulPeriode:r,readOnly:n,periode:t,oppdaterPeriode:d,kodeverkSamlingFpTilbake:b})=>{const p=Z(),a=oe({defaultValues:or(t)}),f=a.watch("foreldet"),c=f&&f===k.FORELDET,T=f&&f===k.TILLEGGSFRIST,u=b.ForeldelseVurderingType.filter(s=>s.kode!==k.IKKE_VURDERT&&s.kode!==k.UDEFINERT);return e.jsx(le,{formMethods:a,onSubmit:s=>d(s),children:e.jsxs(R,{gap:"space-16",children:[e.jsx(Fe,{name:"begrunnelse",control:a.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[N,tr,ar,ze],maxLength:1500,readOnly:n}),e.jsxs(S,{gap:"space-40",children:[e.jsx(we,{name:"foreldet",control:a.control,legend:e.jsx(g,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[N],readOnly:n,children:u.map(s=>e.jsx(he,{value:s.kode,size:"small",children:s.navn},s.kode))}),e.jsxs(R,{gap:"space-20",children:[(c||T)&&e.jsx(Y,{name:"foreldelsesfrist",control:a.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[N,Q],readOnly:n}),T&&e.jsx(Y,{name:"oppdagelsesDato",control:a.control,label:p.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[N,Q,$e],readOnly:n,fromDate:y("1970-01-01").toDate(),toDate:y().toDate()})]})]}),e.jsxs(S,{gap:"space-16",children:[e.jsx(P,{size:"small",variant:"primary",disabled:!a.formState.isDirty||a.formState.isSubmitting||n,loading:a.formState.isSubmitting,children:e.jsx(g,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(P,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(g,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};ge.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}}]}},name:"perioder"}],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const gr="_margin_1dkor_37",J={margin:gr},pr=!1,ye=({valgtPeriode:r,beregnBelop:n,behandlingUuid:t,oppdaterSplittedePerioder:d,setNestePeriode:b,setForrigePeriode:p,readOnly:a,lukkPeriode:f})=>{const c=Z(),[T,u]=h.useState(!1),[s,v]=h.useState(!1),o=D=>{u(!0),D.preventDefault()},x=()=>{u(!1)},i=D=>{v(!1);const A={belop:r.feilutbetaling,fom:D.forstePeriode.fom,tom:D.forstePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "},m={belop:r.feilutbetaling,fom:D.andrePeriode.fom,tom:D.andrePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "};n({behandlingUuid:t,perioder:[A,m]}).then(E=>{const{perioder:F}=E;if(F.some(B=>B.belop===0))v(!0);else{const B={fom:A.fom,tom:A.tom,feilutbetaling:F[0].belop},M={fom:m.fom,tom:m.tom,feilutbetaling:F[1].belop};x(),d([B,M])}})};return e.jsxs(S,{children:[e.jsxs(ne,{size:"small",children:[e.jsx(g,{id:"PeriodeController.Detaljer"}),pr]}),!a&&e.jsxs(e.Fragment,{children:[e.jsx(ee,{}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(er,{"aria-hidden":!0}),onClick:o,variant:"tertiary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.DelOppPerioden"}),children:e.jsx(g,{id:"PeriodeController.DelOppPerioden"})})]}),T&&e.jsx(pe,{cancelEvent:x,showModal:T,periodeData:r,splitPeriod:i,finnesBelopMed0Verdi:s}),e.jsx(ee,{}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(ue,{"aria-hidden":!0}),onClick:p,variant:"secondary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.prevPeriod"}),children:e.jsx(g,{id:"PeriodeController.prevPeriodShort"})}),e.jsx(P,{className:J.margin,size:"xsmall",icon:e.jsx(me,{"aria-hidden":!0}),onClick:b,variant:"secondary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.nextPeriod"}),iconPosition:"right",children:e.jsx(g,{id:"PeriodeController.nextPeriodShort"})}),e.jsx(P,{size:"xsmall",icon:e.jsx(Ae,{"aria-hidden":!0}),onClick:f,variant:"tertiary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.LukkPeriode"})})]})};ye.__docgenInfo={description:"",methods:[],displayName:"PeriodeController",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},beregnBelop:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: BeregnBeløpParams) => Promise<BeregnBeløpResultat>",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: T;
  navn: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const se=(r,n)=>y(r.fom).diff(y(n.fom)),Pr=()=>y().subtract(30,"months").format(U),Dr=r=>r?[e.jsx(g,{id:`ForeldelseForm.AksjonspunktHelpText.${r.definisjon}`,values:{dato:Pr()}},"vurderForeldelse")]:[],re=r=>(!r.foreldelseVurderingType||r.foreldelseVurderingType===k.UDEFINERT)&&(!r.begrunnelse||!!r.erSplittet),Fr=(r=[])=>r.map((n,t)=>({fom:n.fom,tom:n.tom,isAksjonspunktOpen:re(n),isGodkjent:k.FORELDET!==n.foreldet&&k.UDEFINERT!==n.foreldet,id:t})),wr=r=>({foreldelsePerioder:r.map(t=>({fraDato:t.fom,tilDato:t.tom,begrunnelse:t.begrunnelse,foreldelseVurderingType:t.foreldet,foreldelsesfrist:t.foreldelsesfrist,oppdagelsesDato:t.oppdagelsesDato})),kode:H.VURDER_FORELDELSE}),hr=(r,n)=>r.fom<n.fom?-1:r.fom>n.fom?1:0,Rr=r=>[...r].sort(hr).map(n=>({...n,feilutbetaling:n.belop,foreldet:n.foreldelseVurderingType===k.UDEFINERT?void 0:n.foreldelseVurderingType,begrunnelse:_e(n.begrunnelse)})),be=({submitCallback:r,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t,aksjonspunkt:d,alleMerknaderFraBeslutter:b,perioderForeldelse:p,readOnly:a,kodeverkSamlingFpTilbake:f,beregnBelop:c,behandlingUuid:T,formData:u,setFormData:s})=>{const v=Rr(p.perioder),[o,x]=h.useState(u||v),[i,D]=h.useState(o?.find(re)),[A,m]=h.useState(!1),[V,E]=h.useState(!!u),F=l=>{const j=l?o.find(q=>q.fom===l.fom&&q.tom===l.tom):void 0;D(j)},te=()=>{const l=o.findIndex(q=>q.fom===i?.fom&&q.tom===i?.tom),j=l===o.length-1?l:l+1;F(o[j])},B=()=>{const l=o.findIndex(q=>q.fom===i?.fom&&q.tom===i?.tom),j=l===0?l:l-1;F(o[j])},M=()=>{F(void 0)},ve=l=>{const j=Ue(l,"erSplittet"),K=o.filter(w=>w.fom!==j.fom&&w.tom!==j.tom).concat(j).sort(se);x(K),s(K),E(!0),M();const I=K.find(re);I&&F(I)},Te=l=>{const j=o.find(w=>w.fom===i?.fom&&w.tom===i?.tom);if(j===void 0)throw new TypeError(`Periode skal alltid finnes. Fom: ${i?.fom} Tom: ${i?.tom}`);const q=l.map(w=>({...j,...w,erSplittet:!0})),I=o.filter(w=>w.fom!==i?.fom&&w.tom!==i?.tom).concat(q).sort(se);x(I),s(I),E(!0),M(),F(q[0])},je=()=>{m(!0),r(wr(o))},qe=b[H.VURDER_FORELDELSE],W=Fr(o),Pe=Oe(d),De=W.every(l=>!l.isAksjonspunktOpen),ae=i?W.find(l=>l.fom===i.fom&&l.tom===i.tom):void 0;return e.jsx(Ve,{merknaderFraBeslutter:qe,withoutBorder:!0,children:e.jsxs(R,{gap:"space-16",children:[e.jsx(de,{size:"small",level:"2",children:e.jsx(g,{id:"ForeldelseForm.Foreldelse"})}),!d&&e.jsxs(e.Fragment,{children:[e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.Foreldelsesloven"})}),e.jsx(_,{children:e.jsx(g,{id:"ForeldelseForm.AutomatiskVurdert"})})]}),o&&d&&e.jsxs(R,{gap:"space-16",children:[Pe&&e.jsx(Be,{children:Dr(d)}),e.jsx(fe,{perioder:W,valgtPeriode:ae,setPeriode:F,relasjonsRolleType:n,relasjonsRolleTypeKodeverk:t}),i&&e.jsx("div",{id:"panel-tilbakekreving-foreldelse","aria-controls":ae?.id.toString(),children:e.jsx(Ie.New,{borderWidth:"1",padding:"4",children:e.jsxs(R,{gap:"space-16",children:[e.jsx(ye,{setNestePeriode:te,setForrigePeriode:B,valgtPeriode:i,readOnly:a,oppdaterSplittedePerioder:Te,behandlingUuid:T,beregnBelop:c,lukkPeriode:M}),e.jsx(ke,{feilutbetaling:i.feilutbetaling,fom:i.fom,tom:i.tom}),e.jsx(ge,{periode:i,oppdaterPeriode:ve,skjulPeriode:M,readOnly:a,kodeverkSamlingFpTilbake:f},i.fom)]})})}),e.jsx(S,{children:e.jsx(Ne,{isReadOnly:a,isDirty:V,isSubmittable:!i&&De,onClick:je,isSubmitting:A})})]})]})})};be.__docgenInfo={description:"",methods:[],displayName:"ForeldelseForm",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},aksjonspunkt:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  definisjon: string;
  ...
  kode: T;
  navn: string;
}>`}],raw:"KodeverkMedNavn<RelasjonsRolleType>[]"},description:""}}};const{action:Sr}=__STORYBOOK_MODULE_ACTIONS__,Er={perioder:[{fom:"2019-01-01",tom:"2019-01-31",belop:1e3,begrunnelse:"Foreldet",foreldelseVurderingType:k.FORELDET,foreldelsesfrist:"2020-04-01"},{fom:"2019-03-01",tom:"2019-03-31",belop:3e3,foreldelseVurderingType:k.UDEFINERT},{fom:"2019-02-01",tom:"2019-02-28",belop:3e3,begrunnelse:"Over foreldelsesfrist, med tillegsfrist brukes",foreldelseVurderingType:k.TILLEGGSFRIST,foreldelsesfrist:"2020-04-01",oppdagelsesDato:"2019-11-01"},{fom:"2019-04-01",tom:"2019-04-30",belop:4e3,foreldelseVurderingType:k.UDEFINERT}]},Mr={ForeldelseVurderingType:[{kode:k.FORELDET,navn:"Foreldet"},{kode:k.TILLEGGSFRIST,navn:"Ikke foreldet, med tilleggsfrist"},{kode:k.IKKE_FORELDET,navn:"Ikke foreldet"}]},Cr={component:ce,args:{submitCallback:Sr("submit"),behandlingUuid:"1",kodeverkSamlingFpTilbake:Mr,isReadOnly:!1,setFormData:()=>{},perioderForeldelse:Er,relasjonsRolleType:O.MOR,beregnBelop:()=>Promise.resolve({perioder:[{belop:1e4},{belop:12e3}]}),alleMerknaderFraBeslutter:{},relasjonsRolleTypeKodeverk:[{kode:O.MOR,navn:"Mor"}]}},z={args:{aksjonspunkter:[{definisjon:H.VURDER_FORELDELSE,status:"OPPR",begrunnelse:void 0,kanLoses:!0}]}},$={args:{aksjonspunkter:[]}};z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: [{
