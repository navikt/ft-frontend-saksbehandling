import{a as Me}from"./index-B-lxVbXh.js";import{m as b,S as pe,e as B,a as Oe,o as Ie,N as Ve,O as ee,b as Be,H as Ne,D as Le,h as $,c as ke,d as _e}from"./style-DvXKkWZ-.js";import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{u as Q,Q as L,G as Ue,Z as Ce,e as Ke,g as Ge,i as ze,P as He,f as Ze}from"./index.es-BQ0OpxNI.js";import{r as l}from"./index-DASCADcX.js";import{d as y}from"./dayjs.min-Cke173X9.js";import{K as ye,Q as $e,H as Qe,U as re,Z as Ye}from"./index.es-cVzKZrru.js";import{M as p,A as We,b as Xe}from"./index.es-CrE2Ek67.js";import{b as fe}from"./index.esm-BH4c-sZP.js";import{V as x,H as O}from"./VStack-5o7uu9_z.js";import"./Theme-CaMvzsUv.js";import{B as D}from"./Button-Dgzkd3lk.js";import{M as K}from"./Modal-CYTt9kvk.js";import{H as be,L as te,a as _}from"./Label-ymrTdXLG.js";import{A as Je}from"./Alert-ByhgfYs4.js";import{S as ne,T as X,a as er,b as rr,c as nr,d as tr,e as ar,f as ir}from"./Timeline-DZYSEJVA.js";import{S as sr}from"./Scissors-DzHI4ozx.js";import{S as ve,e as ce}from"./DatePicker-a7Z44c2g.js";import{S as or}from"./XMark-KAXZPgUH.js";import{a as lr,S as dr}from"./SilhouetteFill-Dse_AnU7.js";import{B as ur}from"./Box-BDgFgj_x.js";/* empty css              */import"./v4-CtRu48qb.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Checkbox-tuo5WLqa.js";import"./omit-B7stZg_p.js";import"./useId-BiFzyKmP.js";import"./ReadOnlyIcon-DdHBAqwe.js";import"./Loader--92hiQI0.js";import"./Provider-ChnEfPss.js";import"./useId-sDoo_C8F.js";import"./useFormField-C_Behg-2.js";import"./Fieldset-DHF1hOrP.js";import"./Tag-CHNx7fef.js";import"./Textarea-BcuV6kw_.js";import"./index-CRSK7kgn.js";import"./index-BxWMR1Ay.js";import"./useClientLayoutEffect-Dt_TuINI.js";import"./Select-BwsnmEV0.js";import"./ChevronDown-DKSW_DmS.js";import"./Radio-BXDa3uop.js";import"./useDatepicker-C2gv930k.js";import"./Date.Input-_pUoiyW-.js";import"./TextField-CqY3sxwQ.js";import"./PersonPencilFill-CoF6qBVB.js";import"./KeyVerticalFill-m_CavoP-.js";import"./Checkmark-abnGd_Ay.js";import"./BasePrimitive-BG5YNwzo.js";import"./floating-ui.react-9TVABcNX.js";import"./ExclamationmarkTriangleFill-BFbmXhrr.js";import"./XMarkOctagonFill-Cj0h8cZo.js";import"./Popover-IFfnr5z7.js";var Y=(r=>(r.VURDER_FORELDELSE="5003",r))(Y||{});const mr=Oe(3),gr=Ie(1500),pr=r=>r!==b.UDEFINERT?r:void 0,kr=r=>r.foreldet?r.foreldet:pr(r.foreldelseVurderingType),yr=r=>({...r,foreldet:kr(r)}),qe=({skjulPeriode:r,readOnly:n,periode:a,oppdaterPeriode:d,kodeverkSamlingFpTilbake:q})=>{const m=Q(),o=fe({defaultValues:yr(a)}),v=o.watch("foreldet"),c=v&&v===b.FORELDET,T=v&&v===b.TILLEGGSFRIST,s=q[pe.FORELDELSE_VURDERING].filter(g=>g.kode!==b.IKKE_VURDERT);return e.jsx(ye,{formMethods:o,onSubmit:g=>d(g),children:e.jsxs(x,{gap:"4",children:[e.jsx($e,{name:"begrunnelse",label:m.formatMessage({id:"ForeldelsePeriodeForm.Vurdering"}),validate:[B,mr,gr,Ve],maxLength:1500,readOnly:n}),e.jsxs(O,{gap:"10",children:[e.jsx(Qe,{name:"foreldet",label:e.jsx(p,{id:"ForeldelsePeriodeForm.RadioGroup.Foreldet"}),validate:[B],radios:s.map(g=>({label:g.navn,value:g.kode})),isReadOnly:n}),e.jsxs(x,{gap:"5",children:[(c||T)&&e.jsx(re,{name:"foreldelsesfrist",label:m.formatMessage({id:"ForeldelsePeriodeForm.Foreldelsesfrist"}),validate:[B,ee],isReadOnly:n}),T&&e.jsx(re,{name:"oppdagelsesDato",label:m.formatMessage({id:"ForeldelsePeriodeForm.OppdagelsesDato"}),validate:[B,ee,Be],isReadOnly:n,fromDate:y("1970-01-01").toDate(),toDate:y().toDate()})]})]}),e.jsxs(O,{gap:"4",children:[e.jsx(D,{size:"small",variant:"primary",disabled:!o.formState.isDirty||o.formState.isSubmitting||n,loading:o.formState.isSubmitting,children:e.jsx(p,{id:"ForeldelsePeriodeForm.Oppdater"})}),e.jsx(D,{size:"small",variant:"secondary",onClick:r,type:"button",children:e.jsx(p,{id:"ForeldelsePeriodeForm.Avbryt"})})]})]})})};qe.__docgenInfo={description:"",methods:[],displayName:"ForeldelsePeriodeForm",props:{periode:{required:!0,tsType:{name:"intersection",raw:`Readonly<{
  ...
  fom: string;
  tom: string;
}`,signature:{properties:[{key:"fom",value:{name:"string",required:!0}},{key:"tom",value:{name:"string",required:!0}}]},required:!0}}]}},name:"perioder"}],return:{name:"void"}}},description:""},cancelEvent:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const qr="_margin_wnej3_37",J={margin:qr},Tr=!1,je=({valgtPeriode:r,beregnBelop:n,behandlingUuid:a,oppdaterSplittedePerioder:d,setNestePeriode:q,setForrigePeriode:m,readOnly:o,lukkPeriode:v})=>{const c=Q(),[T,s]=l.useState(!1),[g,k]=l.useState(!1),i=R=>{s(!0),R.preventDefault()},E=()=>{s(!1)},t=R=>{k(!1);const A={belop:r.feilutbetaling,fom:R.forstePeriode.fom,tom:R.forstePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "},w={belop:r.feilutbetaling,fom:R.andrePeriode.fom,tom:R.andrePeriode.tom,begrunnelse:r.begrunnelse?r.begrunnelse:" "};n({behandlingUuid:a,perioder:[A,w]}).then(M=>{const{perioder:j}=M;if(j.some(I=>I.belop===0))k(!0);else{const I={fom:A.fom,tom:A.tom,feilutbetaling:j[0].belop},S={fom:w.fom,tom:w.tom,feilutbetaling:j[1].belop};E(),d([I,S])}})};return e.jsxs(O,{children:[e.jsxs(te,{size:"small",children:[e.jsx(p,{id:"PeriodeController.Detaljer"}),Tr]}),!o&&e.jsxs(e.Fragment,{children:[e.jsx(ne,{}),e.jsx(D,{className:J.margin,size:"xsmall",icon:e.jsx(sr,{"aria-hidden":!0}),onClick:i,variant:"tertiary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.DelOppPerioden"}),children:e.jsx(p,{id:"PeriodeController.DelOppPerioden"})})]}),T&&e.jsx(Te,{cancelEvent:E,showModal:T,periodeData:r,splitPeriod:t,finnesBelopMed0Verdi:g}),e.jsx(ne,{}),e.jsx(D,{className:J.margin,size:"xsmall",icon:e.jsx(ve,{"aria-hidden":!0}),onClick:m,variant:"secondary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.prevPeriod"}),children:e.jsx(p,{id:"PeriodeController.prevPeriodShort"})}),e.jsx(D,{className:J.margin,size:"xsmall",icon:e.jsx(ce,{"aria-hidden":!0}),onClick:q,variant:"secondary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.nextPeriod"}),iconPosition:"right",children:e.jsx(p,{id:"PeriodeController.nextPeriodShort"})}),e.jsx(D,{size:"xsmall",icon:e.jsx(or,{"aria-hidden":!0}),onClick:v,variant:"tertiary-neutral",type:"button",title:c.formatMessage({id:"PeriodeController.LukkPeriode"})})]})};je.__docgenInfo={description:"",methods:[],displayName:"PeriodeController",props:{behandlingUuid:{required:!0,tsType:{name:"string"},description:""},beregnBelop:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: { behandlingUuid: string; perioder: PeriodeMedBelop[] }) => Promise<any>",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ behandlingUuid: string; perioder: PeriodeMedBelop[] }",signature:{properties:[{key:"behandlingUuid",value:{name:"string",required:!0}},{key:"perioder",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  belop: number;
  fom: string;
  tom: string;
  begrunnelse: string;
...
Masserer data og populerer felten samt formatterar tidslinjen for tilbakekreving`,methods:[],displayName:"TilbakekrevingTimeline",props:{perioder:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  navn: string;
  kodeverk: string;
}>`}],raw:"KodeverkMedNavn[]"},description:""}}};const Lr={perioder:[{fom:"2019-01-01",tom:"2019-01-31",belop:1e3,begrunnelse:"Foreldet",foreldelseVurderingType:b.FORELDET,foreldelsesfrist:"2020-04-01"},{fom:"2019-03-01",tom:"2019-03-31",belop:3e3,foreldelseVurderingType:b.UDEFINERT},{fom:"2019-02-01",tom:"2019-02-28",belop:3e3,begrunnelse:"Over foreldelsesfrist, med tillegsfrist brukes",foreldelseVurderingType:b.TILLEGGSFRIST,foreldelsesfrist:"2020-04-01",oppdagelsesDato:"2019-11-01"},{fom:"2019-04-01",tom:"2019-04-30",belop:4e3,foreldelseVurderingType:b.UDEFINERT}]},_r={[pe.FORELDELSE_VURDERING]:[{kode:b.FORELDET,navn:"Foreldet",kodeverk:"FORELDELSE_VURDERING"},{kode:b.TILLEGGSFRIST,navn:"Ikke foreldet, med tilleggsfrist",kodeverk:"FORELDELSE_VURDERING"},{kode:b.IKKE_FORELDET,navn:"Ikke foreldet",kodeverk:"FORELDELSE_VURDERING"}]},_n={component:Re,args:{submitCallback:Me("button-click"),behandling:{uuid:"1",versjon:1,status:_e.BEHANDLING_UTREDES},kodeverkSamlingFpTilbake:_r,isReadOnly:!1,setFormData:()=>{},perioderForeldelse:Lr,relasjonsRolleType:$.MOR,beregnBelop:r=>Promise.resolve(r),alleMerknaderFraBeslutter:{},relasjonsRolleTypeKodeverk:[{kode:"MORA",kodeverk:"RELASJONSROLLE_TYPE",navn:"Mor"}]}},H={args:{aksjonspunkter:[{definisjon:Y.VURDER_FORELDELSE,status:ke.OPPRETTET,begrunnelse:void 0,kanLoses:!0}]}},Z={args:{aksjonspunkter:[]}};var oe,le,de;H.parameters={...H.parameters,docs:{...(oe=H.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: [{
...
}`,...(de=(le=H.parameters)==null?void 0:le.docs)==null?void 0:de.source}}};var ue,me,ge;Z.parameters={...Z.parameters,docs:{...(ue=Z.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  args: {
    aksjonspunkter: []
  }
}`,...(ge=(me=Z.parameters)==null?void 0:me.docs)==null?void 0:ge.source}}};const Un=["Default","UtenAksjonspunkt"];export{H as Default,Z as UtenAksjonspunkt,Un as __namedExportsOrder,_n as default};
