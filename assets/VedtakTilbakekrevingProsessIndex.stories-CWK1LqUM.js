import{h as S,m as z,r as Y,j as e,H as B,D as W,az as J,V as h,N as G,e as V,L as N,B as F,aA as Q,aa as Z,av as X,aL as ee,G as te,aM as re,ar as ne,at as y,P as ie,l as ae}from"./iframe-BYGivzjd.js";import{a as se}from"./alleTilbakekrevingKodeverk-M8dTUOKV.js";import{t as le,a as ue,N as O,o as D,m as de,Z as ke}from"./style-DNmrMo0W.js";import{S as oe}from"./PlusCircle-FDMv7oyY.js";import{M as o}from"./message-E7ZULg9i.js";import{E as A}from"./ExpansionCard-fUgfSxqA.js";import{L as ge}from"./Link-v0B1EZue.js";import{T as a}from"./Table-CrJ7ezIN.js";var w=(r=>(r.FORSETT="FORSETT",r.GROVT_UAKTSOM="GROVT_UAKTSOM",r.SIMPEL_UAKTSOM="SIMPEL_UAKTSOM",r))(w||{});const m={OPPSUMMERING:"OPPSUMMERING",FAKTA:"FAKTA",FORELDELSE:"FORELDELSE",VILKAR:"VILKÅR",SARLIGEGRUNNER:"SÆRLIGEGRUNNER",SARLIGEGRUNNER_ANNET:"SÆRLIGEGRUNNER_ANNET"},ve="_addCircleIcon_179gv_1",me="_addPeriode_179gv_7",pe="_textfield_179gv_12",R={addCircleIcon:ve,addPeriode:me,textfield:pe},I=ue(3),fe=D(4e3),ye=[I,O],be=[le,I,O],U=({type:r,readOnly:n,fritekstPakrevet:t,maximumLength:i})=>{const u=S(),{watch:k,control:s}=z(),g=k(r)===void 0,[d,v]=Y.useState(g&&!t),p=t?be:ye;return p.push(i?D(i):fe),e.jsxs(e.Fragment,{children:[d&&!n&&e.jsx("div",{onClick:l=>{l.preventDefault(),v(!1)},onKeyDown:l=>{l.preventDefault(),v(!1)},className:R.addPeriode,role:"button",tabIndex:0,children:e.jsxs(B,{gap:"2",align:"center",children:[e.jsx(oe,{className:R.addCircleIcon,title:u.formatMessage({id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})}),e.jsx(W,{as:"span",children:e.jsx(o,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.LeggTilUtdypendeTekst"})})]})}),!d&&e.jsx(J,{className:R.textfield,name:r,control:s,label:e.jsx(o,{id:"TilbakekrevingVedtakUtdypendeTekstPanel.UtdypendeTekst"}),validate:p,maxLength:i||4e3,readOnly:n})]})};U.__docgenInfo={description:"",methods:[],displayName:"TilbakekrevingVedtakUtdypendeTekstPanel",props:{type:{required:!0,tsType:{name:"string"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},fritekstPakrevet:{required:!1,tsType:{name:"boolean"},description:""},maximumLength:{required:!1,tsType:{name:"number"},description:""}}};const ce="_gulmarkering_3ospb_1",Te="_paddingTop_3ospb_6",x={gulmarkering:ce,paddingTop:Te},j=({intl:r,vedtaksbrevAvsnitt:n,readOnly:t,perioderSomIkkeHarUtfyltObligatoriskVerdi:i,fritekstOppsummeringPakrevdMenIkkeUtfylt:u=!1,erRevurderingTilbakekrevingFeilBeløpBortfalt:k})=>e.jsxs(h,{gap:"4",children:[e.jsx(G,{size:"small",children:e.jsx(o,{id:"TilbakekrevingVedtak.Vedtaksbrev"})}),n.map(s=>{const g=s.underavsnittsliste,d=`${s.fom}_${s.tom}`,v=i.some(l=>l===d),p=s.avsnittstype===m.OPPSUMMERING&&u;return e.jsx(V.Fragment,{children:e.jsxs(A,{size:"small","aria-label":d,defaultOpen:v||p,className:v||p?x.gulmarkering:"",children:[e.jsx(A.Header,{children:e.jsx(A.Title,{size:"small",children:s.overskrift?s.overskrift:r.formatMessage({id:"TilbakekrevingEditerVedtaksbrevPanel.LovhjemlerOgKlagerettOverskrift"})})}),e.jsx(A.Content,{children:e.jsx(h,{gap:"2",children:g.map(l=>e.jsxs(V.Fragment,{children:[l.overskrift&&e.jsx(N,{className:x.paddingTop,children:l.overskrift}),l.brødtekst&&e.jsx(F,{children:l.brødtekst}),l.fritekstTillatt&&e.jsx(U,{type:l.underavsnittstype?`${d}.${l.underavsnittstype}`:s.avsnittstype,readOnly:t,fritekstPakrevet:l.fritekstPåkrevet,maximumLength:k?1e4:void 0})]},(l.underavsnittstype??"")+l.overskrift+l.brødtekst))})})]})},s.avsnittstype+s.fom)})]});j.buildInitialValues=r=>r.filter(n=>n.underavsnittsliste.some(t=>t.fritekst)).reduce((n,t)=>{const u=t.underavsnittsliste.filter(s=>s.fritekst).reduce((s,g)=>({...s,[g.underavsnittstype?g.underavsnittstype:t.avsnittstype]:Q(g.fritekst)}),{}),k=t.fom?{[`${t.fom}_${t.tom}`]:u}:u;return{...n,...k}},{});j.__docgenInfo={description:"",methods:[{name:"buildInitialValues",docblock:null,modifiers:["static"],params:[{name:"vedtaksbrevAvsnitt",optional:!1,type:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  avsnittstype: string;
  fom?: string;
  tom?: string;
  overskrift?: string;
