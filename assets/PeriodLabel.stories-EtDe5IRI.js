import{j as e,R as l,P as t,l as m}from"./iframe-CEg6Ggk6.js";const a=({dateStringFom:i,dateStringTom:n,showTodayString:d=!1})=>e.jsx(e.Fragment,{children:l(i,n,{showTodayString:d})});a.__docgenInfo={description:`PeriodLabel
...
\`\`\``,methods:[],displayName:"PeriodLabel",props:{dateStringFom:{required:!0,tsType:{name:"string"},description:""},dateStringTom:{required:!1,tsType:{name:"string"},description:""},showTodayString:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const s=m({}),p={component:a},r=()=>e.jsx(t,{value:s,children:e.jsx(a,{dateStringFom:"2020-01-02",dateStringTom:"2020-01-04"})}),o=()=>e.jsx(t,{value:s,children:e.jsx(a,{dateStringFom:"2020-01-02",showTodayString:!0})});r.__docgenInfo={description:"",methods:[],displayName:"VisPeriodelabel"};o.__docgenInfo={description:"",methods:[],displayName:"VisPeriodelabelTilDagensDato"};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`() => <RawIntlProvider value={intl}>
  ...
  </RawIntlProvider>`,...o.parameters?.docs?.source}}};const g=["VisPeriodelabel","VisPeriodelabelTilDagensDato"];export{r as VisPeriodelabel,o as VisPeriodelabelTilDagensDato,g as __namedExportsOrder,p as default};
