...
| '-'`,elements:[{name:"literal",value:"'AAP'"},{name:"literal",value:"'ARBEID'"},{name:"literal",value:"'DAGPENGER'"},{name:"literal",value:"'FORELDREPENGER'"},{name:"literal",value:"'FRILANS'"},{name:"literal",value:"'FRILOPP'"},{name:"literal",value:"'FRISINN'"},{name:"literal",value:"'MILITÆR_ELLER_SIVILTJENESTE'"},{name:"literal",value:"'NÆRING'"},{name:"literal",value:"'OMSORGSPENGER'"},{name:"literal",value:"'OPPLÆRINGSPENGER'"},{name:"literal",value:"'PLEIEPENGER'"},{name:"literal",value:"'SVANGERSKAPSPENGER'"},{name:"literal",value:"'SYKEPENGER'"},{name:"literal",value:"'VARTPENGER'"},{name:"literal",value:"'VIDERE_ETTERUTDANNING'"},{name:"literal",value:"'UTENLANDSK_ARBEIDSFORHOLD'"},{name:"literal",value:"'VENTELØNN_VARTPENGER'"},{name:"literal",value:"'ETTERLØNN_SLUTTPAKKE'"},{name:"literal",value:"'UTDANNINGSPERMISJON'"},{name:"literal",value:"'SYKEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'PLEIEPENGER_AV_DAGPENGER'"},{name:"literal",value:"'MELLOM_ARBEID'"},{name:"literal",value:"'-'"}],required:!0}}]},required:!0},value:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  ...
  kode: EnumOrUnknown<T>;
  navn: string;
}>`}],raw:"KodeverkMedNavn<K>[]"}}]}},description:""}}};const se=new Set(["VURDER_VARIG_ENDRT_NYOPPSTR_NAERNG_SN","FASTSETT_BG_AT_FL","FASTSETT_BG_SN","FASTSETT_BG_TB_ARB","FASTSETT_BG_SN_NY_I_ARB_LIVT","VURDER_VARIG_ENDRT_ARB_SITSJN_MDL_INAKTV"]),ue=n=>n.some(a=>se.has(a.definisjon)&&a.kanLoses),oe=(n,a)=>{const t=n.vilkårsperiodeFom;return(a?.perioder??[]).filter(r=>r.vurderesIBehandlingen&&!r.erForlengelse).some(r=>r.periode.fom===t)},ge=(n,a)=>{const t=de(n,a),l=t.find(g=>g.skalVurderes&&g.harAvklaringsbehov)?.bgIndex??0,[r,u]=f.useState(l);return{tabOptions:t,currentTabValue:r.toString(),onTabChange:g=>u(Number(g))}},de=(n,a)=>n.map((t,l)=>({bgIndex:l,skalVurderes:oe(t,a),harAvklaringsbehov:ue(t.avklaringsbehov),skjæringstidspunkt:t.skjaeringstidspunktBeregning,optionLabel:_(t.skjaeringstidspunktBeregning)})).sort((t,l)=>p(t.skjæringstidspunkt).diff(p(l.skjæringstidspunkt))),me=J($),h=({beregningsgrunnlagListe:n,beregningsgrunnlagsvilkår:a,kodeverkSamling:t,arbeidsgiverOpplysningerPerId:l})=>{const{tabOptions:r,currentTabValue:u,onTabChange:g}=ge(n,a);return e.jsx(U,{value:me,children:e.jsxs(v,{value:u,onChange:g,children:[r.length>1&&e.jsx(v.List,{children:r.map(s=>e.jsx(v.Tab,{value:s.bgIndex.toString(),label:s.optionLabel,icon:s.harAvklaringsbehov?e.jsx(x,{"aria-hidden":!0,color:"var(--ax-bg-warning-strong)"}):void 0},s.bgIndex))}),r.map(s=>e.jsx(v.Panel,{value:s.bgIndex.toString(),"aria-label":s.optionLabel,children:e.jsx(V,{beregningsgrunnlag:n[s.bgIndex],beregningsgrunnlagsvilkår:a,kodeverkSamling:t,arbeidsgiverOpplysningerPerId:l})},s.bgIndex))]})})};h.__docgenInfo={description:"",methods:[],displayName:"BeregningProsessIndex",props:{beregningsgrunnlagListe:{required:!0,tsType:{name:"Array",elements:[{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
  vilkårsperiodeFom: string;
  avklaringsbehov: BeregningAvklaringsbehov[];
  skjaeringstidspunktBeregning: string;
  dekningsgrad?: number;
...
}`,...A.parameters?.docs?.source}}};const Ge=["CaseArbeidstakerMedEttArbeidsforholdFP","ToGrunnlagHvorEnHarÅpentAP","ArbeidstakerMedFlereArbeidsforhold"];export{A as ArbeidstakerMedFlereArbeidsforhold,E as CaseArbeidstakerMedEttArbeidsforholdFP,k as ToGrunnlagHvorEnHarÅpentAP,Ge as __namedExportsOrder,Le as default};
