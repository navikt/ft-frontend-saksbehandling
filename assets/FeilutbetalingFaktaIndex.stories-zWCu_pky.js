import{u as x,L,j as e,aA as G,aB as B,aC as F,k as V,al as S,W as y,aD as M,aE as H,H as R,X as j,f as h,B as I,aF as Y,aG as C,aH as $,aI as z,I as W,aJ as X,aK as J,P as Q,i as Z}from"./iframe-GdKD0Z5h.js";import{a as ee}from"./alleKodeverk-BqlsAwOV.js";import{a as ne}from"./alleTilbakekrevingKodeverk-BIIVe2EV.js";import{I as O,K as re,S as ae,G as te}from"./index.es-BDctT3QU.js";import{t as f,a as le,o as ie,N as se}from"./index.es-CZFNEFDl.js";import{T}from"./Table-BSGRBIoq.js";import{M as d}from"./message-BUwEHE_Y.js";/* empty css              */import"./preload-helper-PPVm8Dsz.js";var A=(r=>(r.AVKLAR_FAKTA_FOR_FEILUTBETALING="7003",r))(A||{});const N="perioder",de=(r,u)=>{const t=r.find(a=>a.hendelseType===u);return t?.hendelseUndertyper&&t.hendelseUndertyper.length>0?t.hendelseUndertyper:void 0},P=({perioder:r,årsaker:u,readOnly:t,behandlePerioderSamlet:a,kodeverkSamlingFpTilbake:g})=>{const{control:i,watch:s,setValue:m,getValues:v}=x(),{fields:b}=L({control:i,name:N}),E=(n,k,o)=>{a&&b.forEach((c,l)=>{k!==l&&(o?v(`${N}.${l}.årsak`)===o&&m(`${N}.${l}.${o}.underÅrsak`,n):m(`${N}.${l}.årsak`,n))})};return e.jsxs(T,{children:[e.jsx(T.Header,{children:e.jsxs(T.Row,{children:[e.jsx(T.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Period"})}),e.jsx(T.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Hendelse"})}),e.jsx(T.HeaderCell,{scope:"col",children:e.jsx(d,{id:"FeilutbetalingInfoPanel.Beløp"})})]})}),e.jsx(T.Body,{children:b.map((n,k)=>{const o=s(`${N}.${k}.årsak`),c=de(u,o);return e.jsxs(T.Row,{children:[e.jsx(T.DataCell,{children:e.jsx(G,{dateStringFom:n.fom,dateStringTom:n.tom})}),e.jsxs(T.DataCell,{children:[e.jsx(B,{name:`${N}.${k}.årsak`,control:i,selectValues:u.map(l=>e.jsx("option",{value:l.hendelseType,children:g.HendelseType.find(p=>p.kode===l.hendelseType)?.navn},l.hendelseType)),validate:[f],disabled:t,onChange:l=>E(l.target.value,k),label:""}),c&&e.jsx(B,{name:`${N}.${k}.${o}.underÅrsak`,control:i,selectValues:c.map(l=>e.jsx("option",{value:l,children:g.HendelseUnderType.find(p=>p.kode===l)?.navn},l)),validate:[f],disabled:t,onChange:l=>E(l.target.value,k,o),label:""})]}),e.jsx(T.DataCell,{align:"right",children:r?e.jsx(F,{rød:!0,beløp:r[k].belop}):null})]},n.id)})})]})};P.__docgenInfo={description:"",methods:[],displayName:"FeilutbetalingPerioderFieldArray",props:{perioder:{required:!0,tsType:{name:"signature['perioder']",raw:"FeilutbetalingFakta['behandlingFakta']['perioder']"},description:""},årsaker:{required:!0,tsType:{name:"Array",raw:"FeilutbetalingÅrsak['hendelseTyper']"},description:""},readOnly:{required:!0,tsType:{name:"boolean"},description:""},behandlePerioderSamlet:{required:!0,tsType:{name:"boolean"},description:""},kodeverkSamlingFpTilbake:{required:!0,tsType:{name:"signature",type:"object",raw:`{
