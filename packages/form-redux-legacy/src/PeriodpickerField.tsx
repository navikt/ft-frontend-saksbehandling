...
import { BaseFieldsProps, Fields, Formatter, Parser, WrappedFieldsProps } from 'redux-form';
import moment from 'moment';
import { ACCEPTED_DATE_INPUT_FORMATS, DDMMYYYY_DATE_FORMAT, haystack, ISO_DATE_FORMAT } from '@navikt/ft-utils';
...
const renderReadOnly =
  (): FunctionComponent<Partial<PeriodpickerFieldProps> & WrappedFieldsProps> =>
  ({ names, renderIfMissingDateOnReadOnly, ...otherProps }) => {
