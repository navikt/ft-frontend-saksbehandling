...
const getTitleFormatter = (formName: string) => (formattedAction: any, formattedTime: string) =>
...
const ReduxWrapper: FunctionComponent<OwnProps> = ({ children, formName, formData, setFormData }) => {
