...
const transformValues = (values: FormValues, årsaker: FeilutbetalingAarsak['hendelseTyper']): AvklartFaktaFeilutbetalingAp => {
  ...
  return {
    kode: FaktaTilbakekrevingFeilutbetalingAp.AVKLAR_FAKTA_FOR_FEILUTBETALING,
        ...
        <Row className={styles.smallMarginBottom}>
          <Column xs="12" md="6">
            ...
            <Row className={styles.smallMarginTop}>
              <Column xs="11">
                <FaktaGruppe
                  merknaderFraBeslutter={alleMerknaderFraBeslutter[FaktaTilbakekrevingFeilutbetalingAp.AVKLAR_FAKTA_FOR_FEILUTBETALING]}
                  withoutBorder
                >
