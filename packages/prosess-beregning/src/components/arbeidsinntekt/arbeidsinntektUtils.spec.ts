  ...
  describe('mapBeregningsgrunnlagTilArbeidsinntektVisning', () => {
    it('skal mappe inntektsrader for andelene', () => {
      ...
      expect(resultat[0]).toEqual({
        ...
        beregningsgrunnlag: { månedinntekt: 10592, årsinntekt: 127104 },
        ansattPeriode: {
          fom: '2005-12-15',
          tom: undefined,
        },
        inntektsmelding: { månedinntekt: 50000, årsinntekt: 600000 },
      ...
      expect(resultat[1]).toEqual({
        ...
        inntektsmelding: { månedinntekt: 40000, årsinntekt: 480000 },
