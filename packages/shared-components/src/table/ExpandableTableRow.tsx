...
import pilNedIkonUrl from '@ft-frontend-saksbehandling/assets/images/pil_ned.svg';
import pilOppIkonUrl from '@ft-frontend-saksbehandling/assets/images/pil_opp.svg';
