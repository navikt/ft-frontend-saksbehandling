...
import keyImage from '@ft-frontend-saksbehandling/assets/images/key-1-rotert.svg';
import keyUtgraetImage from '@ft-frontend-saksbehandling/assets/images/key-1-rotert-utgraet.svg';
