...
const config = {
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'ft_prosess_tilbakekreving',
      library: { type: 'var', name: 'ft_prosess_tilbakekreving' },
      filename: 'remoteEntry.js',
      exposes: {
        './TilbakekrevingProsessIndex': './dev/MicroFrontendIndex',
      },
      shared: {
        ...deps,
        react: {
