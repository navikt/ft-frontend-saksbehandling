...
import avslattImage from '@ft-frontend-saksbehandling/assets/images/avslaatt_hover.svg';
import innvilgetImage from '@ft-frontend-saksbehandling/assets/images/innvilget_hover.svg';
