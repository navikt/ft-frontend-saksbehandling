...
import { EditedIcon, VerticalSpacer, AksjonspunktBox } from '@ft-frontend-saksbehandling/shared-components';
import { TextAreaField } from '@ft-frontend-saksbehandling/form-hooks';
import {
  hasValidText, maxLength, minLength, createIntl,
} from '@ft-frontend-saksbehandling/utils';
import advarselIkonUrl from '@ft-frontend-saksbehandling/assets/images/advarsel_ny.svg';
