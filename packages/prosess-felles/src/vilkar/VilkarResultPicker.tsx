...
} from '@ft-frontend-saksbehandling/form-hooks';
import {
  hasValidDate, required, createIntl, requiredIfCustomFunctionIsTrueNew,
} from '@ft-frontend-saksbehandling/utils';
import avslattImage from '@ft-frontend-saksbehandling/assets/images/avslaatt.svg';
import innvilgetImage from '@ft-frontend-saksbehandling/assets/images/check.svg';
import { Aksjonspunkt, Behandlingsresultat, KodeverkMedNavn } from '@ft-frontend-saksbehandling/types';
