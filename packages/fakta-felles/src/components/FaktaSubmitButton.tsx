...
import { createIntl, ariaCheck, isRequiredMessage } from '@ft-frontend-saksbehandling/utils';
import { hasBehandlingFormErrorsOfType } from '@ft-frontend-saksbehandling/form';
