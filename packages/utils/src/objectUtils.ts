...
export const notNull = (value?: string | null) =>
  value === undefined || value === null ? throwError(`Value is ${value}`) : value;
...
export const omit = (object: Record<string, any>, ...keysToOmit: string[]) =>
  Object.keys(object)
...
const isNotNullAndObject = (obj?: DiffInput | null): boolean =>
