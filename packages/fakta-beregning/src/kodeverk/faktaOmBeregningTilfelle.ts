export enum FaktaOmBeregningTilfelle {
  ...
  VURDER_LØNNSENDRING = 'VURDER_LØNNSENDRING',
  FASTSETT_MÅNEDSLØNN_ARBEIDSTAKER_UTEN_INNTEKTSMELDING = 'FASTSETT_MÅNEDSLØNN_ARBEIDSTAKER_UTEN_INNTEKTSMELDING',
  VURDER_AT_OG_FL_I_SAMME_ORGANISASJON = 'VURDER_AT_OG_FL_I_SAMME_ORGANISASJON',
  FASTSETT_BESTEBEREGNING_FØDENDE_KVINNE = 'FASTSETT_BESTEBEREGNING_FØDENDE_KVINNE',
  VURDER_ETTERLØNN_SLUTTPAKKE = 'VURDER_ETTERLØNN_SLUTTPAKKE',
