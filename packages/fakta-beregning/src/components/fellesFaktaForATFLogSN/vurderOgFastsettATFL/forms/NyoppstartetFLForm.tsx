...
export const NyoppstartetFLForm = ({ readOnly }: Props) => {
  ...
  return (
    <RhfRadioGroup
      ...
      control={control}
      legend={<FormattedMessage id="BeregningInfoPanel.NyoppstartetFLForm.ErSokerNyoppstartetFL" />}
      description={
        <ReadMore
          size="small"
        ...
        >
          <List size="small">
            <FormattedMessage tagName={List.Item} id="BeregningInfoPanel.NyoppstartetFLForm.HvordanGarJegFrem1" />
            <FormattedMessage tagName={List.Item} id="BeregningInfoPanel.NyoppstartetFLForm.HvordanGarJegFrem2" />
          </List>
        </ReadMore>
      }
      validate={[required]}
